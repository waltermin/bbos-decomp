...
public interface Element extends Node {
   ...
   Attr setAttributeNode(Attr var1);

   Attr removeAttributeNode(Attr var1);

   NodeList getElementsByTagName(String var1);

   String getAttributeNS(String var1, String var2);

   void setAttributeNS(String var1, String var2, String var3);

   void removeAttributeNS(String var1, String var2);

   Attr getAttributeNodeNS(String var1, String var2);

   Attr setAttributeNodeNS(Attr var1);
