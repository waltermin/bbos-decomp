...
class ESMath$10 extends HostFunction {
   private final ESMath this$0;

   ESMath$10(ESMath _1, String x0, String x1, int x2) {
      super(x0, x1, x2);
      this.this$0 = _1;
   }
   ...
   public long run() {
      ...
      if (Double.isNaN(d)) {
         ...
         return d == 4607182418800017408L ? Value.ZERO : Value.makeDoubleValue(ESMath.log(d));
      }
   }
}
