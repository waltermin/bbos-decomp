...
class ESRegExpPrototype$2 extends HostFunction {
   private final ESRegExpPrototype this$0;

   ESRegExpPrototype$2(ESRegExpPrototype _1, String x0, String x1, int x2) {
      super(x0, x1, x2);
      this.this$0 = _1;
   }
   ...
   public long run() {
      ...
      RegExp$MatchResult m = ESRegExpPrototype.doMatch("test", this.getThis(), s);
      return Value.makeBooleanValue(m != null);
   }
}
