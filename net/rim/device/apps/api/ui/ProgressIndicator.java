...
public class ProgressIndicator {
   VerticalFieldManager _vfm = new VerticalFieldManager(1152921504606846976L);
   protected PopupScreen _popupScreen = new PopupScreen(this._vfm);
   GaugeField _gaugeField;
   LabelField _labelField = new LabelField("", 12884901952L);
   ...
   public ProgressIndicator(long gaugeStyle) {
      this._gaugeField = new GaugeField(null, 0, 1, 0, gaugeStyle);
   ...
   public void run() {
      ...
      new Thread(this._progressRunnable).start();
   }
