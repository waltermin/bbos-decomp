...
public final class MessageListOptions extends OptionsBase implements UnreadCountManager$CountOptions {
   ...
   private static final long MESSAGE_LIST_OPTIONS_SYNC_ITEM;
   private static final long PERSISTED_MESSAGE_LIST_OPTIONS;
   public static final long GUID_OPTIONS_CHANGED;
   private static final int DEFAULT_GAP;
   private static final int TIME_COLUMN_GAP;
   private static final int ADDRESS_COLUMN_GAP;
   private static final int DEFAULT_PRIORITY_WIDTH;
   ...
   public static final int GLOBAL_DELETE_BOTH;
   public static final int HIDE_FILED;
   public static final int PIN_LEVEL_1;
   public static final int AUTO_MORE;
   public static final int SPELL_CHECK_BEFORE_SEND;
   public static final int ALLOW_READ_CONFIRM;
   public static final int HIDE_SENT;
   public static final int DISPLAY_NEW_MESSAGE_INDICATOR;
   public static final int HIGHSPEED_NETWORK_ONLY_FOR_AUTO_DOWNLOAD_ATTACHMENT;
   public static final int CONFIRM_MARK_PRIOR_OPENED;
   public static final int DELETE_HANDHELD_ONLY;
   public static final int DELETE_HANDHELD_AND_DESKTOP;
   public static final int DELETE_PROMPT;
   public static final int DELETE_ON_NOT_SPECIFIED;
   ...
   private static final int DEFAULT_KEEP_MESSAGES_DURATION_INDEX;
   ...
   public static final int MESSAGE_LIST_LINE_MODE_AUTO;
   public static final int MESSAGE_LIST_LINE_MODE_ONE;
   public static final int MESSAGE_LIST_LINE_MODE_TWO;
   public static final int SMS_EMAIL_INBOX_THEME_CONTROLLED;
   public static final int SMS_EMAIL_INBOX_COMBINED;
   public static final int SMS_EMAIL_INBOX_SEPERATE;
   public static final int DEFAULT_SMS_EMAIL_INBOX_INDEX;
   public static final short AUTO_ATTACHMENT_DOWNLOAD_OFF;
   public static final short AUTO_ATTACHMENT_DOWNLOAD_ON;
   public static final short AUTO_ATTACHMENT_DOWNLOAD_HOME_NETWORK;
   private static final int AUTO_MORE_TRIGGER;
   public static final byte DSN_NOT_SPECIFIED;
   public static final byte DSN_SPECIFIED;
   public static final byte DSN_REQUEST_DELIVERY_RECEIPT;
   public static final byte DSN_REQUEST_READ_RECEIPT;
   public static final byte DSN_SEND_READ_RECEIPTS;
   public static final byte DSN_SEND_READ_RECEIPTS_PROMPT;
   public static final short LIST_SEPARATOR_NONE;
   public static final short LIST_SEPARATOR_STRIPES;
   public static final short LIST_SEPARATOR_LINES;
   ...
   private static final long DISABLE_MESSAGE_LIST_ELLIPSES;
