...
class FolderList$4 implements Runnable {
   ...
   @Override
   public void run() {
      this.this$0.handleElementRemoved(this.val$collection, this.val$element);
   }
}
