...
public class RIMMessagingFolderManagement extends RIMMessagingTransmission implements Persistable {
   ...
   private static final byte FM_PURGE_MESSAGES = 3;
   private static final byte FM_MESSAGE_STATUS = 4;
   private static final byte FM_OTAFM_CONFIG = 5;
   private static final byte FM_MESSAGE_LIST = 6;
   private static final byte FM_FOLDER_LIST = 7;
   private static final byte FM_CREATE_FOLDER = 8;
   private static final byte FM_DELETE_FOLDER = 9;
   private static final byte FM_MODIFY_FOLDER = 10;
   private static final byte FM_MESSAGE_LIST_REQUEST = 11;
   private static final byte FM_FOLDER_LIST_REQUEST = 12;
   private static final byte FM_OTAFM_CONFIG_REQUEST = 13;
   private static final byte FM_RESTORE_MESSAGE_LIST = 14;
   private static final byte FM_OTAFM_CONFIG_ACK = 15;
   private static final byte FM_MESSAGE_LIST_ACK = 16;
   private static final byte FM_SEND_CHANGES_REQUEST = 17;
   private static final byte FM_SEND_PURGED_MESSAGE_LIST = 18;
   private static final byte FM_RIM_MESSAGE_ID = 1;
   private static final byte FM_RIM_CURRENT_FOLDER_ID = 2;
   private static final byte FM_RIM_PREVIOUS_FOLDER_ID = 3;
   private static final byte FM_RIM_MESSAGE_STATUS_ID = 4;
   private static final byte FM_RIM_PARENT_FOLDER_ID = 5;
   private static final byte FM_RIM_FOLDER_NAME = 6;
   private static final byte FM_RIM_FOLDER_TYPE = 7;
   private static final byte FM_RIM_FOLDER_ATTR = 8;
   private static final byte FM_RIM_DELETE_BITMASK = 9;
   private static final byte FM_RIM_MESSAGE_LIST_ID = 10;
   private static final byte FM_RIM_FOLDER_NAME_2 = -122;
   public static final byte FM_DELETE_MESSAGES = 1;
   public static final byte FM_DELETE_FOLDERS = 2;
   private static final byte FM_RIM_SERVER_SUPPORT = 1;
   private static final byte FM_RIM_USER_CONFIG = 2;
   private static final byte FM_RIM_CONFLICT = 3;
   private static final byte FM_MESSAGE_LIST_NUM_MESSAGE_STATUS = 1;
   private static final int OTAFM_CONFIG_STATUS_MASK = 1;
   private static final int OTAFM_CONFIG_DELETE_MASK = 2;
   private static final int OTAFM_CONFIG_FILING_MASK = 4;
   private static final int OTAFM_CONFIG_PURGE_MASK = 8;
   private static final int OTAFM_CONFIG_USER_ENABLED = 16;
   private static final int OTAFM_CONFIG_DEVICE_INIT = 32;
   private static final int OTAFM_CONFIG_PURGED_MESSAGE_LIST_MASK = 64;
   private static final int OTAFM_CONFIG_USER_MASK = 15;
   private static final int OTAFM_CONFIG_HANDHELD_WINS = 0;
   private static final int OTAFM_CONFIG_DESKTOP_WINS = 1;
   public static final int FM_MSG_READ = 1;
   public static final int FM_MSG_DELETED_ON_DEVICE = 2;
   public static final int FM_MSG_REPLYTO = 4;
   public static final int FM_MSG_FORWARD = 8;
   public static final int FM_MSG_DELETED = 16;
   public static final int FM_FOLDER_SUBTREE = 0;
   public static final int FM_FOLDER_DELETED_ITEMS = 1;
   public static final int FM_FOLDER_INBOX = 2;
   public static final int FM_FOLDER_OUTBOX = 3;
   public static final int FM_FOLDER_SENT_ITEMS = 4;
   public static final int FM_FOLDER_OTHER = 5;
   public static final int FM_FOLDER_ATTR_LOCAL_FOLDER = 1;
   public static final int FM_FOLDER_ATTR_NO_MESSAGES = 2;
   public static final int FM_FOLDER_ATTR_REDIRECTION_SUPPORTED = 4;
   public static final int FM_FOLDER_ATTR_REDIRECTION_STATUS = 8;
