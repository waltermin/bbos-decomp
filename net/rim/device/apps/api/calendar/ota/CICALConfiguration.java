...
public class CICALConfiguration implements Persistable {
   ...
   private static final long SINGLETON_ID = -3859592151657501285L;
   private static final long DONT_NOTIFY_ATTENDEES_LUID_LIST = 7708406907057731816L;
   public static final int SOURCE_SERVICERECORD = 1;
   public static final int SOURCE_CICAL = 2;
   public static final int SOURCE_USER = 3;
   public static final int SOURCE_OVERRIDE = 255;
   public static final int SYNC_SEND_ENABLED = 1;
   public static final int SYNC_RECEIVE_ENABLED = 2;
   public static final int SYNC_SEND_MEETING_REQ_ENABLED = 4;
   public static final int CAL_DISABLE_RECUR_PATTERN_EDIT = 8;
   public static final int CAL_DISABLE_RECUR_TIME_EDIT = 16;
   public static final int CAL_DISABLE_ENDS_NEVER = 32;
   public static final int CAL_DISABLE_MIDNIGHT_SPAN = 64;
   public static final int CAL_DISABLE_FIXED_RECUR_SCOPE = 128;
   public static final int CAL_DISABLE_POPULATE_WITHOUT_ACCEPT = 256;
   public static final int OTA_CONFIG_SUPPORTED = 512;
   public static final int OTA_SLOW_SYNC_SUPPORTED = 1024;
   public static final int CAL_RECUR_OPTIMIZATIONS = 2048;
   public static final int CAL_NOT_ALLOWED_TO_INVITE_TO_ALL_DAY_EVENT = 4096;
   public static final int CONFICT_HOST_WINS = 1;
   public static final int CONFLICT_DEVICE_WINS = 2;
   public static final int CONFLICT_LAST_IN_WINS = 3;
   public static final int CAL_OTA_DISABLED = 1;
