...
public interface CalDB
   ...
   String CALENDAR_DATABASE_NAME = "Calendar";
   long ORGANIZING_DATA = -5520237139346668942L;
   long ID = 1210326705763766088L;
   int MORE_EVENTS_AFTER = 1;
   int MORE_EVENTS_BEFORE = 2;
   int ADD_ACTION_CHECKSUM_UPDATE = 1;
   int ADD_ACTION_MARK_CLEAN = 2;
   int ADD_ACTION_NO_NOTIFY = 4;
   int ADD_NORMAL = 1;
   int ADD_UPDATE_CHECKSUM_MARK_CLEAN_NO_NOTIFY = 7;
   int ADD_JUST_MARK_CLEAN = 2;
   int ADD_MARK_CLEAN_NO_NOTIFY = 6;
   int PRIMARY_CALENDAR_ID = 0;
