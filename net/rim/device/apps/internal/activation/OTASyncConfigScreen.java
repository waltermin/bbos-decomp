...
final class OTASyncConfigScreen extends AppsMainScreen implements FieldChangeListener {
   ...
   private ObjectChoiceField _wirelessSync = (ObjectChoiceField)(new Object("Wireless Sync:", new String[]{"Yes", "No"}));
   ...
   OTASyncConfigScreen(ActivationApp app) {
      ...
      if (records != null && records.length > 0) {
         ...
         String[] values = new Object[records.length];
         ...
         this._syncableServices = (ObjectChoiceField)(new Object(ActivationApp._resources.getString(135), values));
         this._syncSourceIndex = 0;
         if (values.length == 1) {
   ...
   private final void addFields() {
      ...
      this._dataSourceIDField = (PropertyField)(new Object(label, dsid));
      label = ActivationApp._resources.getString(133);
      String value = MessageFormat.format(ActivationApp._resources.getString(139), new Object[]{Integer.toString(sessionTimeout)});
      this._sessionTimeOut = (PropertyField)(new Object(label, value));
      label = ActivationApp._resources.getString(134);
      value = MessageFormat.format(ActivationApp._resources.getString(139), new Object[]{Integer.toString(batchSymcTimeout)});
      this._batchSyncTime = (PropertyField)(new Object(label, value));
      label = ActivationApp._resources.getString(138);
      value = ActivationApp._resources.getString(userEnabled ? 140 : 141);
      this._userState = (PropertyField)(new Object(label, value));
      label = ActivationApp._resources.getString(136);
      value = Long.toString(numberOfRetries);
      this._numberOfRetries = (PropertyField)(new Object(label, value));
      label = ActivationApp._resources.getString(137);
      value = MessageFormat.format(ActivationApp._resources.getString(139), new Object[]{Integer.toString(ignoredSessionTimeout)});
      this._ignoreSessionTimeOut = (PropertyField)(new Object(label, value));
      this._mainManager.add(this._dataSourceIDField);
      this._mainManager.add((Field)(new Object()));
      ...
      this._mainManager.add((Field)(new Object()));
      ObjectListField sidList = (ObjectListField)(new Object(70));
      ...
      sidList.set(sids);
      this._mainManager.add((Field)(new Object("Activated SIDs:")));
