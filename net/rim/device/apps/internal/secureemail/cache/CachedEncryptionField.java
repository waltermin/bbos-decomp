...
public class CachedEncryptionField extends CachedManager {
   protected int _besEncryptionState;
   protected int _besWeakRecipientState;

   public CachedEncryptionField(int besEncryptionState, int besWeakRecipientState) {
   ...
   protected Manager createManager(Object context) {
      ...
      int extentIndicatorRGB = Graphics.isColor() ? 205 : 0;
