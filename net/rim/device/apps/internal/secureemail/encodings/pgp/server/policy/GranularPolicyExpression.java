...
class GranularPolicyExpression extends GranularPolicyElement implements GranularPolicyEvaluateProvider {
   ...
   private static final int CONDITION_RECIPIENT_ADDRESS;
   private static final int CONDITION_RECIPIENT_DOMAIN;
   private static final int CONDITION_RECIPIENT_USER_GROUP;
   private static final int CONDITION_SENDER_ADDRESS;
   private static final int CONDITION_SENDER_DOMAIN;
   private static final int CONDITION_SENDER_USER_GROUP;
   private static final int CONDITION_MESSAGE_HEADER;
   private static final int CONDITION_MESSAGE_SUBJECT;
   private static final int CONDITION_MESSAGE_BODY;
   private static final int CONDITION_MESSAGE_IS_SIGNED;
   private static final int CONDITION_MESSAGE_IS_ENCRYPTED;
   private static final int CONDITION_MESSAGE_SIZE;
   private static final int CONDITION_MESSAGE_CONTAINED_VIRUS;
   private static final int CONDITION_MESSAGE_HAS_ATTACHMENT_FILENAME;
   private static final int CONDITION_MESSAGE_HAS_ATTACHMENT_TYPE;
   private static final int CONDITION_SERVICE_TYPE;
   private static final int CONDITION_USER_HAS_AUTHENTICATED;
   private static final int CONDITION_APPLICATION_IS;
   private static final int CONDITION_MESSAGE_FROM_MAILING_LIST;
   private static final int CONDITION_RECIPIENT_IS_EXCHANGE_LIST;
   private static final int CONDITION_MAILING_LIST_CONTAINS_NUM_USERS;
   private static final int CONDITION_IP_ADDRESS_LOCAL_CONNECTOR;
   private static final int CONDITION_PORT_LOCAL_CONNECTOR;
   private static final int CONDITION_RECIPIENT_KEY_MODE;
   private static final int CONDITION_SENDER_KEY_MODE;
   private static final int CONDITION_MESSAGE_IS_CONFIDENTIAL;
   private static final int CONDITION_EXTERNAL_RECIPIENT_DELIVERY_PREF;
   private static final int CONDITION_PART_OF_MESSAGE_IS_ENCRYPTED;
   private static final int OPERATOR_IS;
   private static final int OPERATOR_CONTAINS;
   private static final int OPERATOR_BEGINS_WITH;
   private static final int OPERATOR_ENDS_WITH;
   private static final int OPERATOR_MATCHES_PATTERN;
   private static final int OPERATOR_IS_IN_DICTIONARY;
   private static final int OPERATOR_IS_IN_SUBDOMAIN_OF;
   private static final int OPERATOR_CONTAINS_ENTRY_IN_DICTIONARY;
   private static final int OPERATOR_TO_ANY_KEY;
   private static final int OPERATOR_TO_KEY_ID;
   private static final int OPERATOR_TO_ADK;
   private static final int OPERATOR_TO_KEY_IN_DICTIONARY;
   private static final int OPERATOR_IS_GREATER_THAN;
   private static final int OPERATOR_IS_LESS_THAN;
   private static final int OPERATOR_IS_SMTP_INBOUND;
   private static final int OPERATOR_IS_SMTP_OUTBOUND;
   private static final int OPERATOR_IS_POP;
   private static final int OPERATOR_IS_IMAP;
   private static final int OPERATOR_IS_MAPI;
   private static final int OPERATOR_IS_NOTES;
   private static final int OPERATOR_IS_WEB_MESSENGER;
   private static final int OPERATOR_IS_INTERNAL_DESKTOP_OR_OC;
   private static final int OPERATOR_IS_EXTERNAL_DESKTOP_OR_OC;
   private static final int OPERATOR_IS_SERVER;
   private static final int OPERATOR_IS_RIM_BLACKBERRY;
   private static final int OPERATOR_FEWER_THAN;
   private static final int OPERATOR_GREATER_THAN;
   private static final int OPERATOR_IS_EQUALS;
   private static final int OPERATOR_IS_SKM;
   private static final int OPERATOR_IS_CKM;
   private static final int OPERATOR_IS_GKM;
   private static final int OPERATOR_IS_SCKM;
   private static final int OPERATOR_IS_CONFIDENTIAL;
   private static final int OPERATOR_IS_CONFIDENTIAL_OR_SUBJECT;
   private static final int OPERATOR_IS_DELIVERY_WEB_MESSENGER;
   private static final int OPERATOR_IS_SMART_TRAILER;
   private static final int OPERATOR_IS_DESKTOP_OR_OC;
