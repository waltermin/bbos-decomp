...
public class CursorProviderVerticalIndentFieldManager extends VerticalIndentFieldManager implements CursorProviderField {
   private Field _currentCursorField;

   public CursorProviderVerticalIndentFieldManager() {
   }

   public CursorProviderVerticalIndentFieldManager(long style) {
      super(style);
   }
