...
final class IconFetcher {
   private static final String ICON_FOLDER = "/store/appdata/rim/bda/icons/";
   private static final String CONNECTION_UID = "connectionuid";
   private static final String ICON_WIDTH = "icon_x";
   private static final String ICON_HEIGHT = "icon_y";
   private static final String ITEM = "item";
   private static final String PROFILE = "profile";
   private static final String THEME = "theme";
   private static final String USER_AGENT = "user-agent";
   private static final String VERSION = "version";
   private static final String RESP_ICON_WIDTH = "X-Rim-Icon-Width";
   private static final String RESP_ICON_HEIGHT = "X-Rim-Icon-Height";
   private static final int CONNECTION_PUBLIC_MDS = 0;
   private static final int CONNECTION_PRIVATE_MDS = 1;
   private static final int CONNECTION_NO_MDS = 2;
