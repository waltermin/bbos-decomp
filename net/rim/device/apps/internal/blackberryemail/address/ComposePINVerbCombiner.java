...
final class ComposePINVerbCombiner implements VerbCombiner {
   ...
   public final boolean recognize(Object object) {
      return !(object instanceof Object) ? false : ((Verb)object).getVerbGroupId() == 13685231;
   }
   ...
   public final Verb createWrapperVerb(Verb[] verbs, Verb defaultVerb) {
      ...
      return (Verb)(new Object(EmailResources.getString(prompt), EmailResources.getString(94), verbs[0].getOrdering(), verbs, descriptions, defaultVerb));
   }
}
