   ...
   public void setName(String text) {
      if (text != null) {
         if (this._nameField == null) {
            this._nameField = new EmailHeaderEditField$TooltipFieldManager$HeightRestrictedLabelField();
            this._nameField.setTag(ThemeUtilities.EMAIL_ADDRESS_TOOLTIP_NAME_TEXT_TAG);
   ...
   public void setAddress(String text) {
      if (text != null) {
         if (this._addressField == null) {
            this._addressField = new EmailHeaderEditField$TooltipFieldManager$HeightRestrictedLabelField();
            this._addressField.setTag(ThemeUtilities.EMAIL_ADDRESS_TOOLTIP_ADDRESS_TEXT_TAG);
