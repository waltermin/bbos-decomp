...
final class SyncWorkerThread extends Thread {
   ...
   private static final int MAX_FREE_WORKUNITS = 5;
   private static final long FLUSH_BUFFER_TIMEOUT = 180000L;
   private static final int IDLE_TIMEOUT = 120;
   private static final long SCAN_CONFIGURATION_TIMEOUT = 600000L;
   private static final long SEND_CONFIGURATION_TIMEOUT = 960000L;
   private static final int SEND_CONFIGURATION_REQUEST = 1;
   private static final int SEND_CONFIGURATION = 2;
   private static final int SEND_MESSAGE_LIST = 3;
   private static final int FLUSH_TRANSMIT_BUFFERS = 4;
   private static final int RELIABLE_TRANSMISSION_SCAN = 5;
   private static final int FLUSH_TRANSMIT_BUFFER = 6;
   private static final int SEND_FOLDER_LIST_REQUEST = 7;
   private static final int MESSAGE_LIST_RESTORED = 9;
   private static final int FOLDER_LIST_SYNCED = 10;
   private static final int SCAN_CONFIGURATIONS = 11;
   private static final int SLEEP = 12;
   private static final int TASK_FORCE_CONFIGURATION_QUERY = 1;
   private static final int TASK_ENABLE_SERVICE_RECORD = 2;
   private static final int TASK_SEND_MESSAGE_LIST = 3;
   private static final int TASK_SEND_FOLDER_LIST_REQUEST = 4;
   private static final int TASK_SEND_CONFIGURATION_QUERY_IF_MISSING = 5;
   private static final int TASK_SET_RESTORE_MESSAGE_LIST = 6;
   private static final int TASK_SCAN_CONFIGURATIONS = 8;
   private static final int TASK_SEND_FOLDER_LIST_REQUEST_OR_MESSAGE_LIST = 9;
   private static final int TASK_SEND_CONFIGURATION_QUERY = 10;
   private static final long NON_CONFIGURED_SB_CHECK_TIMEOUT = 900000L;
