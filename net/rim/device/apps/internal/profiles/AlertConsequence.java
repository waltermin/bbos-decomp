...
public final class AlertConsequence implements Consequence, SyncConverter {
   ...
   public static final long ALERT_CONSEQUENCE_ID;
   private static final int SILENT_VOLUME;
   private static final int LOW_VOLUME;
   private static final int MEDIUM_VOLUME;
   private static final int HIGH_VOLUME;
   private static final int POLY_SILENT_VOLUME;
   private static final int POLY_LOW_VOLUME;
   private static final int POLY_MEDIUM_VOLUME;
   private static final int POLY_HIGH_VOLUME;
   private static final int HEADSET_SILENT_VOLUME;
   private static final int HEADSET_LOW_VOLUME;
   private static final int HEADSET_MEDIUM_VOLUME;
   private static final int HEADSET_HIGH_VOLUME;
   public static final int OUTPUT_SPEAKER;
   public static final int OUTPUT_HEADSET;
   private static final int ALERT_CHOICE;
   private static final int TUNE_CHOICE;
   private static final int VOLUME_CHOICE;
   private static final int NUMBER_OF_BEEPS_CHOICE;
   private static final int REPEAT_NOTIFICATION_CHOICE;
   private static final int DO_NOT_DISTURB_CHOICE;
   private static final int ENABLE_BACKLIGHT;
   private static final int NOTIFY_DURING_VOICE_CALL_CHOICE;
   private static final int NUMBER_OF_VIBRATIONS_CHOICE;
   public static final int TYPE_NONE;
   public static final int TYPE_TONE;
   public static final int TYPE_VIBRATE;
   public static final int TYPE_VIBRATE_THEN_TONE;
   ...
   private static final int MINIMUM_TIME_BETWEEN_ALERTS;
