...
public final class Profiles
   ...
   private static final long PROFILES_ID;
   public static final byte PROFILE_IDENTIFIER_PROPERTY;
   public static final byte PROFILE_NAME_PROPERTY;
   public static final byte PROFILE_ENABLED_PROPERTY;
   public static final byte PROFILE_SOURCES_COUNT_PROPERTY;
   public static final byte PROFILE_CONSEQUENCES_COUNT_PROPERTY;
   public static final byte PROFILE_SOURCE_ID_PROPERTY;
   public static final byte PROFILE_CONSEQUENCE_ID_PROPERTY;
   public static final byte ALERT_CONFIGURATION_PROPERTY;
   public static final byte ALERT_CONFIGURATION_SETTINGS_PROPERTY;
   public static final byte ALERT_CONFIGURATION_TUNENAME_UNHOLSTERED_PROPERTY;
   public static final byte ALERT_CONFIGURATION_TUNENAME_HOLSTERED_PROPERTY;
   public static final byte ALERT_CONFIGURATION_END_PROPERTY;
   public static final byte PROFILE_ENABLED_OTA_PROPERTY;
   public static final byte ALERT_CONFIGURATION_TUNENAME_FQN_UNHOLSTERED_PROPERTY;
   public static final byte ALERT_CONFIGURATION_TUNENAME_FQN_HOLSTERED_PROPERTY;
   public static final byte OVERRIDE_IDENTIFIER_PROPERTY;
   public static final byte OVERRIDE_NAME_PROPERTY;
   public static final byte OVERRIDE_ENABLED_PROPERTY;
   public static final byte OVERRIDE_CONTEXT_PROPERTY;
   public static final byte OVERRIDE_PROFILE_UID_PROPERTY;
   public static final byte OVERRIDE_USE_TUNE_PROPERTY;
   public static final byte OVERRIDE_CUSTOM_TUNE_PROPERTY;
   public static final byte OVERRIDE_FROM_COUNT_PROPERTY;
   public static final byte OVERRIDE_FROM_UID_PROPERTY;
   public static final byte OVERRIDE_FROM_NAME_PROPERTY;
   public static final byte OVERRIDE_FROM_CONTACT_INFO_PROPERTY;
   public static final byte OVERRIDE_FROM_CONTACT_INFO_TYPE_PROPERTY;
   public static final byte OVERRIDE_FROM_END_PROPERTY;
   public static final byte PROFILE_NAME_PROPERTY_2;
   private static final long PROFILES_PERSISTENT_ID;
   private static final long ENABLED_PROFILE_PERSISTENT_ID;
   private static final long PREVIOUS_PROFILE_PERSISTENT_ID;
   private static final int PROFILES_DATABASE_VERSION;
   private static final int VERSION_WHERE_OVERRIDES_INTRODUCED;
   private static final String PROFILES_DATABASE_NAME;
   public static long PROFILES_APP_DESCRIPTOR_ID = 7850907034192831055L;
   private static long SOURCE_EXPIRE_AMOUNT = 259200000;
   public static final int LOUD_PROFILE_UID;
   public static final int DISCREET_PROFILE_UID;
   public static final int QUIET_PROFILE_UID;
   public static final int DEFAULT_PROFILE_UID;
   public static final int PHONE_ONLY_PROFILE_UID;
   public static final int OFF_PROFILE_UID;
   public static final int OBSOLETE_OUT_OF_BOX_OVERRIDE_UID;
   public static final int OUT_OF_BOX_OVERRIDE_UID;
   public static final int LAST_RIM_PROFILE_UID;
