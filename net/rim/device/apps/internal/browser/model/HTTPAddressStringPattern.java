...
public final class HTTPAddressStringPattern extends StringPattern implements BrowserConfigChangeListener {
   ...
   private static final int SCAN_BUFFER_LENGTH = 64;
   private static final int STATE_INIT = 0;
   private static final int STATE_H = 10;
   private static final int STATE_HT = 11;
   private static final int STATE_HTT = 12;
   private static final int STATE_HTTP = 13;
   private static final int STATE_HTTP_ = 14;
   private static final int STATE_HTTPS = 15;
   private static final int STATE_HTTPS_ = 16;
   private static final int STATE_W = 20;
   private static final int STATE_WW = 21;
   private static final int STATE_WWW = 22;
   private static final int STATE_WWW_ = 23;
   private static final int STATE_WA = 30;
   private static final int STATE_WAP = 31;
   private static final int STATE_WAP_ = 32;
   private static final int STATE_M = 40;
   private static final int STATE_MO = 41;
   private static final int STATE_MOB = 42;
   private static final int STATE_MOBI = 43;
   private static final int STATE_MOBIL = 44;
   private static final int STATE_MOBILE = 45;
   private static final int STATE_MOBILE_ = 46;
   private static final int STATE_Q = 50;
   private static final int STATE_QU = 51;
   private static final int STATE_QUE = 52;
   private static final int STATE_QUEU = 53;
   private static final int STATE_QUEUE = 54;
   private static final int STATE_QUEUE_ = 55;
   private static final int STATE_D = 60;
   private static final int STATE_DA = 61;
   private static final int STATE_DAT = 62;
   private static final int STATE_DATA = 63;
   private static final int STATE_DATA_ = 64;
   private static final int STATE_R = 70;
   private static final int STATE_RT = 71;
   private static final int STATE_RTS = 72;
   private static final int STATE_RTSP = 73;
   private static final int STATE_RTSP_ = 74;
