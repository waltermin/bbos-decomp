...
final class HTMLTableCaption extends HTMLGenericElement implements HTMLTableCaptionElement {
   public HTMLTableCaption(HTMLDOMInternalRepresentation dom, int nodeId) {
      super(dom, nodeId);
   }
