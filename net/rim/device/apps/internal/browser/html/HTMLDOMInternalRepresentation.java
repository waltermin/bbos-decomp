...
public class HTMLDOMInternalRepresentation {
   ...
   private Vector _attrValues = new Vector();
   private IntVector _attrIntValues = new IntVector();
   ...
   private IntLongHashtable _elementAttributeBitSet1 = new IntLongHashtable();
   private IntLongHashtable _elementAttributeBitSet2 = new IntLongHashtable();
   String _prefix;
   String _localName;
   ...
   private static final int NEXT_CHILD = 3;
   private static final int DATA = 4;
   static final int NO_HANDLE = 0;
   private static final int READONLY = 32768;
   private static final int DEFAULT_ATTRIBUTE = 16384;
   private static final int IN_DTD = 8192;
   private static final int REACHABLE = 4096;
   private static final int FLAG_MASK = 61440;
   private static final int ATTRIBUTE_TYPE_MASK = 3840;
   private static final int ATTRIBUTE_TYPE_SHIFT = 8;
   ...
   private static final int NAMESPACE_NODE = 13;
   ...
   String getAttributeValue(int node) {
      ...
      return (valueIndex & -2147483648) != 0
         ...
         : (String)this._attrValues.elementAt(valueIndex);
   }
