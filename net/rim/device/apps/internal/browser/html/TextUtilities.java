...
final class TextUtilities {
   ...
   static final int FONT_SIZE_XX_SMALL = 0;
   static final int FONT_SIZE_X_SMALL = 1;
   static final int FONT_SIZE_SMALL = 2;
   static final int FONT_SIZE_MEDIUM = 3;
   static final int FONT_SIZE_LARGE = 4;
   static final int FONT_SIZE_X_LARGE = 5;
   static final int FONT_SIZE_XX_LARGE = 6;
   static final int FONT_SIZE_XXX_LARGE = 7;
   static final int FONT_SIZE_SMALLER = 8;
   static final int FONT_SIZE_LARGER = 9;
   static final int FONT_STYLE_NORMAL = 0;
   static final int FONT_STYLE_ITALIC = 1;
   static final int FONT_STYLE_OBLIQUE = 2;
   static final int FONT_WEIGHT_NORMAL = 400;
   static final int FONT_WEIGHT_BOLD = 700;
   static final int FONT_WEIGHT_EXTRA_BOLD = 900;
   static final int FONT_WEIGHT_BOLDER = 1;
   static final int FONT_WEIGHT_LIGHTER = 2;
   ...
   static final int TEXT_DECORATION_LINE_THROUGH = 4;
   static final int TEXT_DECORATION_BLINK = 8;
   ...
   private static final int FONT_SIZE_DELTA = 200;
   private static final int SUPPORTED_FLAGS_MASK = 15;
   private static final int INDIVIDUAL_FLAG_MASK = 1;
   private static final int TEXT_COLOR = 0;
   private static final int LINK_COLOR = 4856319;
