...
public final class BrowserOptionsSync extends OTASyncCapableSyncItem implements BrowserOptionsChangeListener {
   ...
   private static final int EMBEDDED_RICH_CONTENT_FIELD;
   private static final int DEFAULT_FONT_SIZE_FIELD;
   private static final int DEFAULT_FONT_FAMILY_FIELD;
   private static final int SHOW_FULL_SCREEN_FIELD;
   private static final int CONFIRM_LEAVE_MODIFIED_PAGE_FIELD;
   private static final int JAVASCRIPT_ENABLED_OVERRIDE_FIELD;
   private static final int ALLOW_POPUP_ENABLED_OVERRIDE_FIELD;
   private static final int USE_FOREGROUND_BACKGROUND_COLOR_OVERRIDE_FIELD;
   private static final int USE_BACKGROUND_IMAGES_OVERRIDE_FIELD;
   private static final int USE_HTML_TABLE_SUPPORT_OVERRIDE_FIELD;
   private static final int ENABLE_CSS_OVERRIDE_FIELD;
   private static final int CSS_MEDIA_TYPE_OVERRIDE_FIELD;
   private static final int ENABLE_EMBEDDED_RICH_CONTENT_OVERRIDE_FIELD;
   private static final int JAVASCRIPT_LOCATION_ENABLED_FIELD;
   private static final int PAGE_CACHE_SIZE_FIELD;
   private static final int MINIMUM_FONT_SIZE_FIELD;
   private static final int MINIMUM_FONT_STYLE_FIELD;
   private static final int ENABLE_BSM_OVERRIDE_FIELD;
   private static final int CONFIG_VALUES_EDITABLE_OVERRIDE_FIELD;
   private static final int AUDIO_PLAYER_VOLUME_FIELD;
   private static final int STARTUP_PAGE_OVERRIDE_FIELD;
   private static final int IMAGE_QUALITY_FIELD;
   private static final int DEFAULT_VIEW_FIELD;
   private static final int ENABLE_MOBILE_CURSOR_FIELD;
