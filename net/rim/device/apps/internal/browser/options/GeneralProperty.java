...
public final class GeneralProperty extends BrowserProperty implements FieldChangeListener {
   ...
   public static final int URLS_PER_MORE_REQUEST_DEFAULT;
   public static final int URLS_PER_MORE_REQUEST_ALL;
   private static final long CONFIRM_QUIT_ON_ESCAPE_KEY;
   private static final int CONFIRM_QUIT_ON_ESCAPE_DEFAULT;
   private static final long CONFIRM_EXECUTE_SCRIPTS_KEY;
   private static final int CONFIRM_EXECUTE_SCRIPTS_DEFAULT;
   private static final long CLEAR_CACHE_ON_CLOSE_KEY;
   private static final int CLEAR_CACHE_ON_CLOSE_DEFAULT;
   private static final long DELETE_BROWSER_SERVICE_RECORDS_KEY;
   private static final int DELETE_BROWSER_SERVICE_RECORDS_DEFAULT;
   private static final long JAVASCRIPT_ENABLED_OVERRIDES_KEY;
   private static final long ALLOW_POPUP_ENABLED_OVERRIDES_KEY;
   private static final long JAVASCRIPT_LOCATION_ENABLED_KEY;
   private static final int JAVASCRIPT_LOCATION_ENABLED_DEFAULT;
   private static final long DEFAULT_CHARSET_KEY;
   private static final long DEFAULT_CHARSET_MODE_KEY;
   public static final int DEFAULT_CHARSET_MODE_AUTO;
   public static final int DEFAULT_CHARSET_MODE_MANUAL;
   private static final long DEFAULT_FONT_FAMILY_KEY;
   private static final long DEFAULT_FONT_SIZE_KEY;
   private static final long MINIMUM_FONT_SIZE_KEY;
   private static final int FONT_SIZE_MINIMUM;
   private static final int FONT_SIZE_MAXIMUM;
   public static final int MINIMUM_FONT_SIZE_LOCALE_ZH;
   private static final long MINIMUM_FONT_STYLE_KEY;
   ...
   private static final long DO_NOT_CACHE_SECURE_PAGES_KEY;
   private static final int DO_NOT_CACHE_SECURE_PAGES_DEFAULT;
   private static final long CONFIRM_LEAVE_MODIFIED_PAGE_KEY;
   private static final int CONFIRM_LEAVE_MODIFIED_PAGE_DEFAULT;
   private static final long ANIMATION_COUNT_KEY;
   public static final int ANIMATION_COUNT_NEVER;
   public static final int ANIMATION_COUNT_ONCE;
   public static final int ANIMATION_COUNT_10_TIMES;
   public static final int ANIMATION_COUNT_100_TIMES;
   public static final int ANIMATION_COUNT_IMAGE_SPECIFIED;
   private static final int ANIMATION_COUNT_DEFAULT;
   private static final long IMAGE_QUALITY_KEY;
   private static final long DEFAULT_VIEW_KEY;
   private static final long FOREGROUND_BACKGROUND_COLOR_OVERRIDES_KEY;
   private static final long BACKGROUND_IMAGES_OVERRIDES_KEY;
   private static final long USE_HTML_TABLES_OVERRIDES_KEY;
   private static final long EMBEDDED_RICH_CONTENT_OVERRIDES_KEY;
   private static final long HOME_PAGE_URL_OVERRIDES_KEY;
   private static final long SHOW_IMAGES_OVERRIDES_KEY;
   private static final long SHOW_IMAGE_PLACEHOLDERS_OVERRIDES_KEY;
   private static final long CONTENT_MODE_OVERRIDES_KEY;
   private static final long EMULATION_MODE_OVERRIDES_KEY;
   private static final long ENABLE_BSM_OVERRIDES_KEY;
   private static final long CONFIG_VALUES_EDITABLE_OVERRIDES_KEY;
   private static final long PREVIOUS_SIM_ID_KEY;
   private static final long AUTHENTICATION_CREDENTIALS_KEY;
   private static final long ENABLE_CSS_OVERRIDES_KEY;
   private static final long CSS_MEDIA_TYPE_OVERRIDES_KEY;
   private static final long STARTUP_PAGE_OVERRIDES_KEY;
   private static final long DEFAULT_BROWSER_CONFIG_CHOOSER_KEY;
   private static final long DEFAULT_BROWSER_CONFIG_CHOOSER_KEY_MDS;
   private static final long DEFAULT_BROWSER_CONFIG_CHOOSER_KEY_WAP;
   private static final long DEFAULT_BROWSER_CONFIG_CHOOSER_KEY_WPTCP;
   private static final long PREFERRED_BROWSER_CONFIG_CHOOSER_KEY;
   private static final long PREFERRED_BROWSER_CONFIG_CHOOSER_KEY_MDS;
   private static final long PREFERRED_BROWSER_CONFIG_CHOOSER_KEY_WAP;
   private static final long SHOW_FULL_SCREEN_KEY;
   private static final int SHOW_FULL_SCREEN_DEFAULT;
   private static final long ACCEPT_COOKIES_KEY;
   private static final int DEFAULT_ACCEPT_COOKIES;
   private static final long RAW_DATA_CACHE_SIZE_KEY;
   private static final int RAW_DATA_CACHE_DEFAULT_SIZE;
   private static final long PAGE_CACHE_SIZE_KEY;
   private static final int PAGE_CACHE_DEFAULT_SIZE;
   private static final long DEFAULT_WAP_CONFIG_DETERMINED_KEY;
   private static final long DEFAULT_MDS_CONFIG_DETERMINED_KEY;
   private static final int DEFAULT_CONFIG_DETERMINED_DEFAULT;
   private static final long MENU_DELAY_TIME_KEY;
   private static final int MENU_DELAY_TIME_DEFAULT = InternalServices.isReducedFormFactor() ? 500 : 300;
   private static final long AUDIO_PLAYER_VOLUME_KEY;
   private static final int AUDIO_PLAYER_VOLUME_DEFAULT;
   public static final long AUDIO_PLAYER_VOLUME_HANDSET_KEY;
   public static final long AUDIO_PLAYER_VOLUME_HANDSFREE_KEY;
   public static final long AUDIO_PLAYER_VOLUME_BLUETOOTH_KEY;
   public static final long AUDIO_PLAYER_VOLUME_HEADSET_KEY;
   public static final long AUDIO_PLAYER_VOLUME_HEADSET_HANDSFREE_KEY;
   public static final long AUDIO_PLAYER_VOLUME_BLUETOOTH_A2DP_KEY;
   public static final long ENABLE_MOBILE_CURSOR_KEY;
   public static final int ENABLE_MOBILE_CURSOR_DEFAULT;
   public static final int CONFIRM_QUIT_ON_EXIT;
   public static final int CONFIRM_EXECUTE_SCRIPTS;
   public static final int ANIMATION_COUNT;
   public static final int CLEAR_CACHE_ON_CLOSE;
   public static final int USE_HTML_TABLE_SUPPORT_OVERRIDE;
   public static final int AUTHENTICATION_CREDENTIALS;
   public static final int ENABLE_CSS_OVERRIDE;
   public static final int USE_BACKGROUND_IMAGES_OVERRIDE;
   public static final int USE_FOREGROUND_BACKGROUND_COLOR_OVERRIDE;
   public static final int UA_PROF_URI;
   public static final int DO_NOT_CACHE_SECURE_PAGES;
   public static final int CSS_MEDIA_TYPE_OVERRIDE;
   public static final int DELETE_BROWSER_SERVICE_RECORDS;
   public static final int DEFAULT_CHARSET;
   public static final int DEFAULT_CHARSET_MODE;
   public static final int HOME_PAGE_URL_OVERRIDE;
   public static final int SHOW_IMAGES_OVERRIDE;
   public static final int SHOW_IMAGES_PLACEHOLDERS_OVERRIDE;
   public static final int CONTENT_MODE_OVERRIDE;
   public static final int EMULATION_OVERRIDE;
   public static final int SIM_ID;
   public static final int JAVASCRIPT_ENABLED_OVERRIDE;
   public static final int ALLOW_POPUP_ENABLED_OVERRIDE;
   public static final int JAVASCRIPT_LOCATION_ENABLED;
   public static final int CONFIRM_LEAVE_MODIFIED_PAGE;
   public static final int ENABLE_EMBEDDED_RICH_CONTENT_OVERRIDE;
   public static final int DEFAULT_FONT_FACE;
   public static final int DEFAULT_FONT_SIZE;
   public static final int DEFAULT_BROWSER_CONFIGS;
   public static final int SHOW_FULL_SCREEN;
   public static final int ACCEPT_COOKIES;
   public static final int RAW_DATA_CACHE_SIZE;
   public static final int DEFAULT_WAP_CONFIG_DETERMINED;
   public static final int DEFAULT_MDS_CONFIG_DETERMINED;
   public static final int PAGE_CACHE_SIZE;
   public static final int MENU_DELAY_TIME;
   public static final int MINIMUM_FONT_SIZE;
   public static final int MINIMUM_FONT_STYLE;
   public static final int ENABLE_BSM_OVERRIDE;
   public static final int CONFIG_VALUES_EDITABLE_OVERRIDE;
   public static final int AUDIO_PLAYER_VOLUME;
   public static final int STARTUP_PAGE_OVERRIDE;
   public static final int IMAGE_QUALITY;
   public static final int DEFAULT_VIEW;
   public static final int AUDIO_PLAYER_VOLUME_HANDSET;
   public static final int AUDIO_PLAYER_VOLUME_HANDSFREE;
   public static final int AUDIO_PLAYER_VOLUME_BLUETOOTH;
   public static final int AUDIO_PLAYER_VOLUME_HEADSET;
   public static final int ENABLE_MOBILE_CURSOR;
   public static final int AUDIO_PLAYER_VOLUME_HEADSET_HANDSFREE;
   public static final int AUDIO_PLAYER_VOLUME_BLUETOOTH_A2DP;
