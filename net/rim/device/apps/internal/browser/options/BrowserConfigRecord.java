...
public final class BrowserConfigRecord {
   ...
   public static final byte ENCODED_TYPE_HOME_PAGE_URL = 1;
   public static final byte ENCODED_TYPE_STARTUP_PAGE_VALUE = 2;
   public static final byte ENCODED_TYPE_TRANSPORT_SERVICE_CID = 3;
   public static final byte ENCODED_TYPE_TRANSPORT_SERVICE_UID = 4;
   public static final byte ENCODED_TYPE_CONFIG_VALUES_EDITABLE = 5;
   public static final byte ENCODED_TYPE_TIMEOUT = 6;
   public static final byte ENCODED_TYPE_CONSTRAINED_NAVIGATION = 7;
   public static final byte ENCODED_TYPE_UAPROF_URI = 8;
   public static final byte ENCODED_TYPE_CONSTRAINED_CONTENT_MODE = 9;
   public static final byte ENCODED_TYPE_DEFAULT_CONTENT_MODE = 10;
   public static final byte ENCODED_TYPE_RIBBON_TITLE = 11;
   public static final byte ENCODED_TYPE_CONFIG_TYPE = 12;
   public static final byte ENCODED_TYPE_WTLS_MODE = 13;
   public static final byte ENCODED_TYPE_ICON = 14;
   public static final byte ENCODED_TYPE_WTLS_CLIENT_ID_TYPE = 15;
   public static final byte ENCODED_TYPE_WTLS_CLIENT_ID_VALUE = 16;
   public static final byte ENCODED_TYPE_DEFAULT_EMULATION_MODE = 17;
   public static final byte ENCODED_TYPE_SHOW_IMAGES_VALUE = 18;
   public static final byte ENCODED_TYPE_SHOW_IMAGE_PLACEHOLDERS_VALUE = 19;
   public static final byte ENCODED_TYPE_AUTO_START_VALUE = 20;
   public static final byte ENCODED_TYPE_BRANDING_ICON_VALUE = 21;
   public static final byte ENCODED_TYPE_VENDOR_ID_VALUE = 22;
   public static final byte ENCODED_TYPE_SEND_PHONE_NUMBER_VALUE = 23;
   public static final byte ENCODED_TYPE_PROVISIONED_BOOKMARKS_FOLDER_NAME = 24;
   public static final byte ENCODED_TYPE_RIBBON_POSITION = 25;
   public static final byte ENCODED_TYPE_HTTPS_ENCRYPTION = 26;
   public static final byte ENCODED_TYPE_CONSTRAINED_SAVING = 27;
   public static final byte ENCODED_TYPE_APP_DOWNLOAD_MODULE_NAME = 28;
   public static final byte ENCODED_TYPE_ICON_URL = 29;
   public static final byte ENCODED_TYPE_HIDDEN_FROM_RIBBON = 30;
   public static final byte ENCODED_TYPE_BROWSER_KEY_URL = 31;
   public static final byte ENCODED_TYPE_PROVISIONED_BOOKMARKS_INTERACTION = 32;
   public static final byte ENCODED_TYPE_CSS_ENABLED = 33;
   private static final byte ENCODED_TYPE_CSS_MEDIA_TYPE = 34;
   public static final byte ENCODED_TYPE_USE_FOREGROUND_BACKGROUND_COLORS = 35;
   public static final byte ENCODED_TYPE_HTML_TABLES_ENABLED = 36;
   public static final byte ENCODED_TYPE_EMBEDDED_MEDIA_ENABLED = 37;
   public static final byte ENCODED_TYPE_JAVASCRIPT_ENABLED = 38;
   public static final byte ENCODED_TYPE_ALLOW_JAVASCRIPT_POPUPS = 39;
   public static final byte ENCODED_TYPE_USE_BACKGROUND_IMAGES = 40;
   public static final byte ENCODED_TYPE_LOCALIZED_STRINGS = 41;
   public static final byte ENCODED_TYPE_BOOKMARKS_FOLDER_NAME = 42;
   public static final byte ENCODED_TYPE_BSM_ENABLED = 43;
   public static final byte ENCODED_TYPE_HELP_LINKS = 44;
   public static final byte ENCODED_TYPE_HELP_GROUP_LABEL = 45;
   public static final byte ENCODED_TYPE_MORE_IMAGES_URL = 46;
   public static final byte ENCODED_TYPE_MORE_THEMES_URL = 47;
   public static final byte ENCODED_TYPE_MORE_TUNES_URL = 48;
   public static final byte ENCODED_TYPE_APP_DOWNLOAD_MODULE_VERSION = 49;
   public static final byte ENCODED_TYPE_APP_DOWNLOAD_UPGRADE = 50;
   public static final byte ENCODED_TYPE_RIM_BRANDED = 51;
   public static final byte ENCODED_TYPE_SEND_PROFILE_DIFFS = 52;
   public static final byte ENCODED_TYPE_PROMPT_ENABLE_JAVASCRIPT = 53;
   public static final byte ENCODED_TYPE_RIBBON_ICON_TYPE = 54;
   public static final byte ENCODED_TYPE_USE_SEPARATE_ICON = 55;
   public static final byte ENCODED_TYPE_DOMAINS = 56;
   public static final byte ENCODED_TYPE_PROVISIONED_BOOKMARKS_EXPAND_FOLDER = 57;
   public static final byte ENCODED_TYPE_JAVASCRIPT_WATCHDOG_TIMEOUT = 58;
   public static final byte ENCODED_TYPE_BOOKMARK_LOW = 60;
   public static final byte ENCODED_TYPE_BOOKMARK = 60;
   public static final byte ENCODED_TYPE_BOOKMARK_HIGH = 99;
   ...
   public static final int STARTUP_BOOKMARKS_PAGE = 0;
   public static final int STARTUP_HOME_PAGE = 1;
   public static final int STARTUP_LAST_PAGE = 2;
   public static final int STARTUP_STARTUP_PAGE = 3;
   public static final int STARTUP_PAGE_VALUE_DEFAULT = 3;
   ...
   public static final int CONFIG_VALUES_EDITABLE_BD_BD = 0;
   public static final int CONFIG_VALUES_EDITABLE_ED_ED = 1;
   public static final int CONFIG_VALUES_EDITABLE_ED_BD = 2;
   public static final int CONFIG_VALUES_EDITABLE_ED_NA = 3;
   public static final int CONFIG_VALUES_EDITABLE_BD_NA = 4;
   public static final int CONFIG_VALUES_EDITABLE_NA_NA = 5;
   public static final int CONFIG_VALUES_EDITABLE_DEFAULT = 1;
   public static final int CONSTRAINED_CONTENT_MODE_UNCONSTRAINED = -1;
   public static final int CONSTRAINED_CONTENT_MODE_WML_ONLY = 0;
   public static int CONSTRAINED_CONTENT_MODE_DEFAULT = -1;
   public static final int CONTENT_MODE_WML_ONLY = 0;
   public static final int CONTENT_MODE_WML_AND_HTML = 1;
   public static final int CONTENT_MODE_HTML_ONLY = 2;
   public static final int CONTENT_MODE_DEFAULT = 1;
   public static final int CONFIG_TYPE_WAP = 0;
   public static final int CONFIG_TYPE_MDS_PRIVATE = 1;
   public static final int CONFIG_TYPE_BWC = 2;
   public static final int CONFIG_TYPE_DEVICE_WPTCP = 3;
   public static final int CONFIG_TYPE_MDS_PUBLIC = 4;
   public static final int CONFIG_TYPE_TEAMON = 5;
   public static final int CONFIG_TYPE_APP_DOWNLOAD = 6;
   public static final int CONFIG_TYPE_WAP_WPTCP = 7;
   public static final int CONFIG_TYPE_MDS_PUBLIC_WPTCP = 8;
   public static final int DEFAULT_EMULATION_MODE_RIM = 1;
   public static final int DEFAULT_EMULATION_MODE_OPENWAVE = 2;
   public static final int DEFAULT_EMULATION_MODE_OPENWAVE_GATEWAY = 3;
   public static final int DEFAULT_EMULATION_MODE_IE = 4;
   public static final int DEFAULT_EMULATION_MODE_POCKET_IE = 5;
   public static final int DEFAULT_EMULATION_MODE_NETSCAPE = 6;
   public static final int DEFAULT_EMULATION_MODE_DEFAULT = 1;
   public static final int SHOW_IMAGES_NONE = 0;
   public static final int SHOW_IMAGES_WML_ONLY = 1;
   public static final int SHOW_IMAGES_WML_AND_HTML = 2;
   public static final int SHOW_IMAGE_PLACEHOLDERS_DEFAULT = 0;
   public static final int SEND_PHONE_NUMBER_NEVER = 0;
   public static final int SEND_PHONE_NUMBER_OTA_REPORTS_ONLY = 1;
   public static final int SEND_PHONE_NUMBER_DEFAULT = 0;
   public static final int RIBBON_POSITION_DEFAULT = 0;
   public static final int HTTPS_ENCRYPTION_REQUIRED_END_TO_END = 0;
   public static final int HTTPS_ENCRYPTION_DESIRED_ALLOW_GAP_END_TO_END = 1;
   public static final int HTTPS_ENCRYPTION_REQUIRED_ALLOW_GAP = 2;
   public static final int HTTPS_ENCRYPTION_NOT_REQUIRED = 3;
   public static final int CONSTRAINED_SAVING_NONE = 0;
   public static final int CONSTRAINED_SAVING_IMAGES = 1;
   public static final int CONSTRAINED_SAVING_AUDIO = 2;
   public static final int PROVISIONED_BOOKMARKS_ALWAYS_SHOW = 0;
   public static final int PROVISIONED_BOOKMARKS_SHOW_IF_NO_OTHERS = 1;
   public static final int PROVISIONED_BOOKMARKS_SHOW_ONLY_IN_THIS_BROWSER = 2;
   public static final int PROVISIONED_BOOKMARKS_INTERACTION_DEFAULT = 0;
   public static final int CSS_MEDIA_TYPE_HANDHELD = 0;
   public static final int CSS_MEDIA_TYPE_SCREEN = 1;
   public static final int CSS_MEDIA_TYPE_DEFAULT = 1;
   public static final int CONSTRAINED_NAVIGATION_NONE = 0;
   public static final int CONSTRAINED_NAVIGATION_RESTRICTED = 1;
   public static final int CONSTRAINED_NAVIGATION_LOCKED_DOWN = 2;
   public static final int CONSTRAINED_NAVIGATION_DEFAULT = 0;
   public static final int PROVISIONED_BOOKMARKS_EXPAND_FOLDER_ALWAYS = 0;
   public static final int PROVISIONED_BOOKMARKS_EXPAND_FOLDER_NEVER = 1;
   public static final int PROVISIONED_BOOKMARKS_EXPAND_FOLDER_ONLY_IN_THIS_BROWSER = 2;
   public static final int PROVISIONED_BOOKMARKS_EXPAND_FOLDER_DEFAULT = 0;
   public static final int JAVASCRIPT_WATCHDOG_TIMEOUT_DEFAULT = 5000;
   private static final byte VERSION = 2;
   public static String SERVICE_CID = "BrowserConfig";
   private static final String APP_DOWNLOAD_PREFIX = "AD_";
   public static int INVALID_VALUE = -1;
   public static final String DEFAULT_BLACKBERRY_BROWSER_HOME_PAGE = "http://mobile.blackberry.com/";
   public static final String DEFAULT_BLACKBERRY_BROWSER_RIBBON_TITLE = "BlackBerry Browser";
   public static final String BLACKBERRY_BROWSER_CONFIG_DESCRIPTION = "RIM BlackBerry Browser Config";
   private static final boolean JAVASCRIPT_ENABLED_DEFAULT = false;
   private static final boolean JAVASCRIPT_POPUPS_ALLOWED_DEFAULT = false;
   private static final boolean EMBEDDED_MEDIA_ENABLED_DEFAULT = false;
   ...
   public static final int BRANDING_ICON_NONE = -1;
   public static final String VENDOR_ID_NONE = null;
   private static final long BUNDLE_ID = 1637489727423389893L;
   public static final String BUNDLE_NAME = "net.rim.device.apps.internal.browser.options.BrowserConfigRecord.BUNDLE_ID";
   private static Object _bundleSyncObject = new Object();
   private static final int STATE_LOCALE_OR_TYPECODE = 0;
   private static final int STATE_LOCALE = 1;
   private static final int STATE_TYPECODE = 2;
   private static final int STATE_TRANSLATION = 3;
