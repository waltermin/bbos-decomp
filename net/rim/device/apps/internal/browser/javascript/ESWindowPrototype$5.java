...
class ESWindowPrototype$5 extends JavaScriptHostFunction {
   private final ESWindowPrototype this$0;

   ESWindowPrototype$5(ESWindowPrototype _1, String x0, String x1, int x2) {
      super(x0, x1, x2);
      this.this$0 = _1;
   }
   ...
   public long run() {
      ...
      if (windowObj instanceof ESWindow) {
         ...
         if (count == 1) {
            try {
               int timerId = Convert.toInt32(this.getParm(0));
               ((ESWindow)windowObj)._timer.deque(timerId);
            } finally {
               return Value.NULL;
            }
         }
