...
final class ESHTMLDocument extends ESNode {
   ...
   public ESHTMLDocument(JavaScriptEngine engine, HTMLDocument doc, ESLocation location) {
      ...
      ESObject emptyArray = (ESObject)(new Object());
      ...
      this.addField(Names.classes, 29, Value.makeObjectValue((ESObject)(new Object())));
      ...
      this.addField(Names.ids, 29, Value.makeObjectValue((ESObject)(new Object())));
      ...
      this.addField(Names.tags, 28, Value.makeObjectValue((ESObject)(new Object())));
