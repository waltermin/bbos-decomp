...
class ESHistoryPrototype$1 extends JavaScriptHostFunction {
   private final ESHistoryPrototype this$0;

   ESHistoryPrototype$1(ESHistoryPrototype _1, String x0, String x1, int x2) {
      super(x0, x1, x2);
      this.this$0 = _1;
   }
   ...
   public long run() {
      ...
      if (renderingApplication != null) {
         renderingApplication.eventOccurred((Event)(new Object(content, -1, true, 0)));
      }
