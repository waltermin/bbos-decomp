...
class ESNodePrototype$4 extends JavaScriptHostFunction {
   ...
   ESNodePrototype$4(ESNodePrototype _1, String x0, String x1, int x2) {
      super(x0, x1, x2);
      this.this$0 = _1;
   }
   ...
   public long run() {
      ...
      try {
         return JavaScriptEngine.getInstance().lookupElementToESObjectLong(node.appendChild(newChild));
