...
class ESWindowPrototype$13 extends JavaScriptHostFunction {
   private final ESWindowPrototype this$0;

   ESWindowPrototype$13(ESWindowPrototype _1, String x0, String x1, int x2) {
      super(x0, x1, x2);
      this.this$0 = _1;
   }
      ...
      if (windowObj instanceof ESWindow) {
         ...
         if (count >= 2) {
            try {
               ...
               return Value.makeIntegerValue(((ESWindow)windowObj)._timer.enque(method, timeout, true));
            } finally {
               return Value.NULL;
            }
         }
