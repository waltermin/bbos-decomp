...
final class JADAttributeParser extends Hashtable implements Persistable {
   ...
   static final String MIDLET_NAME = "MIDlet-Name";
   static final String MIDLET_VERSION = "MIDlet-Version";
   static final String MIDLET_VENDOR = "MIDlet-Vendor";
   static final String MIDLET_DESCRIPTION = "MIDlet-Description";
   static final String MIDLET_JAR_URL = "MIDlet-Jar-URL";
   static final String MIDLET_JAR_SIZE = "MIDlet-Jar-Size";
   static final String MIDLET_INSTALL_NOTIFY = "MIDlet-Install-Notify";
   static final String MIDLET_DELETE_NOTIFY = "MIDlet-Delete-Notify";
   static final String MIDLET_JAR_RSA_SHA1 = "MIDlet-Jar-RSA-SHA1";
   static final String MICROEDITION_PROFILE = "MicroEdition-Profile";
   static final String MICROEDITION_CONFIGURATION = "MicroEdition-Configuration";
   static final String RIM_DOWNLOAD_LABEL = "RIM-Download-Label";
   static final String RIM_MIDLET_SIGNER = "RIM-MIDlet-Signer";
   static final String RIM_JAD_URL = "RIM-JAD-URL";
   static final String RIM_COD_URL = "RIM-COD-URL";
   private static final int SizeOfRIM_COD_URL = 11;
   private static final String RIM_COD_SIZE = "RIM-COD-Size";
   private static final String RIM_TRANSCODED_JAR = "RIM-Transcoded-Jar";
   private static final int MIDLET_NAME_MASK = 1;
   private static final int MIDLET_VERSION_MASK = 2;
   private static final int MIDLET_VENDOR_MASK = 4;
   private static final int MIDLET_JAR_URL_MASK = 8;
   private static final int MIDLET_JAR_SIZE_MASK = 16;
   private static final int RIM_COD_MASK = 8;
   private static final int RIM_COD_SIZE_MASK = 16;
   private static final int REQUIRED_FIELDS_MASK = 31;
   private static final int VALUE_TYPE_STRING = 0;
   private static final int VALUE_TYPE_REQUIRED_STRING = 1;
   private static final int VALUE_TYPE_URL = 2;
   private static final int VALUE_TYPE_NONNEGATIVE_INTEGER = 3;
   private static final int VALUE_TYPE_VERSION = 4;
   private static final int VERSION_STATE_MAJOR = 0;
   private static final int VERSION_STATE_MINOR = 1;
   private static final int VERSION_STATE_MICRO = 2;
