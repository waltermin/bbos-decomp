...
final class ZoomVerb extends ZoomAndPanVerb {
   ...
   private String _label = this._resources.getString(20);

   ZoomVerb(Field field, Object player) {
      super(field, player);
   }
   ...
   public final void setStartingState() {
      ZoomAndPanVerb._zpScreen.setStartingState(1);
   }
}
