...
final class AtomRenderer extends Renderer {
   ...
   public final void finishProcessingData() {
      ...
      // 18: putfield net/rim/device/apps/internal/browser/webfeed/AtomRenderer._in Ljava/io/InputStream;
      // 1b: aload 0
      ...
      // 71: putfield net/rim/device/apps/internal/browser/webfeed/AtomRenderer._contentRead Lnet/rim/device/api/browser/field/ContentReadEvent;
      // 74: aload 0
      // 75: getfield net/rim/device/apps/internal/browser/webfeed/AtomRenderer._contentRead Lnet/rim/device/api/browser/field/ContentReadEvent;
      // 78: lload 3
      // 79: l2i
      // 7a: invokevirtual net/rim/device/api/browser/field/ContentReadEvent.setItemsToRead (I)V
      // 7d: aload 0
      // 7e: getfield net/rim/device/apps/internal/browser/webfeed/AtomRenderer._contentRead Lnet/rim/device/api/browser/field/ContentReadEvent;
      // 81: bipush 1
      // 82: invokevirtual net/rim/device/api/browser/field/ContentReadEvent.setItemsToReadInBytes (Z)V
      // 85: aload 0
      // 86: getfield net/rim/device/apps/internal/browser/webfeed/AtomRenderer._contentRead Lnet/rim/device/api/browser/field/ContentReadEvent;
      // 89: aload 0
      // 8a: getfield net/rim/device/apps/internal/browser/webfeed/AtomRenderer._pipePosition Lnet/rim/device/internal/browser/util/PipeContext;
      ...
      // 97: aload 0
      // 98: getfield net/rim/device/apps/internal/browser/webfeed/AtomRenderer._contentRead Lnet/rim/device/api/browser/field/ContentReadEvent;
      ...
      // a1: aload 2
      // a2: aload 0
      // a3: getfield net/rim/device/apps/internal/browser/webfeed/AtomRenderer._in Ljava/io/InputStream;
      // a6: new net/rim/device/apps/internal/browser/webfeed/AtomRenderer$HandlerHelper
      // a9: dup
      // aa: aload 0
      // ab: aconst_null
      // ac: invokespecial net/rim/device/apps/internal/browser/webfeed/AtomRenderer$HandlerHelper.<init> (Lnet/rim/device/apps/internal/browser/webfeed/AtomRenderer;Lnet/rim/device/apps/internal/browser/webfeed/AtomRenderer$1;)V
   ...
   static final RenderingApplication access$700(AtomRenderer x0) {
      return x0._renderingApplication;
   }

   static final RenderingApplication access$1400(AtomRenderer x0) {
      return x0._renderingApplication;
   }

   static final RenderingApplication access$1500(AtomRenderer x0) {
      return x0._renderingApplication;
   }
}
