...
class DownloadManager$1 extends Thread {
   ...
   public void run() {
      if (!(this.this$0._currentResourceRequest instanceof FetchRequest)) {
         if (this.this$0._renderingApp != null && this.this$0._currentResourceRequest instanceof Object) {
            this.this$0._renderingApp.eventOccurred((Event)(new Object(this, (RequestedResource)this.this$0._currentResourceRequest)));
         }
      } else {
