...
class ITAdminTransmissionService extends AbstractTransmissionService implements PacketReceiver, GlobalEventListener {
   ...
   private static final byte ITADMIN_VERSION;
   private static final String ITADMIN_CID;
   private static final int ITADMIN_COMMAND_TIMEOUT_THRESHOLD;
   private static final byte MULTIPLE_COMMANDS;
   private static final byte SET_PASSWORD;
   private static final byte GET_PASSWORD_STATUS;
   private static final byte SET_IT_POLICY;
   private static final byte GET_IT_POLICY;
   private static final byte CHANGE_PASWORD;
   private static final byte KILL_HANDHELD;
   private static final byte LOCK_HANDHELD;
   private static final byte SET_OWNER_INFO;
   private static final byte SET_PEER_TO_PEER_KEY;
   private static final byte UPDATE_SERVICE_DATA;
   private static final byte SWITCH_SERVICE;
   private static final byte DELETE_SERVICE;
   private static final byte REQUEST_KEY_REGENERATION;
   private static final byte FLUSH_HANDHELD_AGENT;
   private static final byte REQUEST_UPDATE_SERVICE_DATA;
   private static final byte COMMAND_UNRESOLVED;
   private static final byte REJECT_TIMESTAMP;
   private static final byte REJECT_SECURITY_VIOLATION;
   private static final byte EVENT_AUTHENTICATION_FAILED;
   private static final byte EVENT_MALFORMED_POLICY;
   private static final byte SEND_ACK_FLAG;
   private static final int ACK_SUCCESSFUL;
   private static final int ACK_FAILURE;
   private static final int CURRENT_SERVER_UID;
   private static final int NEW_SERVER_UID;
   private static final int TO_BE_DELETED_SERVER_UID;
   private static final byte PASSWORD;
   private static final byte D_VALUE;
   private static final byte K_VALUE;
   private static final byte H_VALUE;
   private static final byte INVALID_PASSWORD;
   private static final byte UNKNOWN_COMMAND_VERSION;
   private static final byte CONTENT_PROTECTION_ENABLED;
   private static final byte SET_PASSWORD_FAILED;
   private static final byte MISSING_PUBLIC_BES_KEY;
   private static final byte INCOMPATIBLE_BES;
   private static final byte OWNER_NAME;
   private static final byte OWNER_INFO;
