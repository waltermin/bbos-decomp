...
public final class LegacyFilterConvert {
   ...
   private static final int KEYWORD_LEN = 50;
   private static final int FOLDER_LEN = 50;
   private static final int ANY_FIELD_TAG = -1;
   private static final int TO_FIELD_TAG = 1;
   private static final int CC_FIELD_TAG = 2;
   private static final int BCC_FIELD_TAG = 3;
   private static final int FROM_FIELD_TAG = 5;
   public static final int SEND_AND_RECEIVED_IDX = 0;
   public static final int SEND_ONLY_IDX = 1;
   public static final int RECEIVED_ONLY_IDX = 2;
   public static final int SAVED_ONLY_IDX = 3;
   private static final int OFFSET_TITLE = 0;
   private static final int OFFSET_SHORTCUT = 50;
   private static final int OFFSET_NAME = 51;
   private static final int OFFSET_NAME_FIELD = 101;
   private static final int OFFSET_SUBJECT = 102;
   private static final int OFFSET_BODY = 152;
   private static final int OFFSET_SEARCH_ALL_FOLDERS = 202;
   private static final int OFFSET_FOLDER = 204;
   private static final int OFFSET_FOLDER_SRVNAME_HASH = 204;
   private static final int OFFSET_FOLDER_SRVUID_HASH = 208;
   private static final int OFFSET_FOLDER_ID = 212;
   private static final int OFFSET_FOLDER_TYPE = 214;
   private static final int OFFSET_FOLDER_RESERVED = 215;
   private static final int OFFSET_SEARCH_FOLDER_NAME = 216;
   private static final int OFFSET_INCLUDE_TX = 266;
   private static final int OFFSET_INCLUDE_RX = 267;
   private static final int OFFSET_INCLUDE_SAVED_ONLY = 268;
   private static final int OFFSET_INCLUDE_UNLOCKED = 269;
   private static final int OFFSET_INCLUDE_DELETED = 270;
   private static final int OFFSET_INCLUDE_MSGS = 272;
   private static final int OFFSET_LOCALE = 276;
   private static final int OFFSET_MAX = 280;
   public static final int CPP_FOLDER_SRVNAME_HASH = 0;
   public static final int CPP_FOLDER_SRVUID_HASH = 4;
   public static final int CPP_FOLDER_ID = 8;
   public static final int CPP_FOLDER_TYPE = 10;
   public static final int CPP_FOLDER_RESERVED = 11;
   public static final int CPP_FOLDER_SIZE = 12;
