...
public final class MMSClientServiceBook {
   private static final int MMSC_VERSION;
   private static final int MAX_MESSAGE_SIZE;
   private static final int AUTO_RETRIEVAL_MODE;
   private static final int RESTRICTED_SEND_MODE;
   private static final int MAX_IMAGE_WIDTH;
   private static final int MAX_IMAGE_HEIGHT;
   private static final int MAX_RECIPIENT_COUNT;
   private static final int MAX_RECIPIENT_BYTE_SIZE;
   private static final int SEND_TEXT_AS_SIMPLE_CONTENT;
   private static final int CONNECTION_TIMEOUT;
   private static final int ALLOW_HOME_ONLY;
   private static final int MAX_TRANSPORT_THREADS;
   private static final int RESTRICTED_SIZE_MODE;
   private static final int DEFAULT_RECEPTION_MODE;
   private static final int DEFAULT_AUTO_RETRIEVAL_MODE;
   private static final int DEFAULT_OPTION_FLAGS;
   private static final int ALLOW_SEND_IMAGE_REDUCTION;
   private static final int MAX_VOICE_NOTES_RECORD_TIME;
   private static final int MAX_VOICE_NOTES_RECORD_SIZE;
   private static final int MAX_COMPOSE_TEXT_SIZE;
   private static final int RETRIEVAL_URL_SCHEME;
   private static final int INFER_ACK_URL;
   private static final int COMPOSE_FROM_SCHEME;
   private static final int LOCKED_OPTIONS_FLAGS;
   private static final int ONE_VIDEO_PER_MMS;
   private static final int ADDRESSING_OPTIONS_FLAGS;
   private static final int UAPROF_URL;
   private static final int UAPROF_USERAGENTNAME;
   public static final int MAX_IMAGE_REDUCTION_BEFORE_SEND;
   public static final int FROM_FIELD_NDD_REQUIRED;
   public static final int TO_FIELD_NDD_REQUIRED;
