...
public final class MMSSyncConverter implements SyncConverter {
   private static final int FIRST_VERSION_SUPPORTED;
   private static final int LAST_VERSION_SUPPORTED;
   ...
   private static final int MESSAGE_FLAGS;
   private static final int FOLDER_ID;
   private static final int STATUS;
   private static final int HTTP_ERROR_CODE;
   private static final int MMS_RESPONSE_CODE;
   private static final int WAP_IO_EXCEPTION_ERROR;
   private static final int WAP_IO_EXCEPTION_ADDITIONAL_DATA;
   private static final int CREATION_DATE;
   private static final int PAYLOAD_ATTRIBUTE_NAME;
   private static final int PAYLOAD_ATTRIBUTE_DATA_STRING;
   private static final int DELIVERY_DATE;
   private static final int READ_DATE;
   private static final int DELIVERY_REPORT_ADDRESS;
   private static final int DELIVERY_REPORT_DATE;
   private static final int DELIVERY_REPORT_STATUS;
   private static final int READ_REPORT_ADDRESS;
   private static final int READ_REPORT_DATE;
   private static final int READ_REPORT_STATUS;
   private static final int LEGACY_PHONE_NUMBER_SENDER;
   private static final int LEGACY_PHONE_NUMBER_TO;
   private static final int LEGACY_PHONE_NUMBER_CC;
   private static final int ATTACHMENT_NAME;
   private static final int ATTACHMENT_DATA_BYTES;
   private static final int ATTACHMENT_DATA_STREAM;
   private static final int ATTACHMENT_DATA_TYPE;
   private static final int ATTACHMENT_CHARSET;
   private static final int EMAIL_ADDRESS_SENDER;
   private static final int EMAIL_ADDRESS_TO;
   private static final int EMAIL_ADDRESS_CC;
   private static final int PHONE_NUMBER_SENDER;
   private static final int PHONE_NUMBER_TO;
   private static final int PHONE_NUMBER_CC;
