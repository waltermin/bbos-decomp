...
public final class NetworkOptionsItem
   ...
   private static final int STRS_AUTOMATIC;
   private static final int STRS_MANUAL;
   private static final int STRS_HOME_ONLY;
   private static final int STRS_AUTOMATIC_A;
   private static final int STRS_AUTOMATIC_B;
   private static final int STRS_EVDO_ONLY;
   private static final int STRS_CDMA_ONLY;
   private static final int STRS_ROAM_ONLY;
   private static final int STRS_MODE_UMTS;
   private static final int STRS_MODE_GPRS;
   private static final int STRS_MODE_DUAL;
   private static final int DS_MODE_ON;
   private static final int DS_MODE_OFF;
   private static final int DS_MODE_ROAM;
   private static final int STRS_PROMPT;
   private static final int STRS_YES;
   private static final int STRS_NO;
   private static final boolean _isSynchronousOperation = RadioInfo.getNetworkType() != 7;
   private static final int WORLD_PHONE_RADIOS;
