...
public final class SimCardEfHandler implements SIMCardEFListener {
   ...
   private static final int STATE_WAIT_FLAG;
   private static final int STATE_DUMMY;
   private static final int STATE_IDLE;
   private static final int STATE_REQ_INFO_PLMNW_ACT;
   private static final int STATE_REQ_INFO_PLMNW_ACT_WAIT;
   private static final int STATE_REQ_INFO_PLMN_SEL;
   private static final int STATE_REQ_INFO_PLMN_SEL_WAIT;
   private static final int STATE_REQ_DATA;
   private static final int STATE_REQ_DATA_WAIT;
   private static final int STATE_WRITE_DATA;
   private static final int STATE_WRITE_DATA_WAIT;
   private static final int STATE_GEN_FAILURE;
   private static final int STATE_PARSE_DATA;
   private static final int STATE_FAILURE;
   private static final int STATE_SUCCESS;
   private static final int REC_SIZE_EF_PLMN_SEL;
   ...
   private static final int ACCESS_TECH_GSM;
   private static final int ACCESS_TECH_GSM_COMPACT;
   private static final int ACCESS_TECH2_GSM;
   private static final int ACCESS_TECH2_GSM_COMPACT;
   private static final int ACCESS_TECH2_UTRAN;
   private static final int ACCESS_TECH2_UNSELECTED;
