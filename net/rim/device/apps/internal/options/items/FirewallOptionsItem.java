...
public final class FirewallOptionsItem extends SaveableMainScreenOptionsListItem implements BlockedCountListener {
   ...
   protected final void populateMainScreen(MainScreen mainScreen) {
      ...
      this._enabledField = (BooleanChoiceField)(new Object(OptionsResources.getString(1703), 2, firewallEnabled, 268435456));
      ...
      mainScreen.add((Field)(new Object(OptionsResources.getString(2019), 36028797018963968L)));
      ...
      this._blockSMS = (CheckboxField)(new Object(OptionsResources.getString(2020), fw.isBlockingEnabled((byte)1)));
      this._blockSMS.setEditable(!fw.isBlockingEnabledByItPolicy((byte)1));
      int smsCount = fw.getBlockedCount((byte)1);
      String[] c = new Object[]{String.valueOf(smsCount)};
      this._smsCountLabel = (LabelField)(new Object(MessageFormat.format(blocked, c), 36028797018963968L));
      vifm.add(new FirewallOptionsItem$FieldAndCountManager(this._blockSMS, this._smsCountLabel), 6);
      this._blockMMS = (CheckboxField)(new Object());
      if (MMS.isEnabled()) {
         ...
         c = new Object[]{String.valueOf(mmsCount)};
         this._mmsCountLabel = (LabelField)(new Object(MessageFormat.format(blocked, c), 36028797018963968L));
         vifm.add(new FirewallOptionsItem$FieldAndCountManager(this._blockMMS, this._mmsCountLabel), 6);
      }

      this._blockPIN = (CheckboxField)(new Object(OptionsResources.getString(1994), fw.isBlockingEnabled((byte)4)));
      this._blockPIN.setEditable(!fw.isBlockingEnabledByItPolicy((byte)4));
      int pinCount = fw.getBlockedCount((byte)4);
      c = new Object[]{String.valueOf(pinCount)};
      this._pinCountLabel = (LabelField)(new Object(MessageFormat.format(blocked, c), 36028797018963968L));
      vifm.add(new FirewallOptionsItem$FieldAndCountManager(this._blockPIN, this._pinCountLabel), 6);
      this._blockBIS = (CheckboxField)(new Object(OptionsResources.getString(1995), fw.isBlockingEnabled((byte)3)));
      this._blockBIS.setEditable(!fw.isBlockingEnabledByItPolicy((byte)3));
      int bisCount = fw.getBlockedCount((byte)3);
      c = new Object[]{String.valueOf(bisCount)};
      this._bisCountLabel = (LabelField)(new Object(MessageFormat.format(blocked, c), 36028797018963968L));
      ...
      if (decryptFailureCount > 0 || notEncryptedErrorCount > 0 || addressMismatchErrorCount > 0 || invalidDatagramCount > 0 || mismatchedKeyCount > 0) {
         vifm.add((Field)(new Object()), 6);
         if (decryptFailureCount > 0) {
            this._decryptFailure = (LabelField)(new Object(OptionsResources.getString(2025), 1170935903116328960L));
            c = new Object[]{String.valueOf(decryptFailureCount)};
            this._decryptFailureCountLabel = (LabelField)(new Object(MessageFormat.format(blocked, c), 36028797018963968L));
         ...
         if (notEncryptedErrorCount > 0) {
            this._notEncryptedError = (LabelField)(new Object(OptionsResources.getString(2026), 1170935903116328960L));
            c = new Object[]{String.valueOf(notEncryptedErrorCount)};
            this._notEncryptedErrorCountLabel = (LabelField)(new Object(MessageFormat.format(blocked, c), 36028797018963968L));
         ...
         if (addressMismatchErrorCount > 0) {
            this._addressMismatch = (LabelField)(new Object(OptionsResources.getString(2031), 1170935903116328960L));
            c = new Object[]{String.valueOf(addressMismatchErrorCount)};
            this._addressMismatchCountLabel = (LabelField)(new Object(MessageFormat.format(blocked, c), 36028797018963968L));
         ...
         if (invalidDatagramCount > 0) {
            this._invalidDatagram = (LabelField)(new Object(OptionsResources.getString(2071), 1170935903116328960L));
            c = new Object[]{String.valueOf(invalidDatagramCount)};
            this._invalidDatagramCountLabel = (LabelField)(new Object(MessageFormat.format(blocked, c), 36028797018963968L));
         ...
         if (mismatchedKeyCount > 0) {
            this._mismatchedKey = (LabelField)(new Object(OptionsResources.getString(2072), 1170935903116328960L));
            c = new Object[]{String.valueOf(mismatchedKeyCount)};
            this._mismatchedKeyCountLabel = (LabelField)(new Object(MessageFormat.format(blocked, c), 36028797018963968L));
   ...
   public final void blockedCountIncremented(byte type, int count) {
      ...
      if (label != null) {
         String[] c = new Object[]{String.valueOf(count)};
