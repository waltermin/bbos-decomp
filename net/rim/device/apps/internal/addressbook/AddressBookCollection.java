...
public final class AddressBookCollection
   ...
   private static final long ADDRESSBOOK_DATA_NAME = 5765246712487104764L;
   private static final int SERIAL_PERSIST_ADD_COUNT = 200;
   private static final int INVALID_KEY = -1;
   private static RIMModelSyncConverter _syncConverter;
   private static final int MAX_UNFILTERED_WORD_LENGTH = 10;
   private static final int MAX_EXCEPTIONS_COUNT = 5;
   private static final int MAX_READER_DATA_SIZE = 102400;
   private static String CLAUSE_SEPARATORS = " \n.?!,:;\"“”@'\\(){}[]<>";
   private static final int OFFSET_FIRSTNAME = 0;
   private static final int OFFSET_LASTNAME_IGNORE = 1;
   private static final int OFFSET_COMPANYNAME = 2;
   private static final int OFFSET_LASTNAME = 3;
   private static final int OFFSET_COUNT = 4;
   static final int KEYID_NORMAL = 0;
   static final int KEYID_FIRSTNAME = 1;
   static final int KEYID_LASTNAME = 2;
   static final int KEYID_COMPANYNAME = 4;
   private static final int KEY_KEYID_SHIFT = 29;
   private static final int KEY_OFFSET_SHIFT = 15;
   private static final int KEY_LENGTH_SHIFT = 22;
   private static final int KEY_KEYID_MASK = 7;
   private static final int KEY_INTERNALID_MASK = 32767;
