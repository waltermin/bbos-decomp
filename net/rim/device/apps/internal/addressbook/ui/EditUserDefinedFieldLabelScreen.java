...
public final class EditUserDefinedFieldLabelScreen extends PopupScreen {
   ...
   private EditUserDefinedFieldLabelScreen(String value) {
      ...
      this._editField = (EditField)(new Object(AddressBookResources.getString(1202), value, 30, 1157425106381701120L));
      Field originalField = (Field)(new Object(value, 1197957500880551936L));
