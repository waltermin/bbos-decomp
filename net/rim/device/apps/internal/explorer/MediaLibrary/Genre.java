...
public final class Genre implements MediaInfo, PaintProvider, KeyProvider, VerbProvider {
   int _id;
   String _name;
   String[] _keywords;
   ...
   public final void setName(String name) {
      if (name == null) {
         ...
         this._prefixedKeywords[0] = FilterConstants.generateKey('ￌ', FilterConstants.UNKNOWN_ID);
      } else {
         this._name = name.trim();
         this._keywords = StringUtilities.stringToKeywords(this._name);
         this._prefixedKeywords = new Object[1];
         String hash = FilterConstants.generateKey('ￌ', Math.abs(this._name.toLowerCase().hashCode()));
