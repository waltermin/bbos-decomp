...
public final class PrevMenuItem extends MenuItem {
   private FileItemField _field;
   private ExploreManager _manager;
   private Screen _screenToClose;

   public PrevMenuItem(ExploreManager manager, Screen closeScreen, FileItemField field) {
      super(ExplorerResources.getResourceBundleFamily(), 33, 591105, 0);
