...
final class CameraPreviewScreen$CustomFocusOrder extends DefaultHandler {
   int _defaultFocus;
   ...
   CameraPreviewScreen$CustomFocusOrder(CameraPreviewScreen _1) {
      this.this$0 = _1;
   ...
   public final void startElement(String uri, String localName, String qName, Attributes attributes) {
      if (localName.equalsIgnoreCase("group")) {
         ...
         if (localName.equalsIgnoreCase("item")) {
            ((FocusGroup)this._stack.peek()).addLeaf(this.this$0._model, attributes);
         }
      }
   }
   ...
   final void setFocusInteractor(FocusInteractor focusInteractor) {
      ...
      if (this._focusGroup != null) {
         this._focusGroup.resolveIds(this.this$0._model);
      }
   }
   ...
   final void enableSendButton(boolean enable) {
      if (enable != this._canSend) {
         this.this$0._model.trigger(107, this.this$0._model.getHandle(enable ? "enableSend" : "disableSend"), null);
         this._canSend = enable;
      }

      if (this._focusGroup != null) {
         this._focusGroup.enableItem(this.this$0._sendHandle, enable);
      }
   }
   ...
   final boolean moveFocus(int dx, int dy) {
      if (this._focusGroup != null) {
         ...
         if (newFocus != oldFocus) {
            if (!VisualNodeImpl.isResolvedDisplayable(newFocus, this.this$0._model)) {
