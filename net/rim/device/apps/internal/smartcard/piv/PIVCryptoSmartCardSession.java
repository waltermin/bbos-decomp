...
public class PIVCryptoSmartCardSession extends CryptoSmartCardSession {
   ...
   private static final int PIV_PWD_LENGTH;
   private static final byte ZERO_BYTE;
   private static final byte INS_GENERAL_AUTHENTICATE;
   private static final byte INS_GET_DATA;
   private static final byte CLASS_00;
   private static final byte CLASS_80;
   private static final byte CLASS_84;
   private static final byte TAG_DYNAMIC_AUTHENTICATION_TEMPLATE;
   private static final byte TAG_RESPONSE;
   private static final byte TAG_CHALLENGE;
   static final byte KEY_REF_PIV_AUTHENTICATION_KEY;
   static final byte KEY_REF_DIGITAL_SIGNATURE_KEY;
   static final byte KEY_REF_KEY_MANAGMENT_KEY;
   static final byte KEY_REF_CARD_AUTHENTICATION_KEY;
