...
public final class CreateNewCalendarVerb extends Verb {
   ...
   public final Object invoke(Object parameter) {
      SimpleInputDialog calendarNameDialog = new SimpleInputDialog(11, CalendarApp._rb.getString(11));
      calendarNameDialog.show();
      String name = calendarNameDialog.getText();
      if (name != null && name.trim().length() != 0) {
         throw new UnsupportedOperationException("The creation of new calendars in this way is unsupported");
      }
