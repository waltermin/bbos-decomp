...
final class CalendarOptionsScreen$CalendarFolderField extends Field {
   ...
   public CalendarOptionsScreen$CalendarFolderField(String name, String value, CalendarKey calendarKey) {
