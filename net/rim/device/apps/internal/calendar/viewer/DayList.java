...
class DayList implements CalendarViewListField$CalendarViewListFieldCallback {
   ...
   private static final int MAX_TIME_BARS;
   private static final int TRANSITION_ARRAY_GROW_SIZE;
   ...
   static final int TIME_COL_PAD;
   static final int TIME_TO_DESC_PADDING_NO_ICON;
   static final int TIME_TO_DESC_PADDING_ICON;
   ...
   private static final boolean CAPITALIZE_HEADERS;
   private static final int VECTOR_PADDING;
   ...
   private static final int ROUND_BORDER_PADDING;
   private static final int ROUND_BORDER_DIAMETER;
   private static final int MODE_NONE;
   private static final int MODE_RIGHT_SWATCH;
   private static final int MODE_RIGHT_SWATCH_FILLED;
   private static final int MODE_LEFT_SWATCH;
   private static final int MODE_LEFT_SWATCH_FILLED;
   private static final int MODE_ROUND_BORDER;
   private static final int MODE_FILLED_ROUND_BORDER;
   private static final int BORDER_FILL_ALPHA;
   private static final int SPACE_PER_BAR;
   private static final int TIME_BAR_WIDTH;
