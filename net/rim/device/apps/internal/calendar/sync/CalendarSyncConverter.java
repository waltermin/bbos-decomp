...
public class CalendarSyncConverter implements SyncConverter {
   ...
   private static final int TYPE_FIELD_ID = 1;
   private static final int TITLE_FIELD_ID = 2;
   private static final int TEXT_FIELD_ID = 3;
   private static final int LOCATION_FIELD_ID = 4;
   private static final int TRIGGER_FIELD_ID = 5;
   private static final int STARTS_FIELD_ID = 6;
   private static final int ENDS_FIELD_ID = 7;
   private static final int ATTENDEE_FIELD_ID = 11;
   private static final int CALENDAR_UID_ID = 15;
   private static final int RELATED_TO_FIELD_ID = 18;
   private static final int ATTENDEE_DECLINED_FIELD_ID = 19;
   private static final int ATTENDEE_TENTATIVE_FIELD_ID = 20;
   private static final int ATTENDEE_NEEDSACTION_FIELD_ID = 21;
   private static final int ORGANIZER_FIELD_ID = 22;
   private static final int RECURRENCE_UID_ID = 23;
   private static final int NEXT_ALARM_FIELD_ID = 26;
   private static final int SYNC_DATA_FIELD_ID = 27;
   private static final int FREE_BUSY_FIELD_ID = 28;
   private static final int OTA_BITFIELD_ID = 29;
   private static final int ORIGINAL_TZ_FIELD_ID = 30;
   private static final int SENSITIVITY_FIELD_ID = 40;
   private static final int MEETING_CAPABILITIES_FIELD_ID = 41;
   private static final int ICALENDAR_UID = 42;
   private static final int CALENDAR_SERVICE_ID = 43;
   private static final int CALENDAR_FOLDER_ID = 44;
   private static final int ALLDAY_FIELD_ID = 255;
   private static final byte EVENT_RECORD = 97;
   private static final byte RECURRING_RECORD = 42;
   private static final long ID = -1330046377160641069L;
