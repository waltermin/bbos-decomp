...
final class OneWayPagerAddressModelImpl
   implements OneWayPagerAddressModel,
   VerbProvider,
   FieldProvider,
   PaintProvider,
   KeyProvider,
   ...
   public final Verb getVerbs(Object context, Verb[] verbs) {
      ...
      return receiptCapableService != null && receiptCapableService._oneWayPageEnabled
         ? IMPlusUtilities.getVerbs(this, -7875293227724358566L, 328192, context, verbs)
         : null;
   }
   ...
   public final boolean convert(Object context, Object target) {
      return IMPlusUtilities.convert(this, this.getData(), this.getSyncFieldId(null), "\r1-way Pager:", context, target);
   }
   ...
   public final Field getField(Object context) {
      return IMPlusUtilities.getField(this.getSyncFieldId(null), 13, this, this.getData(), context);
   }
   ...
   public final int getOrder(Object context) {
      if (ContextObject.getFlag(context, 11)) {
         return ContextObject.getFlag(context, 0) ? 2950 : 3650;
      } else {
         return 0;
      }
   }
