...
final class IMPlusPhoneComposeVerbCombiner implements VerbCombiner {
   ...
   public final boolean recognize(Object object) {
      return !(object instanceof Verb) ? false : ((Verb)object).getVerbGroupId() == 1187214;
   }
   ...
   public final Verb createWrapperVerb(Verb[] verbs, Verb defaultVerb) {
      ...
      return new PopupVerbWrapper(verbDescription, IMPlusResources.getString(20), verbs[0].getOrdering(), verbs, descriptions, defaultVerb);
   }
}
