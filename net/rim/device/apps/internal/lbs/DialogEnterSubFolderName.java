...
final class DialogEnterSubFolderName extends PopupScreen implements FieldChangeListener {
   ...
   public final void handleSelection() {
      ...
      if (fieldWithFocus == this._buttonCancel) {
         ...
         if (this._editSubFolderName.getText().length() > 0) {
            ...
            Dialog.alert(LBSResources.getString(310));
            popScreen = false;
         }
      }
   ...
   public DialogEnterSubFolderName(Folder currentFolder, String defaultValue) {
      ...
      dfm.setMessage((RichTextField)(new Object(LBSResources.getString(309), 36028797018963968L)));
   ...
   static final boolean checkForDuplicatePasses(String name, Folder folder) {
      ...
      if (oldFolder != null) {
         Dialog.alert(LBSResources.getString(311));
         returnValue = false;
      }
