...
final class FinderProgressDialog extends PopupScreen implements FieldChangeListener {
   ...
   private GaugeField _statusGauge = (GaugeField)(new Object(null, 0, 45, 2, 65536));
   ...
   public FinderProgressDialog(Request$Listener listener) {
      ...
      this.add((Field)(new Object(MessageFormat.format(LBSResources.getString(47), new String[]{"..."}), 36028797018963968L)));
