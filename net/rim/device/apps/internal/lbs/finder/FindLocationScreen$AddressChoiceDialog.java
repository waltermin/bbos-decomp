...
final class FindLocationScreen$AddressChoiceDialog extends Dialog {
   private ButtonField _cancel;

   FindLocationScreen$AddressChoiceDialog(String message, Object[] choices, int[] values, int defaultChoice) {
