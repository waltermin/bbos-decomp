...
public final class ConvenienceKeyOptionsImpl extends ConvenienceKeyOptionsProvider {
   ...
   static final String NOTHING_OPTION;
   static final String DEFAULT_OPTION;
   static final String APPLICATION_SWITCHER;
   static final String POWER_OFF_ENTRY;
   static final String RADIO_OFF_ENTRY;
   static final String SINGLE_BROWSER_ENTRY;
   static final String DEFAULT_KEY_1_NAME;
   private static final int TYPE_CONVENIENCE_KEY_1;
   private static final int TYPE_CONVENIENCE_KEY_2;
   private static final int KEY_CLICK;
   private static final int KEY_CLICK_AND_HOLD;
   private static final String LOCK_CONVENIENCE_KEY_1;
   private static final String LOCK_CONVENIENCE_KEY_2;
