...
public class WlanEventProvider implements WLANListenerInternal, ServiceRoutingListener2, RadioStatusListener, GlobalEventListener {
   ...
   private static final long SR_HELPER_KEY;
   public static final String WIFI_ENABLED;
   public static final String WIFI_DISABLED;
   public static final String WIFI_RADIO_ON;
   public static final String WIFI_RADIO_OFF;
   public static final String WIFI_CONNECT;
   public static final String WIFI_DISCONNECT;
   public static final String DATA_WIFI_CONNECT;
   public static final String DATA_WIFI_DISCONNECT;
   public static final String DATA_CARRIER_CONNECT;
   public static final String DATA_CARRIER_DISCONNECT;
   public static final String UMA_CONNECT;
   public static final String UMA_DISCONNECT;
   private static final int EVENT_TYPE_WLAN_ENABLED;
   private static final int EVENT_TYPE_WLAN;
   private static final int EVENT_TYPE_SR;
   private static final int EVENT_TYPE_RADIO_STATUS;
