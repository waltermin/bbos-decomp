...
final class EntryBitmapComponentFactory implements Factory {
   ...
   final void init() {
      ...
      repos.addFactory("EntryBitmap", this);
   }

   @Override
   public final Object createInstance(Object initialData) {
      EntryBitmapComponentFactory$EntryBitmapComponent instance = new EntryBitmapComponentFactory$EntryBitmapComponent();
