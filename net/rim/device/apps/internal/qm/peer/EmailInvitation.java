...
final class EmailInvitation implements PersistableRIMModel, FieldProvider {
   ...
   static final String STAGE_2_SUBJECT;
   static final String STAGE_2_BODY;
   public static final int VERSION;
   public static final int TYPE_INVITE;
   static final int TLE_STAGE;
   static final int TLE_COOKIE;
   static final int TLE_PASSCODE_FLAG;
   static final int TLE_CRYPTO_KEY;
   static final int TLE_PIN;
   static final int TLE_CONFIRM;
   static final int TLE_PASSWORD;
   static final int TLE_QUESTION;
   static final int TLE_BODY_HASH;
   static final int TLE_END;
   static final int TLE_INBOUND;
   static final int TLE_REPLYTO;
   static final int TLE_ISPIN;
