...
public final class PeerAuditManager implements Runnable, GlobalEventListener {
   ...
   public static final long PEER_AUDIT_MANAGER_GUID;
   public static final long PEER_AUDITOR_TEST;
   private static PeerAuditManager _instance;
   public static final int IT_POLICY_GROUP;
   public static final int AUDIT_EMAIL_ADDRESS;
   public static final int AUDIT_UID;
   public static final int AUDIT_REPORT_INTERVAL;
   public static final int AUDIT_MAX_REPORT_INTERVAL;
   private static final int DEFAULT_REPORT_INTERVAL;
   private static final int TYPE_REPORTS;
   private static final int TYPE_RECENT_RECORDS;
   private static final int TYPE_LAST_TIME_SENT;
   private static final int TYPE_LAST_RECORD_LOGGING_DATE;
   private static final int TYPE_ATTACHMENTS;
   private static final int TYPE_SINGLE_REPORT;
   private static final int TYPE_SUBJECT;
   private static final int TYPE_BODY;
   private static final int REPORT_MAX_SIZE;
   private static int _currentReportSize;
   private static StringBuffer _timeAsStringBuffer = (StringBuffer)(new Object());
   private static final String USAGE_REPORT_SUBJECT;
   ...
   private static final int TYPE_LOG_MSG;
   private static final int TYPE_LOG_OBJ;
   private static final int TYPE_LOG_DSP;
   private static final int TYPE_LOG_STS;
   private static final String OUTGOING_DISPLAY_NAME_PREFIX;
   private static final String INCOMING_DISPLAY_NAME_PREFIX;
   private static final String OUTGOING_STATUS_PREFIX;
   private static final String INCOMING_STATUS_PREFIX;
