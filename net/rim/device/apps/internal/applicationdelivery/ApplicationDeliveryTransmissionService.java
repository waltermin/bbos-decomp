...
class ApplicationDeliveryTransmissionService extends AbstractTransmissionService implements PacketReceiver, RealtimeClockListener {
   ...
   private static final int COMMAND_APPLICATION_DATA;
   private static final int COMMAND_ACKNOWLEDGEMENT;
   static final int ACK_RESERVED;
   static final int ACK_SUCCESS;
   static final int ACK_TIMEOUT;
   static final int ACK_INSUFFICIENT_MEMORY;
   static final int ACK_INSUFFICIENT_PRIVILEGES;
   static final int ACK_INVALID_VERSION;
   static final int ACK_DATA_FORMAT_ERROR;
   static final int ACK_INVALID_COMMAND;
   static final int ACK_INSUFFICIENT_BODY_DATA;
   static final int ACK_INVALID_MODULE_HASH;
   static final int ACK_INVALID_APP_DATA_LENGTH;
   static final int ACK_INSUFFICIENT_APP_DATA;
   static final int ACK_INCOMPLETE_MODULE;
   static final int ACK_MODULE_SAVE_FAILED;
   static final int ACK_SECURITY_VIOLATION;
   static final int ACK_FAILURE;
   private static final byte TAG_TRANSACTION_ID;
   private static final byte TAG_MODULE_COUNT;
   private static final byte TAG_MODULE_ID;
   private static final byte TAG_SEQUENCE_NUMBER;
   private static final byte TAG_MODULE_SIZE;
   private static final byte TAG_MODULE_DATA_OFFSET;
   private static final byte TAG_MODULE_DATA;
   private static final byte TAG_APPLICATION_GROUP_DATA;
   private static final byte TAG_VERSION_SUPPORTED;
   private static final byte TAG_GENERAL_ERROR;
   private static final byte TAG_TRANSACTION_STATUS;
   private static final int VERSION;
   private static final long APPLICATION_DELIVERY_PERSISTED_GUID;
