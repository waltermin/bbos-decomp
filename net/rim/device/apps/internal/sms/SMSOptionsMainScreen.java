...
class SMSOptionsMainScreen extends AppsMainScreen implements FieldChangeListener {
   ...
   private static final int SHOW_SERVICE_CENTRE;
   private static final int SHOW_CALLBACK_NUMBER;
   private static final int SHOW_SENT_AS;
   private static final int SHOW_MESSAGE_CODING;
   private static final int SHOW_MESSAGE_CLASS;
   private static final int SHOW_PRIORITY;
   private static final int SHOW_VALIDITY_PERIOD;
   private static final int SHOW_DELIVERY_PERIOD;
   private static final int SHOW_MULTIPLE_RECIPIENTS;
   private static final int SHOW_ROUTE;
   private static final int SHOW_DELIVERY_REPORTS;
   private static final int SHOW_STORE_ON_SIM;
   private static final int SHOW_NUM_PREVIOUS_ITEMS;
   private static final int SHOW_DISABLE_AUTO_TEXT;
   private static final int SHOW_ALL_OPTIONS;
   private static final int SENT_AS_TEXT;
   private static final int SENT_AS_FAX3;
   private static final int SENT_AS_FAX4;
   private static final int SENT_AS_VOICE;
   private static final int SENT_AS_ERMES;
   private static final int MSG_CODING_GPRS_DEFAULT;
   private static final int MSG_CODING_GPRS_UCS2;
   private static final int MSG_CODING_GPRS_8BIT;
   private static final int MSG_CODING_CDMA_ASCII;
   private static final int MSG_CODING_CDMA_ISO8859;
   private static final int MESSAGE_CLASS_0;
   private static final int MESSAGE_CLASS_1;
   private static final int MESSAGE_CLASS_2;
   private static final int MESSAGE_CLASS_3;
   private static final int MESSAGE_CLASS_NOT_GIVEN;
   private static final int PRIORITY_NORMAL;
   private static final int PRIORITY_URGENT;
   private static final int VALIDITY_PERIOD_15_MINUTES;
   private static final int VALIDITY_PERIOD_30_MINUTES;
   private static final int VALIDITY_PERIOD_1_HOUR;
   private static final int VALIDITY_PERIOD_3_HOURS;
   private static final int VALIDITY_PERIOD_6_HOURS;
   private static final int VALIDITY_PERIOD_12_HOURS;
   private static final int VALIDITY_PERIOD_1_DAY;
   private static final int VALIDITY_PERIOD_3_DAYS;
   private static final int VALIDITY_PERIOD_1_WEEK;
   private static final int VALIDITY_PERIOD_2_WEEKS;
   private static final int VALIDITY_PERIOD_MAX;
   private static final int DELIVERY_PERIOD_IMMEDIATE;
   private static final int DELIVERY_PERIOD_15_MINUTES;
   private static final int DELIVERY_PERIOD_30_MINUTES;
   private static final int DELIVERY_PERIOD_1_HOUR;
   private static final int DELIVERY_PERIOD_3_HOURS;
   private static final int DELIVERY_PERIOD_6_HOURS;
   private static final int DELIVERY_PERIOD_12_HOURS;
   private static final int DELIVERY_PERIOD_1_DAY;
   private static final int DELIVERY_PERIOD_3_DAYS;
   private static final int DELIVERY_PERIOD_1_WEEK;
   private static final int DELIVERY_PERIOD_2_WEEKS;
   private static final int MAX_CALLBACK_LENGTH;
