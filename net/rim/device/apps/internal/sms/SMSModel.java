...
public class SMSModel
   ...
   public static final int STATUS_TX_COMPOSING;
   public static final int STATUS_TX_RETRIEVING_KEY;
   public static final int STATUS_TX_COMPRESSING;
   public static final int STATUS_TX_ENCRYPTING;
   public static final int STATUS_TX_PENDING;
   public static final int STATUS_TX_SENDING;
   public static final int STATUS_TX_SENT;
   public static final int STATUS_TX_MAILBOXED;
   public static final int STATUS_TX_DELIVERED;
   public static final int STATUS_TX_READ;
   public static final int STATUS_TX_ERROR;
   public static final int STATUS_TX_GENERAL_FAILURE;
   public static final int STATUS_RX_RECEIVING;
   public static final int STATUS_RX_RECEIVED;
   public static final int STATUS_RX_ERROR;
   public static final int OFFSET_DATAGRAM_ID;
   public static final int DATAGRAM_MASK;
   public static final int USE_SMART_DIALING_MASK;
   private static final int OFFSET_MESSAGE_STATUS;
   protected static final int OFFSET_MESSAGE_ID;
   public static final int INVALID_MESSAGE_ID;
   protected static final int OFFSET_MESSAGE_TRANSMISSION_ERROR;
   public static final int INVALID_MESSAGE_TRANSMISSION_ERROR;
   protected static final int OFFSET_CAUSE_CODE;
   private static final int OFFSET_PER_STATUS_ENTRY;
   protected static final int OFFSET_PER_ERROR_ENTRY;
   public static final int INVALID_CAUSE_CODE;
   public static final int FLAG_OPENED;
   public static final int FLAG_SAVED_THEN_ORPHANED;
   public static final int FLAG_SAVED;
   public static final int FLAG_BEGINNING_OF_THREAD;
   public static final int FLAG_USE_SMART_DIALING;
   public static final int FLAG_ERROR_STATUS_OCCURRED;
   public static final int FLAG_NEW;
   private static WeakReference _messageHeaderDataBufferWR = (WeakReference)(new Object(null));
   private static final int INVALID_SUBJECT_OFFSET;
   private static final int MAXIMUM_SUBJECT_LENGTH;
