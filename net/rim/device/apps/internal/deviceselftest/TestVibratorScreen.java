...
final class TestVibratorScreen extends TestScreenBase {
   TestVibratorScreen() {
      super._title = new LabelField(DeviceSelfTestResources.getString(52), 1152921504606846976L);
      super._input = new LabelField(DeviceSelfTestResources.getString(53), 1152921504606846976L);
      super._output = new LabelField(DeviceSelfTestResources.getString(54), 1152921504606846976L);
