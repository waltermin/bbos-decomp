...
final class TestKeyboardScreen extends TestScreenBase {
   ...
   TestKeyboardScreen() {
      super._title = new LabelField(DeviceSelfTestResources.getString(98), 1152921504606846976L);
      super._input = new LabelField(DeviceSelfTestResources.getString(99), 1152921504606846976L);
      super._output = new LabelField(DeviceSelfTestResources.getString(100), 1152921504606846976L);
      this.setTitle(super._title);
      this.add(super._input);
      this.add(new SeparatorField());
      this.add(super._output);
      this.add(new SeparatorField());
      this._keyString = new EditField("Pressed Keys : ", null);
