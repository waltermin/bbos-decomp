...
final class MemoryCleanerDialog extends PopupDialog implements ListFieldCallback {
   ...
   public MemoryCleanerDialog(MemoryCleaner cleaner, MemoryCleanerListener[] listeners) {
      super(new HorizontalFieldManager(), 33554432);
      ...
      this._labelField = new LabelField(_rb.getString(1), 51539607552L);
      vfm.add(this._labelField);
      vfm.add(new SeparatorField());
      if (this._numListeners > 0) {
         this._listField = new ListField(this._numListeners);
         this._listField.setCallback(this);
         VerticalFieldManager scrollingfm = new VerticalFieldManager(299067162755072L);
