...
final class BluetoothPhoneManager$ConnectVerb extends Verb {
   private BluetoothDevice _deviceToConnect;
   private String _prompt;
   private AudioPathControl _control;
   private final BluetoothPhoneManager this$0;

   public BluetoothPhoneManager$ConnectVerb(BluetoothPhoneManager _1, BluetoothDevice device, AudioPathControl control) {
      super(1266752);
      this.this$0 = _1;
