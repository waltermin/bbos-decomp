...
class PBAPServer extends ServerRequestHandler implements Runnable, Authenticator {
   ...
   private static final int FOLDER_ROOT;
   private static final int FOLDER_TELECOM;
   private static final int FOLDER_TELECOM_PB;
   private static final int FOLDER_TELECOM_ICH;
   private static final int FOLDER_TELECOM_OCH;
   private static final int FOLDER_TELECOM_MCH;
   private static final int FOLDER_TELECOM_CCH;
   private static final int FOLDER_SIM1;
   private static final int FOLDER_SIM1_TELECOM;
   private static final int FOLDER_SIM1_TELECOM_PB;
   private static final int FOLDER_SIM1_TELECOM_ICH;
   private static final int FOLDER_SIM1_TELECOM_OCH;
   private static final int FOLDER_SIM1_TELECOM_MCH;
   private static final int FOLDER_SIM1_TELECOM_CCH;
   private static final int SEARCH_ORDER_INDEXED;
   private static final int SEARCH_ORDER_ALPHANUMERIC;
   private static final int SEARCH_ORDER_PHONETIC;
   private static final int SEARCH_ATTRIBUTE_NAME;
   private static final int SEARCH_ATTRIBUTE_NUMBER;
   private static final int SEARCH_ATTRIBUTE_SOUND;
   private static final int FORMAT_VCARD_2_1;
   private static final int FORMAT_VCARD_3_0;
