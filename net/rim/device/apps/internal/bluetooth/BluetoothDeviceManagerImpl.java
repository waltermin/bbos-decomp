...
public final class BluetoothDeviceManagerImpl extends BluetoothDeviceManager implements BluetoothMEListener2, SystemListener2, GlobalEventListener {
   ...
   private static final long BLUETOOTH_OPTIONS_DATA_KEY = 7045685465310336373L;
   static final int EVENT_INQUIRY_COMPLETE = 0;
   static final int EVENT_INQUIRY_CANCELLED = 1;
   static final int EVENT_DEVICE_ADDED = 2;
   static final int EVENT_DEVICE_REMOVED = 3;
   static final int EVENT_DEVICE_LIST_UPDATED = 4;
   static final int EVENT_DEVICE_INFO_UPDATED = 5;
   static final int EVENT_STATE_CHANGE = 6;
   static final int EVENT_INQUIRY_RESULT = 7;
   static final int EVENT_SERVICES_DISCOVERED = 8;
   static final int EVENT_SERVICE_SEARCH_COMPLETED = 9;
   static final int EVENT_PAIRING_IN_PROGRESS = 10;
   public static final int MAX_DEVICE_NAME_LENGTH = 64;
   public static final int CLASS_OF_DEVICE = 5243404;
   public static final int ADDRESS_BOOK_TRANSFER_MODE_DISABLED = 0;
   public static final int ADDRESS_BOOK_TRANSFER_MODE_ALL_ENTRIES = 1;
   public static final int ADDRESS_BOOK_TRANSFER_MODE_HOTLIST = 2;
   public static final int ADDRESS_BOOK_TRANSFER_MODE_SELECTED_CATEGORIES = 3;
   public static final int L2CAP_MTU = 1024;
   public static final int CONNECTED_DEVICES_MAX = 5;
   public static final int SD_ATTR_RETRIEVABLE_MAX = 10;
   static final int SECURITY_MODE_3 = 0;
   static final int SECURITY_MODE_3_WITH_ENCRYPTION = 1;
