...
final class BluetoothPhoneManager
   ...
   private static final int SCO_STATE_DISCONNECTED;
   private static final int SCO_STATE_CONNECTING;
   private static final int SCO_STATE_CONNECTED;
   private static final int SCO_STATE_CONNECTING_DISCONNECT_WHEN_DONE;
   private static final int STATE_NONE;
   private static final int STATE_ANSWER_CALL;
   private static final int STATE_RESUME_CALL;
   private static final int STATE_SEND_OK;
   private static final int STATE_SEND_ERROR;
   private static final int STATE_SEND_OK_FORCE_CALL_HELD_UPDATE;
   private static final int MAX_PHONE_NUMBERS;
   private static final int ENCODING_ASCII;
   private static final int ENCODING_GSM;
   private static final int ENCODING_UTF8;
   private static final int ENCODING_UCS2;
   private static final int PHONEBOOK_BB;
   private static final int PHONEBOOK_SIM;
   private static final int PHONEBOOK_DIALED_CALLS;
   private static final int PHONEBOOK_MISSED_CALLS;
   private static final int PHONEBOOK_RECEIVED_CALLS;
   private static final int MAX_CALL_HISTORY_ITEMS;
   private static final int MAX_PHONEBOOK_NAME_LENGTH;
   private static final int MAX_PHONEBOOK_NUMBER_LENGTH;
   ...
   private static final int CME_ERROR_AG_FAILURE;
   private static final int CME_ERROR_NO_CONNECTION;
   private static final int CME_ERROR_OPERATION_NOT_ALLOWED;
   private static final int CME_ERROR_OPERATION_NOT_SUPPORTED;
   private static final int CME_ERROR_PH_SIM_PIN_REQUIRED;
   private static final int CME_ERROR_SIM_NOT_INSERTED;
   private static final int CME_ERROR_SIM_PIN_REQUIRED;
   private static final int CME_ERROR_SIM_PUK_REQUIRED;
   private static final int CME_ERROR_SIM_FAILURE;
   private static final int CME_ERROR_SIM_BUSY;
   private static final int CME_ERROR_INCORRECT_PASSWORD;
   private static final int CME_ERROR_SIM_PIN2_REQUIRED;
   private static final int CME_ERROR_SIM_PUK2_REQUIRED;
   private static final int CME_ERROR_MEMORY_FULL;
   private static final int CME_ERROR_INVALID_INDEX;
   private static final int CME_ERROR_MEMORY_FAILURE;
   private static final int CME_ERROR_TEXT_STRING_TOO_LONG;
   private static final int CME_ERROR_INVALID_CHARACTERS_IN_TEXT_STRING;
   private static final int CME_ERROR_DIAL_STRING_TOO_LONG;
   private static final int CME_ERROR_INVALID_CHARACTERS_IN_DIAL_STRING;
   private static final int CME_ERROR_NO_NETWORK_SERVICE;
   private static final int CME_ERROR_NETWORK_TIMEOUT;
   private static final int CME_ERROR_EMERGENCY_CALLS_ONLY;
   private static final long LOG_GUID;
   private static final int LOG_SCO_LINK_FAILED;
   private static final int LOG_SCO_LINK_UP_REQUESTED;
   private static final int LOG_SCO_LINK_UP;
   private static final int LOG_SCO_LINK_DOWN_REQUESTED;
   private static final int LOG_SCO_LINK_DOWN;
   private static final int LOG_NO_ECHO_NOISE_CANCELLATION;
   private static final int LOG_HEADSET_CONNECT_REQUESTED;
   private static final int LOG_HEADSET_DISCONNECT_REQUESTED;
   private static final int LOG_HANDSFREE_CONNECT_REQUESTED;
   private static final int LOG_HANDSFREE_DISCONNECT_REQUESTED;
   private static final int LOG_RADIO_EXCEPTION;
   private static final int LOG_NREC_DISABLED;
   private static final int LOG_DISCONNECT_REQUESTED;
