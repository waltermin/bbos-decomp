...
final class BluetoothA2DPManager extends BluetoothProfileManager implements BluetoothA2DPListener, AudioRouterListener, VerbFactory, Runnable {
   ...
   private static final int PLAY_STATE_NONE;
   private static final int PLAY_STATE_SUSPENDED;
   private static final int PLAY_STATE_SUSPEND_PENDING;
   private static final int PLAY_STATE_STARTED;
   private static final int PLAY_STATE_START_PENDING;
   private static final int PLAY_STATE_WAITING_TO_SUSPEND;
   private static final byte MIN_BITPOOL;
   private static final byte MAX_BITPOOL;
   private static final byte[] SBC_CONFIG_ELEMENTS = new byte[]{46, -1, 19, 48};
   public static final long LOG_GUID;
   private static final int LOG_OPEN_STREAM;
   private static final int LOG_CLOSE_STREAM;
   private static final int LOG_SUSPEND_STREAM;
   private static final int LOG_START_STREAM;
   private static final int LOG_OPEN_STREAM_RESPONSE;
   private static final int LOG_START_STREAM_RESPONSE;
   private static final int LOG_STREAM_STARTED;
   private static final int LOG_STREAM_IDLE;
   private static final int LOG_STREAM_SUSPENDED;
   private static final int LOG_STREAM_ABORTED;
   private static final int LOG_BAD_CODEC_DATA;
   private static final int LOG_CONFIG_STREAM;
   private static final int LOG_RECONFIG_REQUIRED;
   private static final int LOG_START_ALREADY_PENDING;
   private static final int LOG_WAITING_TO_SUSPEND_STREAM;
