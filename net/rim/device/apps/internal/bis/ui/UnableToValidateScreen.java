...
public final class UnableToValidateScreen extends BasicScreen {
   ...
   public final void refresh(Hashtable screenParams) {
      ...
      this.addContentField(new LabelField(ApplicationResources.getString(176)));
      ...
      CommandEvent yesEvent = new CommandEvent(32, 7, new String[]{invalidAccountDescription});
