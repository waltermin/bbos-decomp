...
public final class AddISPEmailScreen extends UserSettingsScreen {
   ...
   public final void refresh(Hashtable screenParams) {
      ...
      CommandEvent nextEvent = new CommandEvent(17, 12, new String[]{"email", "server", "userName", "password"});
   ...
   public final boolean importFormDataFromUI(Hashtable inputMap) {
      ...
      String server = this._emailServerEdit.getText();
