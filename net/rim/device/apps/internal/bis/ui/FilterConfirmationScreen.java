...
public final class FilterConfirmationScreen extends BasicScreen {
   ...
   public final void refresh(Hashtable screenParams) {
      ...
      AnimatedBitmapField exclamationIcon = (AnimatedBitmapField)(new Object(exclamationImage, 1000, 0));
      HorizontalSpacerField hsf = (HorizontalSpacerField)(new Object(5));
      this.addContentFieldRow(new Object[]{exclamationIcon, hsf, new Object(ApplicationResources.getString(293))});
      this.addContentLineBreak();
      this.addContentField((Field)(new Object(ApplicationResources.getString(294))));
      this.addContentLineBreak();
      this.addContentField((Field)(new Object(ApplicationResources.getString(295))));
