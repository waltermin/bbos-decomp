...
public final class HotmailPRVErrorScreen extends UserSettingsScreen {
   ...
   public final void refresh(Hashtable screenParams) {
      ...
      this.addContentField(new ActiveRichTextField(ApplicationResources.getString(146)));
      this.addContentLineBreak();
      this.addContentField(new ActiveRichTextField(ApplicationResources.getString(147)));
      this.addContentLineBreak();
      ...
      this.addContentLineBreak();
      this.addContentField(new LabelField(ApplicationResources.getString(137)));
