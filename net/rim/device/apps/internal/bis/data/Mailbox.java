...
public final class Mailbox {
   ...
   public static final int MAILBOX_TYPE_UNKNOWN;
   public static final int MAILBOX_TYPE_SIMPLE;
   public static final int MAILBOX_TYPE_HOSTED;
   public static final int MAILBOX_TYPE_PROPRIETARY;
   public static final int MAILBOX_TYPE_ISP;
   public static final int MAILBOX_TYPE_OWA;
   public static final int MAILBOX_TYPE_SMC;
   public static final String PROTOCOL_POP;
   public static final String PROTOCOL_IMAP;
   public static final String PROTOCOL_OWA;
   public static final String PROTOCOL_NATIVE;
   private static final int SOURCE_MAILBOX_VALIDATED;
   private static final int DELETE_SYNC_ENABLED;
   private static final int FORWARD_MESSAGES_TO_DEVICE;
   public static final int FIELD_HIDDEN;
   public static final int FIELD_READONLY;
   public static final int FIELD_ALTERABLE;
   private static final int FIELD_PERMISSION_INDEX_DESCRIPTION;
   private static final int FIELD_PERMISSION_INDEX_FRIENDLYNAME;
   private static final int FIELD_PERMISSION_INDEX_ADDRESS;
   private static final int FIELD_PERMISSION_INDEX_LOGIN;
   private static final int FIELD_PERMISSION_INDEX_REPLYTO;
