...
public final class OWAEmailSetupCommand implements DomainCommand {
   ...
   public final DomainCommandResult run(Hashtable params) {
      ...
      String owaUserName = ArgUtils.getStringValue(params, "userName");
      String owaPassword = ArgUtils.getStringValue(params, "password");
      ...
      sessionState.setIntegrationPassword(owaPassword);
      ...
      try {
         RestClient$AddMailboxCallResult callResult = restClient.addOWAAccount(
            configRecord.getBrandName(), userName, email, server, description, owaUserName, owaPassword
         );
