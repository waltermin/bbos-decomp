         ...
         try {
            ...
            if (defaultProperties != null) {
               ...
               while (propertiesKeys.hasMoreElements()) {
                  ...
                  String value = getStringValue(defaultProperties, key);
            ...
            if (requestProperties != null) {
               ...
               while (propertiesKeys.hasMoreElements()) {
                  String key = (String)propertiesKeys.nextElement();
                  String value = getStringValue(requestProperties, key);
                  conn.setRequestProperty(key, value);
               }
            }
            ...
            var37 = new HttpResponse(responseCode, responseData, contentType, responsePropertiesMap, location);
            var25 = false;
            var28 = false;
         } finally {
            if (var28) {
