...
public final class RestClient {
   ...
   private static final String REST_HOST_URL_PATTERN;
   private static final String BRAND_URL_PATTERN;
   private static final String USER_URL_PATTERN;
   private static final String SPECIFIC_USER_URL_PATTERN;
   private static final String SEND_FORGOT_PASSWORD_URL_PATTERN;
   private static final String SEND_FORGOT_HOSTED_PASSWORD_URL_PATTERN;
   private static final String SESSION_URL_PATTERN;
   private static final String CHANGE_HANDHELD_URL_PATTERN;
   private static final String CHANGE_PASSWORD_URL_PATTERN;
   private static final String SEND_SERVICE_BOOKS_URL_PATTERN;
   private static final String LOG_URL_PATTERN;
   private static final String EMAIL_ACCOUNT_URL_PATTERN;
   private static final String SPECIFIC_EMAIL_ACCOUNT_URL_PATTERN;
   private static final String VALIDATE_SRCMBOX_URL_PATTERN;
   private static final String CLIENT_APP_STATUS_URL_PATTERN;
   private static final String CORE_STATUS_URL_PATTERN;
   private static final String LANG_STATUS_URL_PATTERN;
   private static final String ACCEPT_EUA_URL_PATTERN;
   private static final String PRE_AUTH_PATTERN;
   private static final String VALIDATE_PASSWORDS_URL_PATTERN;
   private static final String CHANGE_TO_USERNAME_URL_PATTERN;
   private static final String SECRET_QUESTIONS_URL_PATTERN;
   private static final String REST_REQUEST_METHOD;
   private static final String FILTERS_URL_PATTERN;
   private static final String FILTERS_RETRIEVE_URL_PATTERN;
   private static final String FILTER_ADD_URL_PATTERN;
   private static final String FILTER_UPDATE_DELETE_URL_PATTERN;
