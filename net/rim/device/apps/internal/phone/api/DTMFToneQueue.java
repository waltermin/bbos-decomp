...
public final class DTMFToneQueue extends Thread implements PhoneEventListener {
   ...
   private static final int DTMF_EVENT;
   private static final int LOG_DTMF_START_TONE_FAILED;
   private static final int LOG_DTMF_ADD_TONE_FAILED;
   private static final int LOG_DTMF_ABORT;
   private static final int LOG_DTMF_INVALID_TONE;
   private static final int LOG_DTMF_ECHO_TONE;
   private static final int LOG_DTMF_SEND_TONE;
   private static final int LOG_DTMF_DELAY;
   private static final byte INVALID_DTMF_BYTE;
   private static final int INVALID_DTMF_AUDIO_TONE;
   private static final long DEFAULT_TONE_LENGTH = PhoneUtilities.idenTypeNetwork() ? 200 : 100;
   private static final long MAX_TONE_LENGTH;
   private static final long DEFAULT_GAP_LENGTH;
   private static final long DTMF_RETRY_LENGTH;
   private static final long MAX_DTMF_RETRY_LENGTH;
   private static final long HOLD_MAXIMUM;
   private static final long HOLD_MINIMUM;
   private static final int DELAY_MAXIMUM;
