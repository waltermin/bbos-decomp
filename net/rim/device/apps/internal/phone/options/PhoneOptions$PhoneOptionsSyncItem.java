...
final class PhoneOptions$PhoneOptionsSyncItem extends OTASyncCapableSyncItem implements ForwardingTypes, AudioTTYListener {
   ...
   private static final int SMART_DIAL_COUNTRY_CODE_TAG = 1;
   private static final int SMART_DIAL_AREA_CODE_TAG = 2;
   private static final int SMART_DIAL_PHONE_NUMBER_TAG = 3;
   private static final int SMART_DIAL_LOCAL_PHONE_NUMBER_LENGTH_TAG = 4;
   private static final int VOICE_MAIL_TAG = 5;
   private static final int BOOLEAN_OPTIONS_TAG = 6;
   private static final int FORWARD_ALL_CALLS_TAG = 7;
   private static final int FORWARD_BUSY_TAG = 8;
   private static final int FORWARD_NO_REPLY_TAG = 9;
   private static final int FORWARD_NOT_REACHABLE_TAG = 10;
   private static final int SMART_DIAL_NATIONAL_PHONE_NUMBER_LENGTH_TAG = 11;
   private static final int VOICE_MAIL_NUMBER_TAG = 12;
   private static final int VOICE_MAIL_ADDITIONAL_TONES_TAG = 13;
   private static final int CORPORATE_EXTENSIONS_ADDITIONAL_TONES_TAG = 14;
   private static final int CORPORATE_EXTENSION_LENGTH_TAG = 15;
   private static final int CALL_TIMERS_TAG = 16;
   private static final int TTY_TAG = 17;
   private static final int PHONE_LIST_VIEW_TYPE_TAG = 18;
   private static final int DIRECT_CONNECT_OPTIONS_TAG = 19;
   private static final int CORPORATE_EXTENSION_LENGTH_EXCLUSIONS_TAG = 20;
   private static final int EXTENSIONS_ADDITIONAL_TONES_TAG = 21;
   private static final int GPS_TAG = 22;
   private static final int AVC_TAG = 23;
   private static final int DIRECT_CONNECT_LOUD_AUDIO = 24;
   private static final int DEFAULT_CALL_VOLUME_TAG = 25;
   private static final int SAVED_FORWARDING_NUMBER_TAG = 26;
   private static final int SHOW_CALL_LOGS_TAG = 27;
   private static final int HAC_TAG = 28;
   private static final int CORPORATE_EXTENSION_NETWORK_TAG = 29;
   private static final int RINGTONE_LIGHT_TAG = 30;
   private static final int VOICE_MAIL_LINE_TAG = 31;
   private static final int DEFAULT_ENHANCED_CALL_AUDIO_TAG = 32;
   private static final int PREVIOUS_ENHANCED_CALL_AUDIO_TAG = 33;
   private static final int LINE_DESCRIPTION_LINE = 34;
   private static final int LINE_DESCRIPTION_STRING = 35;
