...
public final class MMCDocHandler extends DefaultHandler {
   ...
   private static final String STATUS_URI = "status-uri";
   private static final String MMC_ID = "mmcID";
   ...
   public static final String PHONE_OEM = "phone:oem";
   public static final String PHONE_PSA_VERSION = "phone:psa.version";
   public static final String PHONE_SOFTWARE_VERSION = "phone:version.software";
   public static final String PHONE_CDMA_IS683 = "phone:cdma.is683";
   public static final String PHONE_CDMA_IS683_RESULT = "phone:cdma.is683.result";
   public static final String PHONE_CDMA_PRL = "phone:cdma.prl";
   public static final String PHONE_CDMA_NAM_MDN = "phone:cdma.nam.mdn";
   public static final String PHONE_CDMA_NAM_MSID = "phone:cdma.nam.msid";
   ...
   public static final String BROWSER_RESET = "browser:reset";
   public static final String PHONE_RESET = "phone:reset";
   public static final String PHONE_HOMEPAGE = "phone:homepage";
   public static final String PRL_STORAGE_AVAILABLE = "phone:prl.storage.available";
   public static final String PHONE_RESTARTSESSION = "phone:restartsession";
   private static final String CID_SUFFIX = "@cdma.blackberry.com";
   private static final String VALUEREF_STATUS = "cid:";
   private static final String CONTENT_ID = "Content-ID: <";
   private static final String CONTENT_TYPE = "Content-Type: ";
   private static final String BOUNDARY = "cDmAbLaCkBeRrYiOtA";
   ...
   private static final String OBJECT_UNKNOWN = "UnknownObject";
   private static final String OK = "ok";
   private static final String CID_MISSING = "CidMissing";
   private static final String DOWNLOAD_FAILED = "DownLoadFailed";
   public static final int PRL_STORAGE_SIZE = 8192;
