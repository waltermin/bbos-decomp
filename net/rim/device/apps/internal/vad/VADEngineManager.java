...
final class VADEngineManager
   ...
   private static final long VAD_OPTIONS_DATA_KEY;
   static final int ENGINE_OK;
   static final int ENGINE_STARTING;
   static final int ENGINE_ERROR_IT_POLICY;
   static final int ENGINE_ERROR_OOM;
   static final int ENGINE_ERROR_UNKNOWN;
   static final int ENGINE_ERROR_NO_AUDIO;
   static final int ENGINE_ERROR_CONTENT_PROTECTION;
   static final int ENGINE_ERROR_VERSION_MISMATCH;
   static final int ENGINE_ERROR_STARTING_CALL;
   private static final int FILE_INVALID;
   private static final int FILE_LVR;
   private static final int FILE_PRM;
   private static final int FILE_STR;
   private static final int FILE_ELVIS;
   private static final int FILE_ENROLL_IDX;
   private static final int FILE_VRE_CN;
   private static final int FILE_VST_PARAM;
   private static final int FILE_VR_VERSION;
   private static final int FILE_GRAMMAR_DUMP;
   private static final int FILE_TEMP_ELVIS;
   private static final int FILE_AUDIO_DATA;
   private static final int NUM_FILES;
   private static final int ENGINE_STATE_NONE;
   private static final int ENGINE_STATE_INITIALIZING;
   private static final int ENGINE_STATE_READY;
   private static final int ENGINE_STATE_STOPPED;
   private static final int ENGINE_STATE_PROCESSING_EVENT;
   private static final int ENGINE_STATE_REBUILDING_ADDRESS_BOOK;
   private static final int ENGINE_STATE_STARTING;
   private static final int ENGINE_STATE_STOPPING;
   private static final int ENGINE_STATE_PROCESSING_EXIT_EVENT;
   private static final int ENGINE_STATE_VERSION_MISMATCH;
   private static final int MAX_ADDRESS_BOOK_ENTRIES;
   private static final boolean DEBUG_FS;
   private static final boolean DEBUG_PB;
   private static final int TTS_ACTION_START;
   private static final int TTS_ACTION_DONE;
   private static final int TTS_ACTION_INTERRUPT;
