package net.rim.device.theme.bbdimension_l_320x240_b;
...
public final class ThemeFactory extends Theme$Factory {
   public ThemeFactory() {
      super("Bbdimension_l_320x240_b", "Bbdimension_zen_320x240_b");
   ...
   public final String getName(Locale locale) {
      return ResourceBundle.getBundle(-7466788116501415566L, "net.rim.device.theme.bbdimension_l_320x240_b.resource.Theme").getString(0);
   }
   ...
   public final void populate(Theme$Writer theme) {
      theme.setResourceBundle(ResourceBundle.getBundle(-7466788116501415566L, "net.rim.device.theme.bbdimension_l_320x240_b.resource.Theme"));
      theme.addResources();
