...
public final class Protocol implements ConnectionBaseInterface {
   ...
   private static final int MAX_IPS_TO_TRY;
   ...
   private static final String APN_USER;
   private static final String APN_PASS;
   private static final String DNS1;
   private static final String DNS2;
   private static final String SESSION_TIMEOUT;
   private static final String DEFAULT_APN;
   private static final String DEFAULT_INTERFACE;
   private static final String TUNNEL_DESC;
   private static final int MAX_TUNNEL_ATTEMPTS;
   private static final int TUNNEL_KICK;
   private static final String PREFIX;
   private static final String DEVICE_SIDE_PARM;
