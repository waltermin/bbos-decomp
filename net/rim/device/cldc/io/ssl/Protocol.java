...
public final class Protocol implements ConnectionBaseInterface {
   ...
   public final Connection openPrim(String param1, int param2, boolean param3) throws TLSSecurityException {
      ...
      // 000: bipush 0
      // 001: istore 4
      // 003: invokestatic net/rim/device/cldc/io/ssl/TLSOptionStore.getOptions ()Lnet/rim/device/cldc/io/ssl/TLSOptionStore;
      // 006: astore 5
      // 008: bipush 1
      // 009: istore 6
      ...
      // 0da: dup
      // 0db: getstatic net/rim/device/cldc/io/ssl/Protocol._rb Lnet/rim/device/api/i18n/ResourceBundle;
      // 0de: bipush 13
      ...
      // 21e: dup
      // 21f: getstatic net/rim/device/cldc/io/ssl/Protocol._rb Lnet/rim/device/api/i18n/ResourceBundle;
      // 222: bipush 13
      ...
      // 22c: istore 9
      // 22e: aload 7
      // 230: invokevirtual net/rim/device/cldc/io/utility/URL.getHost ()Ljava/lang/String;
      // 233: astore 10
      // 235: aload 5
      // 237: aload 10
      // 239: invokevirtual net/rim/device/cldc/io/ssl/TLSOptionStore.isTrustedHost (Ljava/lang/String;)Z
      // 23c: ifeq 242
      // 23f: bipush 1
      // 240: istore 9
      // 242: aload 7
      // 244: invokevirtual net/rim/device/cldc/io/utility/URL.getRIMParameters ()Lnet/rim/device/cldc/io/utility/URLParameters;
      // 247: astore 11
      // 249: aload 11
      // 24b: ifnull 25c
      // 24e: aload 11
      // 250: ldc_w "trustAll"
      // 253: invokevirtual net/rim/device/cldc/io/utility/URLParameters.containParameter (Ljava/lang/String;)Z
      // 256: ifeq 25c
      // 259: bipush 1
      // 25a: istore 9
      // 25c: new net/rim/device/cldc/io/ssl/ProxySecureConnection
      // 25f: dup
      // 260: aload 1
      // 261: iload 2
      // 262: iload 3
      // 263: iload 9
      // 265: invokespecial net/rim/device/cldc/io/ssl/ProxySecureConnection.<init> (Ljava/lang/String;IZZ)V
      // 268: areturn
