...
public final class Transport extends DatagramTransportBase implements DatagramStatusListener, GlobalEventListener, ServiceRoutingListener2, ConnEvent {
   ...
   private static final int GME_TYPE_INTEGER;
   private static final int GME_TYPE_OPAQUE;
   private static final int GME_TYPE_SOURCE_ID;
   private static final int GME_TYPE_GRP_SOURCE_ID;
   private static final int GME_TYPE_DEST_ID;
   private static final int GME_TYPE_GRP_DEST_ID;
   private static final int GME_ACK_REQUEST_FLAG;
   private static final int GME_TYPE_CONTENT_ID;
   public static final int GME_CMD_DATA;
   public static final int GME_CMD_SYSTEM_CHECK;
   public static final int GME_CMD_INVALID_COMMAND_BYTE;
   private static final int GME_CMD_SYSTEM_OK;
   private static final int GME_CMD_RESERVED;
   private static final int GME_CMD_DELIVERY;
   private static final int GME_CMD_TRANSACTION_ERROR;
   private static final int GME_TERROR_RESERVED;
   private static final int GME_TERROR_FAILURE_AT_SERVICE;
   private static final int GME_TERROR_UNHANDLED_GME_CMD;
   private static final int GME_TERROR_BAD_GME_FORMAT;
   private static final int GME_TERROR_TIMEOUT;
   private static final int GME_TERROR_INVALID_SERVICE_IDENTIFIER;
   private static final int GME_TERROR_DECRYPTION_ERROR;
   private static final int GME_TERROR_GENERAL_FAILURE;
