...
class SerialLayer extends NativeLayer {
   ...
   private static final int TX_EMPTY_TIMEOUT;
   private static final int RX_TIMEOUT;
   protected static final byte HEADER_1;
   protected static final byte HEADER_2;
   protected static final byte HEADER_3;
   protected static final byte TRAILER_1;
   protected static final byte TRAILER_2;
   protected static final byte TRAILER_3;
   protected static final byte[] HEADER = new byte[]{-39, -82, -5};
   protected static final int HEADER_INT;
   protected static final byte[] TRAILER = new byte[]{-65, -22, -99};
   protected static final int TRAILER_INT;
   ...
   protected static final int DATA_FRAGMENT_SIZE;
   protected static final int DATA_FRAGMENT_MIN;
   protected static final int DATA_FRAGMENT_PAYLOAD = 2047 - (DATA_HEADER_SIZE + DATA_TRAILER_SIZE + TRAILER.length + 1);
   private static final int VERSION_REQUIRING_DTR_FIX;
