...
public final class GcmpPacket {
   ...
   public static final int MASK_INFO_REQUEST;
   public static final int MASK_CHALLENGE_MESSAGE;
   public static final int MASK_CHALLENGE_RESPONSE;
   public static final int MASK_CHALLENGE_RESULT;
   public static final int MASK_CHALLENGE_REQUEST;
   public static final int MASK_TUNNEL_ID;
   public static final int MASK_NETWORK_ADDRESS;
   public static final int MASK_PING_TMO;
   public static final int MASK_TUNNEL_HOLD_TMO;
   public static final int MASK_SHUTTING_DOWN;
   public static final int MASK_ACK_REQUEST;
   public static final int MASK_ACK_RESPONSE;
   public static final int MASK_ACK_INFO;
   public static final byte CHALLENGE_SCHEME_HMAC;
   public static final byte CHALLENGE_RESULT_FAILED;
   public static final byte CHALLENGE_RESULT_PASSED;
   public static final byte CHALLENGE_RESULT_NOT_SUPPORTED;
   private static final byte TYPE_TERMINATOR;
   private static final byte TYPE_INFO_REQUEST;
   private static final byte TYPE_CHALLENGE_MESSAGE;
   private static final byte TYPE_CHALLENGE_RESPONSE;
   private static final byte TYPE_CHALLENGE_RESULT;
   private static final byte TYPE_CHALLENGE_REQUEST;
   private static final byte TYPE_TUNNEL_ID;
   private static final byte TYPE_NETWORK_ADDRESS;
   private static final byte TYPE_PING_TMO;
   private static final byte TYPE_TUNNEL_HOLD_TMO;
   private static final byte TYPE_SHUTTING_DOWN;
   private static final byte TYPE_ACK_REQUEST;
   private static final byte TYPE_ACK_RESPONSE;
   private static final byte TYPE_ACK_INFO;
   private static final byte BYTE_FALSE;
   private static final byte BYTE_TRUE;
