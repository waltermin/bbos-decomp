...
final class GcmpSession extends Thread implements GcmpEvents, RadioStatusListener, SrpListener {
   ...
   private static final int DEF_INACTIVITY_TMO;
   private static final boolean DEF_CONDITIONAL_PINGING;
   private static final int DEF_TUNNEL_HOLD_TMO;
   private static final int MAX_INACTIVITY_TMO;
   private static final int MIN_INACTIVITY_TMO;
   private static final int DELAY_SEND_TMO;
   private static final int ACK_RESPONSE_TMO;
   private static final int START_BACKOFF_TMO;
   private static final int MAX_BACKOFF_TMO;
   private static final int COVERAGE_LOSS_TMO = !RadioInfo.areWAFsSupported(2)
      ...
      ? 15000
      : 300000;
   private static final int WAIT_DELAY_SEND;
   private static final int WAIT_ACK_RESPONSE;
   private static final int WAIT_BACKOFF;
   private static final int WAIT_INACTIVITY;
   private static final int WAIT_OUT_OF_COVERAGE;
   private static final int ACTION_NONE;
   private static final int ACTION_DELAY_SEND;
   private static final int ACTION_KICK;
   private static final int ACTION_RETRY;
   private static final int ACTION_BACKOFF;
   private static final int ACTION_DEACTIVATE;
   public static final int DEF_MASK;
