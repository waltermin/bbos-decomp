...
public final class TunnelManagerImpl extends Thread implements GlobalEventListener, RadioStatusListener, TunnelEvent {
   ...
   private static final int WAIT_INACTIVE;
   private static final int WAIT_ACTIVE;
   private static final int WAIT_ACTIVATING;
   private static final int WAIT_BACKOFF;
   private static final int WAIT_DORMANT;
   private static final int WAIT_OFF;
   private static final int WAIT_LINGER;
   ...
   private static final int ACTION_ACTIVATE;
   private static final int ACTION_BACKOFF;
   private static final int ACTION_ACTIVE;
   private static final int ACTION_INACTIVE;
   private static final int ACTION_CRITICAL;
   private static final int ACTION_STANDBY;
   private static final int ACTION_DORMANT;
