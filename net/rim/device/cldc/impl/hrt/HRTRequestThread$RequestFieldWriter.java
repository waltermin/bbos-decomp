...
final class HRTRequestThread$RequestFieldWriter implements TLEFieldController {
   ...
   int _deviceId;
   public static final int MODE_DEVICE_INFO = 0;
   public static final int MODE_SERVICE_INFO = 1;
   private static final int OS_VERSION = 1;
   private static final int APPS_VERSION = 2;
   private static final int DEVICE_ID = 3;
   private static final int DEVICE_NAME = 4;
   private static final int CURRENT_NPC = 5;
   private static final int IMEI = 6;
   private static final int IMSI = 7;
   private static final int ESN = 8;
   private static final int MSISDN = 9;
   private static final int ICCID = 10;
   private static final int REGISTRATION_APN = 11;
   private static final int CURRENT_NPC_EXTENSION = 12;
   private static final int MDN = 13;
   private static final int IP_ADDRESS = 14;
   private static final int SIM_ID = 15;
   private static final int UFMI = 16;
   private static final int LEGACY_GID1_AND_SPN = 17;
   private static final int GID2 = 18;
   private static final int LOCALIZATION = 19;
   private static final int SUPPORTED_RADIO_TECHNOLOGY = 20;
   private static final int HOME_NPC = 21;
   private static final int EF_SPN = 22;
   private static final int EF_GID1 = 23;
   private static final int HOME_NPC_EXTENSION = 28;
   private static final int PROXY_HOME_NPC = 24;
   private static final int PROXY_HOME_NPC_EXTENSION = 25;
   private static final int MEID = 30;
   private static final int SERVICE_INFO_UID = 1;
   private static final int SERVICE_INFO_HOME_ADDRESS = 5;
   private static final int SRT_3GPP_GPRS = 1;
   private static final int SRT_3GPP_UMTS = 2;
   private static final int SRT_3GPP_GAN = 4;
   private static final int SRT_WLAN_DEFAULT = 8;
   private static final int SRT_CDMA_DEFAULT = 16;
   private static final int SRT_IDEN_DEFAULT = 32;
