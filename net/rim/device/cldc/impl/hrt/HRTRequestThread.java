...
public final class HRTRequestThread extends Thread implements SIMCardStatusListener, GlobalEventListener, Comparator, RadioStatusListener, RealtimeClockListener {
   ...
   private static final String HR_REG_THREAD_STR;
   public static final long HR_REQ_THREAD_GUID;
   private static final long HR_REQ_THREAD_COMMAND_GUID;
   ...
   private static final int CMD_NONE;
   private static final int CMD_GME_SYS_CHECK;
   private static final int CMD_REG_INFO_PACKET;
   private static final int CMD_SYS_CHECK_THEN_REG_INFO_PACKET;
   private static final int CMD_REG_REQ;
   private static final int CMD_DYNAMIC_PIN_REQ;
   private static final int PROG_READY;
   private static final int PROG_WAIT_FOR_CONTEXT;
   private static final int PROG_WAIT_FOR_REG_RESP;
   private static final int PROG_DONE;
   private static final int PROG_NO_DATA_COVERAGE;
   private static final int PROG_WAIT_FOR_KICK;
   private static final int PROG_NO_ICCID_IMSI;
   private static final int PROG_WAIT_ON_SEND_FAILURE;
   private static final int PROG_NO_HOME_NPC;
   private static final int EVENT_NONE;
   private static final int EVENT_NEW_NPC;
   private static final int EVENT_REGISTER_NOW;
   private static final int EVENT_NEW_ACTIVE_HRI;
   private static final int EVENT_ACTIVE_HRI_MODIFIED;
   private static final int EVENT_NO_ACTIVE_HRI;
   private static final int EVENT_SIM;
   private static final int EVENT_SERVICE_BOOK_CHANGED;
   private static final int EVENT_REG_RESP_RECEIVED;
   private static final int EVENT_CONNECTION_ACTIVATED;
   private static final int EVENT_CONNECTION_REFUSED;
   private static final int EVENT_SEND_SYS_CHECK;
   private static final int EVENT_ABORT_EXISTING;
   private static final int EVENT_NEW_HOME_NPC;
   private static final int EVENT_NEW_MDN;
   private static final int EVENT_NEW_SPN;
   private static final int EVENT_DEVICE_HAS_NO_PIN;
   private static final int EVENT_TRY_NEXT_APN;
   private static final int EVENT_NEW_IMSI;
   private static final int EVENT_TTL_EXPIRED;
   private static final int PB_ERROR;
   private static final int PB_NEW_DEFAULT_HRT;
   private static final int PB_EMPTY_RESPONSE;
   private static final int PB_BAD_REF_ID;
   private static final int PB_REG_ERROR;
   private static final int PB_DYNAMIC_PIN_RESPONSE;
   private static final int DELAY_SHORT;
   private static final int DELAY_MEDIUM;
   private static final int DELAY_LONG;
   private static final int DELAY_SUPER_LONG;
   private static final int DELAY_NO_HINT;
   private static final int CAUSE_NONE;
   private static final int CAUSE_RESET;
   private static final int CAUSE_NPC_CHANGE;
   private static final int CAUSE_USER_REQUEST;
   private static final int CAUSE_NO_ACTIVE_HRI;
   private static final int CAUSE_SIM_CHANGE;
   private static final int CAUSE_SB_CHANGE;
   private static final int CAUSE_BAD_REG_RESPONSE;
   private static final int CAUSE_FIRST_TIME_EVER;
   private static final int CAUSE_BAD_REG_ID;
   private static final int CAUSE_REG_RESP_TIMEOUT;
   private static final int CAUSE_HOME_NPC_CHANGE;
   private static final int CAUSE_MDN_CHANGE;
   private static final int CAUSE_SPN_CHANGE;
   private static final int CAUSE_DOWNGRADE;
   private static final int CAUSE_DEVICE_HAS_NO_PIN;
   private static final int CAUSE_IMSI_CHANGE;
   private static final int CAUSE_TTL_EXPIRED;
   private static final int MAX_ATTEMPTS;
   private static final int CONN_RELAY;
   private static final int CONN_REG;
   ...
   private static final byte V3_REG_REQ_VERSION;
   private static final byte V4_REG_REQ_VERSION;
   private static final byte V5_REG_REQ_VERSION;
   private static final byte REGISTRATION_REQUEST_PACKET;
   private static final int REGISTRATION_RESPONSE_PACKET;
   private static final byte DYNAMIC_PIN_REQUEST_PACKET;
   private static final int DYNAMIC_PIN_RESPONSE_PACKET;
   private static final int CRYPTO_SCHEMA_RSA_AES;
   private static final int FIELD_DEVICE_INFORMATION;
   private static final int FIELD_DEFAULT_HRT;
   private static final int FIELD_REGISTRATION_HRT;
   private static final int FIELD_SERVICE_LIST;
   private static final int FIELD_SERVICE_ROUTING_INFO;
   private static final int FIELD_HAVE_ROUTING_INFO_FLAG;
   private static final int FIELD_REFERENCE_ID;
   private static final int FIELD_REG_CAUSE;
   private static final int FIELD_ASSIGNED_PIN;
   private static final int FIELD_PENDING_LIFETIME;
   private static final int FIELD_RESPONSE_KEY;
   private static final int FIELD_SECURE_PIN_IP_KEY;
   private static final int FIELD_TIME_TO_LIVE;
   private static final int FIELD_REGISTRATION_ERROR;
   private static final int FIELD_REGISTRATION_ERROR_MESSAGE;
   private static final int ERROR_PROTOCOL_VERSION;
   private static final int ERROR_PROVISIONING_SYSTEM;
   private static final int ERROR_INVALID_FORMAT;
   private static final int ERROR_INVALID_DATA;
   private static final int ERROR_DECRYPTION_FAILED;
   private static final int ERROR_INVALID_ENCRYPTION_KEY;
   private static final int ERROR_ACCESS_DENIED;
   private static final int ERROR_INVALID_PIN;
   private static final int SERVICE_INFO_UID;
   private static final int SERVICE_INFO_HRT;
   private static final int SERVICE_INFO_DISABLED;
   private static final int EL_REQT_ON;
   private static final int EL_REQT_OFF;
   private static final int EL_CANT_OPEN_CONNECTIONS;
   private static final int EL_CLOSE_REG_CONNECTION;
   private static final int EL_CLOSE_RELAY_CONNECTION;
   private static final int EL_REG_SERVER_PRESENT;
   private static final int EL_REG_SERVER_ABSENT;
   private static final int EL_COMMAND_DONE;
   private static final int EL_COMMAND_FAILED;
   private static final int EL_NEW_COMMAND;
   private static final int EL_COMMAND_DROPPED;
   private static final int EL_NO_COMMAND;
   private static final int EL_EQUAL_COMMAND;
   private static final int EL_DROPPED_REG_COMMAND;
   private static final int EL_EVENT_NEW_NPC;
   private static final int EL_EVENT_REG_NOW;
   private static final int EL_EVENT_NEW_ACTIVE_HRI;
   private static final int EL_EVENT_ACTIVE_HRI_MODIFIED;
   private static final int EL_EVENT_NO_ACTIVE_HRI;
   private static final int EL_EVENT_SIM;
   private static final int EL_EVENT_SB_CHANGED;
   private static final int EL_EVENT_REG_RESP;
   private static final int EL_EVENT_DYN_PIN_RESP;
   private static final int EL_EVENT_CONN_UP;
   private static final int EL_EVENT_TIMEOUT;
   private static final int EL_EVENT_CONN_REFUSED;
   private static final int EL_EVENT_SEND_SYS_CHECK;
   private static final int EL_EVENT_ABORT_EXISTING;
   private static final int EL_EVENT_NEW_HOME_NPC;
   private static final int EL_EVENT_NEW_MDN;
   private static final int EL_EVENT_NEW_IMSI;
   private static final int EL_EVENT_NEW_SPN;
   private static final int EL_EVENT_DEVICE_HAS_NO_PIN;
   private static final int EL_EVENT_TTL_EXPIRED;
   private static final int EL_NEW_SIM_HASH;
   private static final int EL_NEW_UID_HASH;
   private static final int EL_NEW_HOME_NPC_1;
   private static final int EL_NEW_HOME_NPC_2;
   private static final int EL_PENDING_SB_DROPPED;
   private static final int EL_PROG_NO_DATA_COVERAGE;
   private static final int EL_PROG_NO_HRI;
   private static final int EL_PROG_WAIT_FOR_CONTEXT;
   private static final int EL_PROG_NO_ICCID_IMSI;
   private static final int EL_PROG_WAIT_FOR_KICK;
   private static final int EL_PROG_NO_HOME_NPC;
   private static final int EL_EXECUTE_ABORT;
   private static final int EL_EXECUTE_FAILED;
   private static final int EL_EXECUTE_SYS_CHECK;
   private static final int EL_EXECUTE_V3_REG_REQ;
   private static final int EL_EXECUTE_V3_INFO;
   private static final int EL_EXECUTE_V4_REG_REQ;
   private static final int EL_EXECUTE_V4_INFO;
   private static final int EL_EXECUTE_V5_REG_REQ;
   private static final int EL_EXECUTE_V5_INFO;
   private static final int EL_EXECUTE_DYN_PIN_REQ;
   private static final int EL_EXECUTE_MAX_ATTEMPTS;
   private static final int EL_EXECUTE_CANCELED;
   private static final int EL_XMIT_MDP;
   private static final int EL_XMIT_GME;
   private static final int EL_CONN_ACTIVE;
   private static final int EL_CONN_INACTIVE;
   private static final int EL_CONN_EXCEPTION;
   private static final int EL_CONN_ACTIVATE;
   private static final int EL_WHOOPS_NO_PHONE_NO;
   private static final int EL_WHOOPS_NO_ICCID_IMSI;
   private static final int EL_WHOOPS_ICCID_IMSI_CHANGED;
   private static final int EL_WHOOPS_PHONE_NO_CHANGED;
   private static final int EL_WHOOPS_PHONE_NO_EXISTS;
   private static final int EL_WHOOPS_NO_HOME_NPC;
   private static final int EL_PDP_ACTIVATE_IGNORE;
   private static final int EL_PDP_REJ_IGNORE;
   private static final int EL_PDP_REJ_NON_FATAL;
   private static final int EL_PDP_REJ_FATAL;
   private static final int EL_PDP_TRY_NEXT_APN;
   private static final int EL_CRAZY_SIM;
   private static final int EL_SIM_INVALID;
   private static final int EL_DYNAMIC_PIN_RESPONSE_ERROR;
   private static final int EL_RESP_BAD_LENGTH;
   private static final int EL_RESP_BAD_SCHEMA;
   private static final int EL_RESP_UNMATCHED;
   private static final int EL_RESP_BAD_SIG;
   private static final int EL_RESP_ERROR_PROTOCOL_VERSION;
   private static final int EL_RESP_ERROR_PROVISIONING_SYSTEM;
   private static final int EL_RESP_ERROR_INVALID_FORMAT;
   private static final int EL_RESP_ERROR_INVALID_DATA;
   private static final int EL_RESP_ERROR_DECRYPTION_FAILED;
   private static final int EL_RESP_ERROR_INVALID_ENCRYPTION_KEY;
   private static final int EL_RESP_ERROR_ACCESS_DENIED;
   private static final int EL_RESP_ERROR_INVALID_PIN;
   private static final int EL_RESET_FIRST_AFTER_RESET;
