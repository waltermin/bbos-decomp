...
class NokiaRingtonePlayer extends TunePlayer {
   ...
   private static final byte COMMAND_END;
   private static final byte CANCEL_COMMAND;
   private static final byte RINGING_TONE_PROGRAMMING;
   private static final byte SOUND;
   private static final byte UNICODE;
   private static final byte BASIC_SONG_TYPE;
   private static final byte TEMPORARY_SONG_TYPE;
   private static final byte MIDI_SONG_TYPE;
   private static final byte DIGITISED_SONG_TYPE;
   private static final byte POLYPHONIC_SONG_TYPE;
   private static final byte PATTERN_HEADER_ID;
   private static final byte ALREADY_DEFINED_PATTERN;
   private static final byte NOTE_INSTRUCTION_ID;
   private static final byte SCALE_INSTRUCTION_ID;
   private static final byte STYLE_INSTRUCTION_ID;
   private static final byte TEMPO_INSTRUCTION_ID;
   private static final byte VOLUME_INSTRUCTION_ID;
   private static final byte SCALE1;
   private static final byte SCALE2;
   private static final byte SCALE3;
   private static final byte SCALE4;
   private static final byte STYLE_NATURAL;
   private static final byte STYLE_CONTINUOUS;
   private static final byte STYLE_STACCATO;
   private static final byte FULL_NOTE;
   private static final byte HALF_NOTE;
   private static final byte QUARTER_NOTE;
   private static final byte EIGHTH_NOTE;
   private static final byte SIXTEENTH_NOTE;
   private static final byte THIRTY_SECONDTH_NOTE;
   private static final byte NO_SPECIAL_DURATION;
   private static final byte DOTTED_NOTE;
   private static final byte DOUBLE_DOTTED_NOTE;
   private static final byte TWO_THIRD_LENGTH;
