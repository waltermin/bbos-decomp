...
public final class MediaLogger {
   ...
   private static final String MAKE_UNAVAILABLE;
   private static final String PLAY_STREAM;
   private static final String PLAY_STREAM_FAILED;
   private static final String RECORD_STREAM;
   private static final String RECORD_STREAM_FAILED;
   private static final String RESERVE_SESSION;
   private static final String RESERVE_SESSION_FAILED;
   private static final String OPEN_STREAM;
   private static final String OPEN_STREAM_FAILED;
   private static final String CLEAR_DEAD_SESSION;
   private static final String MEDIA_ERROR;
   private static final String ACTIVE_MEDIA_PLAY_ERROR;
