...
final class JPEGMetadataExtractor extends MetaDataControlImpl {
   ...
   private static final int WINDOWS_XP_EXIF;
   private static final int JEIDA_EXIF;
   private static final int TAG_TYPE_BYTE;
   private static final int TAG_TYPE_ASCII;
   private static final int TAG_TYPE_SHORT;
   private static final int TAG_TYPE_LONG;
   private static final int TAG_TYPE_RATIONAL;
   private static final String MAKE_CANON;
   private static final String MAKE_FUJIFILM;
   private static final String MAKE_KODAK;
   private static final String MAKE_NIKON;
   private static final String MAKE_OLYMPUS;
   private static final String MAKE_RICOH;
   private static final String MAKE_SANYO;
   private static final String MAKE_SONY;
   private static final int TAG_LITTLE_ENDIAN_TAG;
   private static final int TAG_BIG_ENDIAN_TAG;
   private static final int TAG_EXIF_SEGMENT_TAG;
   private static final int TAG_END_OF_IMAGE_TAG;
   private static final int TAG_ITU_COMMENT;
   private static final int TAG_TITLE;
   private static final int TAG_COMMENT;
   private static final int TAG_AUTHOR;
   private static final int TAG_KEYWORDS;
   private static final int TAG_MAKE;
   private static final int TAG_MODEL;
   private static final int TAG_COPYRIGHT;
   private static final int TAG_DATE_TIME_TAKEN;
   private static final int TAG_DESCRIPTION;
   private static final int TAG_ORIENTATION;
   private static final int TAG_EXPOSURE_TIME;
   private static final int TAG_F_NUMBER;
   private static final int TAG_ISO_SPEED;
   private static final int TAG_EXIF_SUB_IFD;
   private static final int TAG_MAKERNOTE;
