...
public final class DeviceOptionsDaemon extends Thread implements TLEFieldController {
   ...
   private static final int SECURITY_OPTIONS;
   private static final int PAGER_OPTIONS;
   private static final int VERSION_OPTIONS;
   private static final int IT_ADMIN;
   private static final int SET_PASSWORD_CMD;
   private static final int GET_PASSWORD_STATUS_CMD;
   private static final int SET_PASSWORD_FILE;
   private static final int GET_PASSWORD_FILE;
   private static final int SET_DEVICE_OPTIONS_CMD;
   private static final int GET_DEVICE_OPTIONS_CMD;
   private static final int GET_VERSION_OPTIONS_CMD;
   private static final int UNKNOWN_COMMAND;
   private static final int SUCCESS;
   private static final int SET_PASSWORD;
   private static final int GET_PASSWORD_STATUS;
   private static final int SET_IT_POLICY;
   private static final int GET_IT_POLICY;
   private static final int CHANGE_PASWORD;
   private static final int KILL_HANDHELD;
   private static final int LOCK_HANDHELD;
   private static final int SET_OWNER_INFO;
   private static final int SET_PEER_TO_PEER_KEY;
