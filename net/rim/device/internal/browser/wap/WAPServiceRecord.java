...
public final class WAPServiceRecord {
   ...
   private static final byte ENCODED_TYPE_SECURE_ACCESS;
   private static final byte ENCODED_TYPE_AUTH_USERNAME;
   private static final byte ENCODED_TYPE_AUTH_PASSWORD;
   private static final byte ENCODED_TYPE_SESSION_RESUME;
   ...
   private static final byte ENCODED_TYPE_WAP_20_CONFORMANCE;
   private static final byte ENCODED_TYPE_MMSC_URL;
   private static final byte ENCODED_TYPE_MMS_RETRIEVAL_MODE;
   private static final byte ENCODED_TYPE_MMS_MESSAGE_URL_PREFIX;
   private static final byte ENCODED_TYPE_MMS_AUTHENTICATION_HEADER;
   private static final byte ENCODED_TYPE_MMSC_VERSION;
   private static final byte ENCODED_TYPE_MMSC_SUPPRESS_EXTRA_BYTE_COMPLIANCE_MODE;
   public static String SERVICE_CID = "WAP";
   public static final int SESSION_RESUME_FALSE;
   public static final int SESSION_RESUME_TRUE;
   public static final int SECURE_ACCESS_FALSE;
   public static final int SECURE_ACCESS_TRUE;
   public static final int WTLS_MODE_WAP;
   public static final int WTLS_MODE_OPENWAVE;
   public static final int WAP_20_CONFORMANCE_FALSE;
   public static final int WAP_20_CONFORMANCE_TRUE;
   public static final int WTLS_CLIENT_ID_TYPE_INVALID;
   public static final int WTLS_CLIENT_ID_TYPE_IPV4_DEVICE;
   public static final int WTLS_CLIENT_ID_TYPE_IPV4_SPECIFIED;
   public static final int WTLS_CLIENT_ID_TYPE_GSM_MSISDN_DEVICE;
   public static final int WTLS_CLIENT_ID_TYPE_GSM_MSISDN_SPECIFIED;
   public static final int WTLS_CLIENT_ID_TYPE_CDMA_MDN_DEVICE;
   public static final int WTLS_CLIENT_ID_TYPE_CDMA_IMSI_15_DEVICE;
   public static final int WTLS_CLIENT_ID_TYPE_CDMA_IMSI_SPECIFIED;
   public static final int WTLS_CLIENT_ID_TYPE_CDMA_IMSI_10_DEVICE;
   public static final int MMS_RETRIEVAL_MODE_UNSPECIFIED;
   public static final int MMS_RETRIEVAL_MODE_ALWAYS;
   public static final int MMS_RETRIEVAL_MODE_NEVER;
   public static final int MMS_RETRIEVAL_MODE_HOMEONLY;
   public static final int MMSC_VERSION_1_0;
   public static final int MMSC_VERSION_1_1;
   public static final int MMSC_VERSION_1_2;
   public static final int MMSC_VERSION_1_3;
