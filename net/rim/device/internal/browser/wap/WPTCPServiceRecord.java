...
public final class WPTCPServiceRecord {
   ...
   public static final byte ENCODED_TYPE_HTTP_PROXY_ADDRESS;
   public static final byte ENCODED_TYPE_PERSISTENT_CONNECTIONS;
   public static final byte ENCODED_TYPE_USE_HTTP_11;
   public static final byte ENCODED_TYPE_PROXY_AUTH_CONFIG_URL;
   public static final byte ENCODED_TYPE_USE_DNS_LOADBALANCING;
   public static final byte ENCODED_TYPE_PRIMARY_DNS;
   public static final byte ENCODED_TYPE_SECONDARY_DNS;
   public static final byte ENCODED_TYPE_CONNECT_PROXY_ADDRESS;
   public static final byte ENCODED_TYPE_PROXY_AUTH_USERNAME_TYPE;
   public static final byte ENCODED_TYPE_PROXY_AUTH_PASSWORD_TYPE;
   public static final byte ENCODED_TYPE_PROXY_AUTH_USERNAME_VALUE;
   public static final byte ENCODED_TYPE_PROXY_AUTH_PASSWORD_VALUE;
   public static final byte ENCODED_TYPE_MMSC_URL;
   public static final byte ENCODED_TYPE_MMS_RETRIEVAL_MODE;
   public static final byte ENCODED_TYPE_MMS_MESSAGE_URL_PREFIX;
   public static final byte ENCODED_TYPE_MMS_AUTHENTICATION_HEADER;
   public static final byte ENCODED_TYPE_MMSC_VERSION;
   public static final byte ENCODED_TYPE_DEFAULT_TCP_CONFIG_MODE;
   public static final byte ENCODED_TYPE_INTERFACE;
   public static final byte ENCODED_TYPE_SESSION_TIMEOUT;
   public static final byte ENCODED_TYPE_ALWAYS_SEND_BASIC_PROXY_AUTH;
   public static final int AUTH_TYPE_NOT_SPECIFIED;
   public static final int AUTH_TYPE_FROM_SERVICE_RECORD;
   public static final int AUTH_TYPE_RIM_QUERY_URL;
   public static final int AUTH_TYPE_MD5_ESN_AKEY;
   public static final int AUTH_TYPE_CLIENT_ID_ICCID;
   public static final int AUTH_TYPE_CLIENT_ID_MIN;
   public static final int AUTH_TYPE_CLIENT_ID_ESN;
   public static final int AUTH_TYPE_CLIENT_ID_MSISDN;
   public static final int AUTH_TYPE_CLIENT_ID_IMSI;
   public static final int AUTH_TYPE_CLIENT_ID_IPV4;
   public static final int AUTH_TYPE_CLIENT_ID_IPV6;
   public static final int AUTH_TYPE_CLIENT_ID_ITSI;
   public static final int AUTH_TYPE_CLIENT_ID_MAN;
   public static final int AUTH_TYPE_CLIENT_ID_ICCID_WITHOUT_ID;
   public static final int AUTH_TYPE_CLIENT_ID_MIN_WITHOUT_ID;
   public static final int AUTH_TYPE_CLIENT_ID_ESN_WITHOUT_ID;
   public static final int AUTH_TYPE_CLIENT_ID_MSISDN_WITHOUT_ID;
   public static final int AUTH_TYPE_CLIENT_ID_IMSI_WITHOUT_ID;
   public static final int AUTH_TYPE_CLIENT_ID_IPV4_WITHOUT_ID;
   public static final int AUTH_TYPE_CLIENT_ID_IPV6_WITHOUT_ID;
   public static final int AUTH_TYPE_CLIENT_ID_ITSI_WITHOUT_ID;
   public static final int AUTH_TYPE_CLIENT_ID_MAN_WITHOUT_ID;
   public static final int AUTH_TYPE_HMAC_MD5_MDN_ESN;
   public static final int AUTH_TYPE_CLIENT_ID_MDN;
   public static final int AUTH_TYPE_CLIENT_ID_MDN_WITHOUT_ID;
   public static final byte DEFAULT_TCP_CONFIG_MODE_NOT_USED;
   public static final byte DEFAULT_TCP_CONFIG_MODE_USED_FOR_EXPLICT_DEVICE_SIDE;
