...
public final class OTAUpgradeControl implements LowMemoryFailedListener {
   ...
   private int _status;
   public static final int OTA_OK;
   public static final int OTA_FLASH_FULL;
   private static final boolean DATA_BUFFER_ENDIANESS;
   private static final int CURRENT_VERSION;
   private static final int CHUNK_HEADER_LEN;
   private static final int CHUNK_FLAGS_NULL;
   private static final int CHUNK_FLAGS_ZLIB;
   private static final int CHUNK_FLAGS_SECURE;
   private static final int CHUNK_FLAGS_USED;
   private static final int ITEM_FLAGS_NULL;
   private static final int ITEM_FLAGS_DIRTY;
   private static final long GUID_BACKUP;
   private static final long GUID_RESTORE;
   private static final long GUID_EXTRA;
   private static final long GUID_LOG;
   private static final long GUID_NULL;
   private static final int AMOUNT_TO_WRITE;
   private static final int ITEMS_FOR_GC;
   private static final int TAG_RADIO;
   private static final int TAG_RADIO_IDS;
   private static final int RADIO_ON;
   private static final int RADIO_OFF;
   private static final long RADIO_IDS_PRESENT;
   private static final long OTASYNC_OFF_DELAY_IN_MS;
   private static final long SYSTEM_RECOVERY_TIME_IN_MS;
   private static final long LONG_SYSTEM_RECOVERY_TIME_IN_MS;
   private static final int RESET_RESTORE_UNDO_FLUSH_OUTPUT_TO_FLASH;
   private static final int RESET_RESTORE_UNDO_FLUSH_OUTPUT_TO_FLASH_1;
   private static final int RESET_RESTORE_UNDO_FLUSH_OUTPUT_TO_FLASH_2;
   private static final int RESET_APPEND_INT_OUTPUT_TO_FLASH;
   private static final int RESET_APPEND_INT_OUTPUT_TO_FLASH_1;
   private static final int RESET_APPEND_INT_OUTPUT_TO_FLASH_2;
   private static final int RESET_FINI_BACKUP_OUTPUT_TO_FLASH;
   private static final int RESET_FINI_BACKUP_OUTPUT_TO_FLASH_1;
   private static final int RESET_FINI_BACKUP_OUTPUT_TO_FLASH_2;
   private static final int RESET_INIT_COLLECTION_OUTPUT_TO_FLASH;
   private static final int RESET_INIT_COLLECTION_OUTPUT_TO_FLASH_1;
   private static final int RESET_INIT_COLLECTION_OUTPUT_TO_FLASH_2;
   private static final int RESET_REGISTER_COLLECTION_OUTPUT_TO_FLASH;
   private static final int RESET_REGISTER_COLLECTION_OUTPUT_TO_FLASH_1;
   private static final int RESET_REGISTER_COLLECTION_OUTPUT_TO_FLASH_2;
   private static final int RESET_BACKUP_CHUNK_OUTPUT_TO_FLASH;
   private static final int RESET_BACKUP_CHUNK_OUTPUT_TO_FLASH_1;
   private static final int RESET_BACKUP_CHUNK_OUTPUT_TO_FLASH_2;
   private static final int RESET_BACKUP_FLUSH_OUTPUT_TO_FLASH;
   private static final int RESET_BACKUP_FLUSH_OUTPUT_TO_FLASH_1;
   private static final int RESET_BACKUP_FLUSH_OUTPUT_TO_FLASH_2;
   private static final int RESET_RESTORE_CHUNK_OUTPUT_TO_FLASH;
   private static final int RESET_RESTORE_CHUNK_OUTPUT_TO_FLASH_1;
   private static final int RESET_RESTORE_CHUNK_OUTPUT_TO_FLASH_2;
   private static final int RESET_RESTORE_FLUSH_OUTPUT_TO_FLASH;
   private static final int RESET_RESTORE_FLUSH_OUTPUT_TO_FLASH_1;
   private static final int RESET_RESTORE_FLUSH_OUTPUT_TO_FLASH_2;
   private static final int RESET_RESTORE_UNDO_CHUNK_OUTPUT_TO_FLASH;
   private static final int RESET_RESTORE_UNDO_CHUNK_OUTPUT_TO_FLASH_1;
   private static final int RESET_RESTORE_UNDO_CHUNK_OUTPUT_TO_FLASH_2;
   private static final int RESET_BACKUP_COMMIT;
   private static final int RESET_BACKUP_COMMIT_1;
   private static final int RESET_RESTORE_COMMIT;
   private static final int RESET_RESTORE_COMMIT_1;
   private static final int RESET_RESTORE_PURGE;
   private static final int RESET_RESTORE_PURGE_1;
   private static final int RESET_TRANSFER_ERASE;
   private static final int RESET_TRANSFER_ERASE_1;
   private static final int RESET_BACKUP_COLLECTION_ERASE;
   private static final int RESET_BACKUP_COLLECTION_ERASE_1;
   private static final int RESET_REGISTERED_COLLECTION_ERASE;
   private static final int RESET_REGISTERED_COLLECTION_ERASE_1;
   private static final int RESET_UNDO_COLLECTION_ERASE;
   private static final int RESET_UNDO_COLLECTION_ERASE_1;
   private static final int RESET_RESTORE_BACKUP_ERASE;
   private static final int RESET_RESTORE_BACKUP_ERASE_1;
   private static final int RESET_EMPTY_UNDO_ERASE;
   private static final int RESET_EMPTY_UNDO_ERASE_1;
   private static final int RESET_EXTRA_ERASE;
   private static final int RESET_EXTRA_ERASE_1;
   private static final int RESET_APPEND_LONG_OUTPUT_TO_FLASH;
   private static final int RESET_APPEND_LONG_OUTPUT_TO_FLASH_1;
   private static final int RESET_APPEND_LONG_OUTPUT_TO_FLASH_2;
   private static final int RESET_NUM;
   private static final int RESET_UNKNOWN;
