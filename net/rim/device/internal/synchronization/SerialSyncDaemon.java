...
final class SerialSyncDaemon implements Runnable, GlobalEventListener, LowMemoryFailedListener {
   ...
   private static final boolean OUTPUT_CMDS_INTO_LOG;
   private static final int PERIODIC_COUNTER_MASK;
   private static final int REMOVES_FOR_PERSISTENT_GC;
   private static final char DEVICE_VERSION_NUMBER;
   private static final char DEVICE_MINOR_VERSION_NUMBER;
   private static final char DEVICE_LIST_DATABASES;
   private static final char DEVICE_LIST_DATABASES_EX;
   private static final char DEVICE_LIST_ENCODINGS;
   private static final char DEVICE_SUMMARIZE;
   private static final char DEVICE_RECORD_DATA;
   private static final char DEVICE_RECORD_DATA_EX;
   private static final char DEVICE_RECORD_UID;
   private static final char DEVICE_NUMBER_RECORDS;
   private static final char DEVICE_MEMORY;
   private static final char DEVICE_DATETIME;
   private static final char DEVICE_ERROR;
   private static final char HOST_VERSION_NUMBER;
   private static final char HOST_MINOR_VERSION_NUMBER;
   private static final char HOST_LIST_DATABASES;
   private static final char HOST_LIST_DATABASES_EX;
   private static final char HOST_BACKUP;
   private static final char HOST_BACKUP_EX;
   private static final char HOST_CLEAN;
   private static final char HOST_SUMMARIZE;
   private static final char HOST_SET_SUMMARY_STATE;
   private static final char HOST_ADD_RECORD;
   private static final char HOST_ADD_RECORD_EX;
   private static final char HOST_UPDATE_RECORD;
   private static final char HOST_REMOVE_RECORD;
   private static final char HOST_FETCH_RECORD;
   private static final char HOST_FETCH_RECORD_EX;
   private static final char HOST_NUMBER_RECORDS;
   private static final char HOST_MEMORY;
   private static final char HOST_CLEAN_DIRTY_FLAG;
   private static final char HOST_GET_DATETIME;
   private static final char HOST_SET_DEVICE_DATETIME;
   private static final char HOST_LIST_ENCODINGS;
   private static final char HOST_BACKUP_RESTORE;
   private static final int SERIAL_DB_ACCESS_PROTOCOL_VERSION;
   private static final int SERIAL_DB_ACCESS_PROTOCOL_MINOR_VERSION;
   private static final byte DATABASE_HEADER_VERSION;
   private static final short DATABASE_HEADER_SIZE;
   private static final byte RECORD_HEADER_VERSION;
   private static final short RECORD_HEADER_SIZE;
   private static final byte DATABASE_NAME;
   private static final int BR_START;
   private static final int BR_STOP;
   static final int SR_NO_ERROR;
   static final int SR_GENERAL_ERROR;
   static final int SR_INVALID_DATA;
   static final int SR_UNKNOWN_APP;
   static final int SR_UNKNOWN_COMMAND;
   static final int SR_UNKNOWN_DATABASE;
   static final int SR_UNKNOWN_RECORD;
   static final int SR_OUT_OF_MEMORY;
   static final int SR_OPERATION_CANCELLED;
   static final int SR_CONTENT_PROTECTION_ENABLED;
   private static final int DAYLIGHT_ENABLED;
   private static final int DAYLIGHT_SET;
   private static final short RESTORE_INACTIVE;
   private static final short RESTORE_INITIALIZING;
   private static final short RESTORE_WRITING;
