...
public class TLS10Connection implements SSLConnection, ParentStreamProvider, ConnectionCloseProvider, ConnectionCloseListener, SocketConnectionEnhanced {
   ...
   public TLS10Connection(StreamConnection subConnection, String name, boolean startHandshake, TLSRecordProtocol recordProtocol) {
      if (subConnection != null && name != null && recordProtocol != null) {
   ...
   public TLS10Connection(StreamConnection subConnection, String name, boolean startHandshake) {
      this(subConnection, name, startHandshake, new TLSRecordProtocol(subConnection, name, true));
   }

   public TLS10Connection(StreamConnection subConnection, String name) {
