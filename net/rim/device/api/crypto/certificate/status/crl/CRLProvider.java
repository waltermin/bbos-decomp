...
public class CRLProvider extends CertificateStatusProvider {
   ...
   @Override
   protected void encodeRequest(Certificate[] param1, boolean param2, ProviderRequestData param3, KeyStore param4, ProviderUiContext param5) throws StatusProviderException {
