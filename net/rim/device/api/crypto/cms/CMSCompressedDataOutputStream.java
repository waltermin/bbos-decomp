...
public final class CMSCompressedDataOutputStream extends CMSOutputStream {
   ...
   public CMSCompressedDataOutputStream(OutputStream out, int contentType, int compressionType, boolean outer) {
      ...
      if (compressionType == 1) {
         ...
         this._compressedOut = (OutputStream)(new Object(this._bufferOut));
      } else {
         throw new Object();
      }
   }
   ...
   public final void close() {
      ASN1OutputStream compressedDataOutput = (ASN1OutputStream)(new Object(super._out));
      ASN1OutputStream compressedData = (ASN1OutputStream)(new Object());
      compressedData.writeInteger(0);
      ASN1OutputStream compressionAlgorithm = (ASN1OutputStream)(new Object());
      ...
      ASN1OutputStream encapsulatedContentInfo = (ASN1OutputStream)(new Object());
