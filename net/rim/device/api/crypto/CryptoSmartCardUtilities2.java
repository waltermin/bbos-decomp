...
public class CryptoSmartCardUtilities2 {
   ...
   public static PrivateKey createPrivateKey(
      ...
      return new RSAPrivateKey(new RSACryptoSystem(smartCardRSACryptoToken, modulusBitLength), cryptoTokenPrivateKeyData);
   }
   ...
   public static PrivateKey createPrivateKey(
      ...
      return new DSAPrivateKey(new DSACryptoSystem(smartCardDSACryptoToken, cryptoTokenSystemData), cryptoTokenPrivateKeyData);
   }
}
