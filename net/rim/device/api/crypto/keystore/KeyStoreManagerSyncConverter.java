...
final class KeyStoreManagerSyncConverter implements SyncConverter, SyncObject, SyncEventListener {
   ...
   private static final long KEY_STORE_MANAGER_SYNC_CONVERTER;
   private static final int PASSWORD_PRESENT;
   private static final int ACCESS_GRANTED;
   private static final int PASSWORD_ATTEMPTS;
   private static final int PASSWORD_ATTEMPTS_THRESHOLD;
   private static final int ALL_RECORDS_SYNCED_WITH_BES;
   private static final int PASSWORD_MIN_LENGTH;
   private static final int PASSWORD_COMPLEXITY;
   private static final int LOW_SECURITY_DISABLED;
   private static final int TRUSTED_KEYSTORE_PROTECTED;
   private static final int CURRENT_PASSWORD_VERSION;
   private static final int KEY_STORE_DATA_FORMAT_VERSION;
   private static final int SIGN_MIN_KEYSTORE_SECURITY_LEVEL;
   private static final int ENCRYPT_MIN_KEYSTORE_SECURITY_LEVEL;
   private static final int PASSWORD_CHALLENGE;
   private static final int PASSWORD_RESPONSE;
   private static final int CURRENT_KEY_STORE_DATA_FORMAT_VERSION;
   private static final int PASSWORD_CHALLENGE_LENGTH;
