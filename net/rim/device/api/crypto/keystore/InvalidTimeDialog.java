...
final class InvalidTimeDialog extends PopupDialog implements FieldChangeListener {
   ...
   public InvalidTimeDialog(Certificate certificate, CertificateStatus status, long style) {
      ...
      RichTextField label = (RichTextField)(new Object(KeyStoreResources.getString(9), 45035996273704960L));
      vifm.add(label);
      LabelField yourTimeLabel = (LabelField)(new Object(KeyStoreResources.getString(12)));
      yourTimeLabel.setFont(this._boldFont);
      vifm.add(yourTimeLabel);
      SimpleDateFormat format = (SimpleDateFormat)(new Object(54));
      RichTextField yourTime = (RichTextField)(new Object(format.formatLocal(System.currentTimeMillis()), 45035996273704960L));
      vifm.add(yourTime);
      LabelField theirTimeLabel = (LabelField)(new Object(KeyStoreResources.getString(13)));
      theirTimeLabel.setFont(this._boldFont);
      vifm.add(theirTimeLabel);
      RichTextField theirTime = (RichTextField)(new Object(format.formatLocal(status.getProducedAtTime()), 45035996273704960L));
      vifm.add(theirTime);
      HorizontalFieldManager buttonManager = (HorizontalFieldManager)(new Object(12884901888L));
      this._accept = (ButtonField)(new Object(KeyStoreResources.getString(10)));
      this._accept.setChangeListener(this);
      buttonManager.add(this._accept);
      this._reject = (ButtonField)(new Object(KeyStoreResources.getString(11)));
      this._reject.setChangeListener(this);
      buttonManager.add(this._reject);
      vifm.add(buttonManager);
      HorizontalFieldManager detailManager = (HorizontalFieldManager)(new Object(12884901888L));
      this._details = (ButtonField)(new Object(KeyStoreResources.getString(14)));
