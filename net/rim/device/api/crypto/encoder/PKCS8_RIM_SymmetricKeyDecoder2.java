...
final class PKCS8_RIM_SymmetricKeyDecoder2 extends PKCS8_SymmetricKeyDecoder {
   ...
   @Override
   public final SymmetricKey decodeKey(ASN1InputStream parameters, ASN1InputStream symmetricKeyInfo, String algorithm) {
      ...
      try {
         ...
         if (algorithm.equals("AES")) {
            ...
            return (SymmetricKey)(new Object(keyData, 0, keyData.length * 8));
         }

         if (algorithm.equals("ARC4")) {
            byte[] keyData = symmetricKeyInfo.readOctetStringAsByteArray();
            return (SymmetricKey)(new Object(keyData, 0, keyData.length));
         }

         if (algorithm.equals("DES")) {
            byte[] keyData = symmetricKeyInfo.readOctetStringAsByteArray();
            return (SymmetricKey)(new Object(keyData, 0));
         }
