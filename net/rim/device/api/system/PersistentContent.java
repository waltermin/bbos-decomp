...
public final class PersistentContent {
   ...
   private static final int COMPRESS_MIN_BYTE_LENGTH = 32;
   private static final int MASTER_HEADER_BYTE_LENGTH = 3;
   private static final int MASTER_COMPRESS_FLAG = 1;
   private static final int MASTER_ENCRYPT_FLAG = 2;
   private static final int MASTER_STRING_FLAG = 4;
   private static final int MASTER_BYTES_FLAG = 8;
   private static final int NUM_MASTER_FLAGS = 4;
   private static final int MASTER_FLAGS_MASK = 15;
   private static final int MASTER_BYTE_LENGTH_SHIFT = 4;
   private static final int MASTER_BYTE_LENGTH_BITS = 20;
   private static final int MAX_MASTER_BYTE_LENGTH = 1048576;
   private static final int BLOCK_HEADER_BYTE_LENGTH = 2;
   private static final int BLOCK_COMPRESS_FLAG = 1;
   private static final int BLOCK_PUBLIC_KEY_FLAG = 2;
   private static final int BLOCK_DEVICE_KEY_FLAG = 4;
   private static final int BLOCK_BYTES_FLAG = 8;
   private static final int NUM_BLOCK_FLAGS = 4;
   private static final int BLOCK_BYTE_LENGTH_SHIFT = 4;
   private static final int BLOCK_BYTE_LENGTH_BITS = 12;
   private static final int MAX_BLOCK_BYTE_LENGTH = 4096;
   private static final long ID = -8690596288514859193L;
   private static final long EVENT_LOGGER_ID = -2564487553114485073L;
   private static PersistentContent _instance;
   private static boolean _fileHook = Array.hasFileSupport();
   private static final int ECC_CURVE_0 = 0;
   private static final int ECC_CURVE_1 = 3;
   private static final int ECC_CURVE_2 = 4;
   private static final int ONE_SECOND = 1000;
   private static final int ONE_MINUTE = 60000;
   private static final int ONE_HOUR = 3600000;
   private static final int INITIAL_CHECK_SECURE_DELAY = 1000;
   private static final byte NV_VERSION = 9;
   private static final int NV_COMPRESS_FLAG = 1;
   private static final int NV_ENCRYPT_FLAG = 2;
   private static final int NV_STRENGTH_MASK = 3;
   private static final int NV_STRENGTH_SHIFT = 2;
   private static final long R_LIFETIME = 600000L;
