...
public class XMLParser extends SAXParser implements Locator, XMLReader {
   ...
   private static final int NAME_BUFFER_INITIAL_SIZE;
   private static final int NAME_BUFFER_GROWTH_INCREMENT;
   private static final int NAMESTACK_INITIAL_SIZE;
   private static final int NAMESTACK_GROWTH_INCREMENT;
   private static final int TOKEN_SPACE;
   private static final int TOKEN_COMMENT;
   private static final int TOKEN_PI;
   private static final int TOKEN_START_TAG;
   private static final int TOKEN_END_TAG;
   private static final int TOKEN_DTD;
   private static final int TOKEN_EOF;
   private static final int TOKEN_UNKNOWN;
   private static final int TOKEN_INCLUDE;
   private static final int TOKEN_IGNORE;
   private static final int TOKEN_CDSECT;
   private static final int KEYWORD_ID;
   private static final int KEYWORD_no;
   private static final int KEYWORD_1p0;
   private static final int KEYWORD_ANY;
   private static final int KEYWORD_yes;
   private static final int KEYWORD_xml;
   private static final int KEYWORD_CDATA;
   private static final int KEYWORD_EMPTY;
   private static final int KEYWORD_FIXED;
   private static final int KEYWORD_IDREF;
   private static final int KEYWORD_NDATA;
   private static final int KEYWORD_xmlns;
   private static final int KEYWORD_ENTITY;
   private static final int KEYWORD_IDREFS;
   private static final int KEYWORD_IGNORE;
   private static final int KEYWORD_PCDATA;
   private static final int KEYWORD_PUBLIC;
   private static final int KEYWORD_SYSTEM;
   private static final int KEYWORD_version;
   private static final int KEYWORD_ATTLIST;
   private static final int KEYWORD_DOCTYPE;
   private static final int KEYWORD_ELEMENT;
   private static final int KEYWORD_IMPLIED;
   private static final int KEYWORD_INCLUDE;
   private static final int KEYWORD_NMTOKEN;
   private static final int KEYWORD_encoding;
   private static final int KEYWORD_ENTITIES;
   private static final int KEYWORD_NMTOKENS;
   private static final int KEYWORD_NOTATION;
   private static final int KEYWORD_REQUIRED;
   private static final int KEYWORD_standalone;
   private static final String ERROR_RECURSIVE_ENTITY;
   private static final String ERROR_NO_LT_IN_ATTVALUE;
   private static final String ERROR_EXTERNAL_REF_IN_ATTVALUE;
   private static final String ERROR_CANT_FIND_DTD;
   private static final String ERROR_CANT_RESOLVE;
   private static final String ERROR_BAD_END_CDATA;
   private static final String ERROR_AINT_STANDALONE;
   private static final String ERROR_DUPLICATE_ATTRIBUTE;
   private static final String ERROR_NEED_ATTVALUE;
   private static final String ERROR_NEED_ENTITY_VALUE;
   private static final String ERROR_NEED;
   private static final String ERROR_NEED_NAME;
   private static final String ERROR_NEED_ELEMENT;
   private static final String ERROR_NEED_ENCODING;
   private static final String ERROR_NEED_EOF;
   private static final String ERROR_NEED_PUBID;
   private static final String ERROR_NEED_SYSID;
   private static final String ERROR_NEED_SPACE;
   private static final String ERROR_NEED_EXT_OR_PUBID;
   private static final String ERROR_BAD_CHAR;
   private static final String ERROR_BAD_CHARREF;
   private static final String ERROR_PE_NOT_HERE;
   private static final String ERROR_PI_NOT_XML;
   private static final String ERROR_BAD_URI;
   private static final String ERROR_NEED_ANY_OR_EMPTY;
   private static final String ERROR_NEED_ATTTYPE;
   private static final String ERROR_NEED_ATTVALUEDECL;
   private static final String ERROR_NEED_MARKUPDECL;
   private static final String ERROR_NEED_MARKUP_OR_END;
   private static final String ERROR_NEED_NMTOKEN;
   private static final String ERROR_NEED_NUMBER;
   private static final String ERROR_BAD_UTF8;
   private static final String ERROR_BAD_XMLDECL;
   private static final String ERROR_TAG_MISMATCH;
   private static final String ERROR_BAD_NESTING;
   private static final String ERROR_UNDEEFINED_NAMESPACE;
   private static final String ERROR_UNDEFINED_ENTITY;
   private static final String ERROR_UNDEFINED_NAMESPACE_PREFIX;
   private static final String ERROR_UNDEFINED_PE;
   private static final String ERROR_UNEXPECTED_EOF;
   private static final String ERROR_UNRECOGNIZED_MARKUP;
   private static final String ERROR_CANT_DECODE;
   private static final String ERROR_BAD_VERSION;
   static final int LETTER;
   static final int DIGIT;
   static final int COMBINING;
