...
public final class ServiceRecord implements Persistable, GlobalEventListener {
   ...
   private static final int PROTECTED_FLAG;
   private static final int DISABLED_FLAG;
   private static final int RESTORED_FLAG;
   private static final int DISABLE_RESTORE_FLAG;
   private static final int ENABLE_RESTORE_FLAG;
   private static final int INVISIBLE_FLAG;
   ...
   static final int DT_SERVICE_NAME;
   static final int DT_ACCOUNT_ADDRESS;
   static final int DT_HOME_ADDRESS;
   static final int DT_NETWORK_ADDRESS;
   static final int DT_TRANSPORT_LEVEL_PORT;
   static final int DT_UID;
   static final int DT_CID;
   static final int DT_APPLICATION_DATA;
   static final int DT_COMP_MODE;
   static final int DT_ENCRYPT_MODE;
   static final int DT_CA_REALM;
   static final int DT_CA_ADDRESS;
   static final int DT_CA_PORT;
   static final int DT_CERTIFICATE_ID;
   static final int DT_SERVICE_KEY_DATA;
   static final int DT_HANDHELD_KEY_DATA;
   static final int DT_HOST_ROUTING_INFO;
   static final int DT_SERVICE_DESCRIPTION;
   static final int DT_CURRENT_HOST_ROUTING_INFO;
   static final int DT_HOST_ROUTING_INFOS;
   static final int DT_RECORD_SOURCE;
   static final int DT_RECORD_TYPE;
   static final int DT_PROTECTED_FLAG;
   static final int DT_FLAGS_FLAG;
   static final int DT_SERVICE_APPLICATION;
   static final int DT_DATASOURCE_ID;
   static final int DT_BBR_ROUTING_INFO;
   static final int DT_USER_ID;
   static final int DT_ACKNOWLEDGEMENT_DATA_ID;
   static final int DT_SERVICE_IDENTIFIER;
   static final int PARSE_BAD_VERSION;
   static final int PARSE_MISSING_NAME;
   static final int PARSE_MISSING_UID;
   static final int PARSE_MISSING_CID;
   static final int SECURE_SEVICE_RECORD_DROPPED;
