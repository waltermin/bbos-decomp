...
public final class ServiceBookSyncCollection
   ...
   public static final long SB_SYNC_GUID;
   static final int SB_EVENT_REPORTED_NULL_OBJECT;
   private static final int BACKUP_RESTORE_RECORD_TAG;
   private static final int SERVICE_RECORD_TYPE;
   private static final int SERVICE_NAME;
   private static final int HOME_ADDRESS;
   private static final int DATASOURCE_ID;
   private static final int USER_ID;
   private static final int SERVICE_UID;
   private static final int SERVICE_CID;
   private static final int APPLICATION_DATA;
   private static final int COMP_MODE;
   private static final int ENCRYPT_MODE;
   private static final int CA_REALM;
   private static final int CA_ADDRESS;
   private static final int CA_PORT;
   private static final int SERVICE_DESCRIPTION;
   private static final int FLAGS_FLAG;
   private static final int RECORD_SOURCE;
   private static final int SERVICE_IDENTIFIER;
   private static final int BBR_ROUTING_INFO;
   private static final int BBR_PORT;
   private static final int BBR_HOST;
   private static final int HOST_ROUTING_INFO;
   private static final int SERVICE_RECORD_RESTORE_ID;
   private static final int LAST_UPDATED;
   private static final int HRI_APN_PASSWORD;
   private static final int HRI_APN_USERNAME;
   private static final int HRI_APN;
   private static final int HRI_RADIO_NETWORK_ID;
   private static final int HRI_HPID_VALUE;
   private static final int HRI_NPC;
   private static final int HRI_NPC_EXTENSION;
   private static final int HRI_LOAD_SHARING;
   private static final int HRI_NETWORK_NAME;
   private static final int HRI_WIRELESS_NETWORK;
   private static final int HRI_IP_LIST;
   private static final int HRI_UDP_PORT_LIST;
   private static final int HRI_QOS;
   private static final int BACKUP_RESTORE_RECORD_TYPE;
