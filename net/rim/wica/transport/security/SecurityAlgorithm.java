...
public class SecurityAlgorithm {
   ...
   private static final int MAC_TYPE;
   private static final int SIGNATURE_TYPE;
   private static final int ENCRYPTION_DECRYPTION_TYPE;
   private static final int KEY_ESTABLISHING_TYPE;
