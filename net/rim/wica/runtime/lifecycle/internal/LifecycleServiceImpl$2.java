...
class LifecycleServiceImpl$2 implements Runnable {
   private final Vector val$entries;
   private final LifecycleServiceImpl this$0;

   LifecycleServiceImpl$2(LifecycleServiceImpl this$0, Vector val$entries) {
      this.this$0 = this$0;
   ...
   public void run() {
      ...
      for (int i = 0; i < size; i++) {
         HomeScreenUtilities.unregisterEntry((HomeScreenEntry)this.val$entries.elementAt(i));
      }
   }
}
