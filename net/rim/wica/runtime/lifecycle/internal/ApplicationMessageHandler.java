...
final class ApplicationMessageHandler implements MessageConsumer {
   ...
   private static final String REGISTER_MANAGEMENT_EVENTS_MSG;
   private static final String UNREGISTER_MANAGEMENT_EVENTS_MSG;
   private static final String REGISTER_LIFECYCLE_EVENTS_MSG;
   private static final String UNREGISTER_LIFECYCLE_EVENTS_MSG;
   private static final String CLIENT_ADMIN_POLICY_REQ_MSG;
   private static final String CLIENT_ADMIN_POLICY_RESP_MSG;
   private static final String APPLICATION_INFO_REQ_MSG;
   private static final String APPLICATION_INFO_RESP_MSG;
   private static final String LIFECYCLE_ACTION_MSG;
   private static final String CLIENT_ADMIN_POLICY_UPDATE_MSG;
   private static final String APPLICATION_INSTALL_MSG;
   private static final String APPLICATION_UPDATE_MSG;
   private static final String APPLICATION_STATE_MSG;
   private static final String APPLICATION_UNINSTALL_MSG;
   private static final int LIFECYCLE_START_ACTION;
   private static final int LIFECYCLE_UNINSTALL_ACTION;
   private static final int LIFECYCLE_UPGRADE_ACTION;
   private static final int LIFECYCLE_CLEAR_CACHE_ACTION;
