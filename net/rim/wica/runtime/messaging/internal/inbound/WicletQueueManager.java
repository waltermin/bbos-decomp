...
final class WicletQueueManager extends Processor implements InboundQueueConnection, MessageHandler {
   ...
   private static final int _WICLET_STATE_OPEN;
   private static final int _WICLET_STATE_DEACTIVATED;
   private static final int _WICLET_STATE_CLOSED;
   private static final int _MSG_BG;
   private static final int _MSG_FG_NEW;
   private static final int _MSG_FG_OVERWRITE;
   private static final int _MSG_FG;
   private static final int _DISABLE_ON_MD_STARTUP;
   private static final int _DISABLE_ON_UPGRADE;
   private static final int _DISABLE_ON_UNINSTALL;
   private static final int _DISABLE_ON_DEACTIVATE;
   private static final int _DISABLE_ON_ERROR;
   private static final int _SEND_ALL;
   private static final int _SUSPEND_FOREGROUND;
   private static final int _SUSPEND_ALL;
