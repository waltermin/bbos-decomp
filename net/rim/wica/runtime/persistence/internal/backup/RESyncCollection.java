...
public final class RESyncCollection implements SyncCollection, SyncConverter, SyncEventListener, GlobalEventListener {
   ...
   private static final int NUMBER_OF_WICLETS_PARTS_V2;
   private static final byte RE_WITHOUT_WICLETS;
   private static final byte RE_VERSION;
   private static final byte RUNTIME_INFO;
   private static final byte AG_INFO_ARRAY;
   private static final byte IN_REQUEST_QUEUE;
   private static final byte INCOMING_MESSAGES;
   private static final byte OUTGOING_MESSAGES;
   private static final byte DEDICATED_OUTGOING_MESSAGES;
   private static final byte COMMON_RESOURCES;
   private static final byte WICLET_INFO;
   private static final byte WICLET_COLLISION_TABLE;
   private static final byte WICLET_GLOBAL_DATA_DEF_ID;
   private static final byte WICLET_DATA_DEFS;
   private static final byte WICLET_MSG_DEFS;
   private static final byte WICLET_SCRIPT_DEFS;
   private static final byte WICLET_UI_DEFS;
   private static final byte WICLET_INCOMING_MESSAGES;
   private static final byte WICLET_RESOURCES;
   private static final byte WICLET_DATA;
   private static final byte WICLET_MAPPING_TABLE;
   private static final byte APPLICATION_SYNC_DATA;
