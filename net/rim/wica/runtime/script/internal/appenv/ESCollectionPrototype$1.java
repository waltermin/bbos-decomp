...
class ESCollectionPrototype$1 extends HostFunction {
   private final ESCollectionPrototype this$0;

   ESCollectionPrototype$1(ESCollectionPrototype this$0, String x0, String x1, int x2) {
      super(x0, x1, x2);
      this.this$0 = this$0;
   }
   ...
   public long run() {
      ...
      if (!(collection instanceof KeyDataCollection)) {
         ...
         dataHandlers = keyedCollection.retrieveAll(true);
