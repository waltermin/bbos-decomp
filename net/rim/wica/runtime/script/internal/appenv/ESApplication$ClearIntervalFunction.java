...
final class ESApplication$ClearIntervalFunction extends HostFunction {
   private final ESApplication this$0;

   ESApplication$ClearIntervalFunction(ESApplication this$0) {
      super("application", "clearInterval", 1);
      this.this$0 = this$0;
   }
