...
final class ESApplication$SetTimeoutFunction extends HostFunction {
   private final ESApplication this$0;

   ESApplication$SetTimeoutFunction(ESApplication this$0) {
      super("application", "setTimeout", 2);
      this.this$0 = this$0;
   }
   ...
   public final long run() {
      ...
      return Value.makeIntegerValue(this.this$0._engine.getTimer().setTimeout(action, timeout, args, false));
   }
}
