...
class WicletTextEditField$EmailAddressEditFieldMF extends EmailAddressEditField implements MultiFocusable {
   public WicletTextEditField$EmailAddressEditFieldMF(String label, String initialValue, int maxNumChars) {
   }
