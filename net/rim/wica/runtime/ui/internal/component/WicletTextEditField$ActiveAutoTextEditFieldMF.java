...
class WicletTextEditField$ActiveAutoTextEditFieldMF extends ActiveAutoTextEditField implements MultiFocusable {
   public WicletTextEditField$ActiveAutoTextEditFieldMF(String label, String initialValue, int maxNumChars, long style) {
