...
class EventICalendarProvider extends PIMICalendarProvider {
   ...
   public void setTrigger(int type, int paramType, Date date) {
      ...
      this._event.setInt(100, 0, 0, offset);
   }
   ...
   public int getRelativeTrigger() {
      return this._event.getInt(100, 0);
   }
   ...
   public String getAlarmDescriptionValue() {
      String desc = this._event.getString(107, 0);
      if (desc == null) {
         desc = "";
      } else {
         desc = ((StringBuffer)(new Object())).append(desc).append('\n').toString();
      }

      try {
         long start = this._event.getDate(106, 0);
         long end = this._event.getDate(102, 0);
         if (start != 0 && end != 0) {
            DateFormat format = DateFormat.getInstance(54);
            return ((StringBuffer)(new Object())).append(desc).append(format.formatLocal(start)).append('\n').append(format.formatLocal(end)).toString();
         }
      } finally {
         return desc;
      }
   ...
   public void setExceptionDateTime(int type, int paramType, Date[] date, int dateLength) {
      ...
      long[] exDates = this._repeat.getExceptDates();

      for (int i = exDates.length - 1; i >= 0; i--) {
         this._repeat.removeExceptDate(exDates[i]);
      }
   ...
   public Date[] getExceptionDateTimeValue() {
      Date[] dates = null;
      if (this._repeat != null) {
         long[] exceptTimes = this._repeat.getExceptDates();
         int length = exceptTimes.length;
         dates = new Object[length];

         for (int i = 0; i < length; i++) {
            dates[i] = (Date)(new Object(exceptTimes[i]));
         }
      }
   ...
   public int getExceptionDateLength() {
      return this._repeat != null ? this._repeat.getExceptDates().length : 0;
   }
   ...
   public void setFreq(int freqType) {
      if (freqType == -746168210) {
         ...
         switch (freqType) {
            case -1738378111:
               this._repeat.setInt(5, 17);
               return;
            case -1681232246:
               this._repeat.setInt(5, 19);
               return;
            case -565154143:
            case 1726084353:
            case 2136870513:
               ...
               return;
            case 64808441:
               this._repeat.setInt(5, 16);
               return;
            case 1954618349:
               this._repeat.setInt(5, 18);
               return;
            default:
               this._repeat = null;
   ...
   public int getFreq() {
      if (this._repeat != null) {
         try {
            int repeatFreq = this._repeat.getInt(5);
            switch (repeatFreq) {
               case 15:
                  break;
               case 16:
   ...
   public Date getUntil() {
      if (this._repeat != null) {
         try {
            return (Date)(new Object(this._repeat.getDate(4)));
         } catch (FieldEmptyException var2) {
         }
      }
   ...
   public boolean isUntilSpecified() {
      if (this._repeat != null) {
         try {
            long repeatEnd = this._repeat.getDate(4);
            if (repeatEnd != 0) {
               if (super._version == 1) {
   ...
   public boolean isCountSpecified() {
      ...
      try {
         return super._version == 1 ? this._repeat.getInt(0) != 0 && !this.isUntilSpecified() : this._repeat.getInt(0) != 0 || !this.isUntilSpecified();
   ...
   public void setInterval(int interval) {
      ...
      this._repeat.setInt(6, interval);
   }
   ...
   public void setByDay(int[] orderWeek, int[] weekDay, int dayLength) {
      ...
      for (int i = 0; i < dayLength; i++) {
         ...
         try {
            if (this._repeat.getInt(5) == 19 || thisOrdWk < -5 || thisOrdWk > 5) {
               thisOrdWk = 0;
            }
   ...
   public void setByDay(int orderWeek, int weekDay) {
      ...
      if (weekDay >= 1 && weekDay <= 7 && orderWeek >= -maxOrderWeek && orderWeek <= maxOrderWeek) {
         try {
            if (this._repeat.getInt(5) == 19 || orderWeek < -5 || orderWeek > 5) {
               orderWeek = 0;
            }
   ...
   public boolean isYearDaysSpecified() {
      try {
         return this._repeat != null && this._repeat.getInt(3) != 0;
      } catch (FieldEmptyException fee) {
         return false;
      }
   }
   ...
   public void setByMonth(int[] month, int monthLength) {
      ...
      this._repeat.setInt(7, intMonths);
   }
   ...
   public void setByMonth(int month) {
      ...
      if (month > 0 && month < 13) {
         int intMonths;
         try {
            intMonths = this._repeat.getInt(7);
         } catch (FieldEmptyException fee) {
            intMonths = 0;
         }
   ...
   public boolean isMonthsSpecified() {
      try {
         return this._repeat != null && this._repeat.getInt(7) != 0;
      } catch (FieldEmptyException fee) {
         return false;
      }
   }
   ...
   private int[] getMonthArray() {
      int monthinyear;
      try {
         monthinyear = this._repeat.getInt(7);
      } catch (FieldEmptyException fee) {
         monthinyear = 0;
      }
   ...
   private void calcWeekArray() {
      ...
      try {
         if (this._repeat.getInt(5) != 19) {
            weeks = RepeatRuleUtil.getWeekArray(this._repeat.getInt(8));
