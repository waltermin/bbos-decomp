...
final class EventFieldsModel implements PersistableRIMModel, SyncObject {
   ...
   public EventFieldsModel(RepeatRule repeat) {
      ...
      for (int i = fields.length - 1; i >= 0; i--) {
         ...
         switch (field) {
            case 0:
               this._frequency = repeat.getInt(field);
               break;
            case 1:
               this._dayInMonth = repeat.getInt(field);
               break;
            case 2:
               this._dayInWeek = repeat.getInt(field);
               break;
            case 4:
               this._dayInYear = repeat.getInt(field);
               break;
            case 8:
               this._month = repeat.getInt(field);
               break;
            case 16:
               this._weekInMonth = repeat.getInt(field);
               break;
            case 32:
               this._repeatCount = repeat.getInt(field);
               break;
            case 64:
               this._endDate = repeat.getDate(field);
               break;
            case 128:
               this._interval = repeat.getInt(field);
         }
      }
   }

   public EventFieldsModel(Event e) {
      this._uid = e.getUID();
