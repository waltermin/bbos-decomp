...
class EventListImpl$_eventComparator implements Comparator {
   public boolean matches(Event m, Event e) {
      ...
      if (mRecur != null && eRecur != null) {
         ...
         return RepeatRuleUtil.compareExceptionDates(mRecur.getExceptDates(), eRecur.getExceptDates());
      } else {
         return false;
      }
   }
   ...
   public int compare(Object o1, Object o2) {
      Event e1 = (Event)o1;
      Event e2 = (Event)o2;
      long timediff = this.getStart(e1) - this.getStart(e2);
      if (timediff > 0) {
         return 1;
      } else {
   ...
   private long getStart(Event e) {
      return e.countValues(106) > 0 ? e.getDate(106, 0) : 0;
   }
