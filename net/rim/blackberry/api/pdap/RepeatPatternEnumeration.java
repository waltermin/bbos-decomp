...
public final class RepeatPatternEnumeration implements Enumeration {
   ...
   public RepeatPatternEnumeration(Event event, long startDate, long beginning, long ending, int count) {
      this._event = event;
   ...
   public static final long findLastCount(Event event, long start, int count) {
