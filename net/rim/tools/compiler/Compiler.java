...
public class Compiler implements Optimization {
   ...
   private static final int CODE_FULL;
   private static final int DATA_FULL;
   private static final int VTABLE_FULL;
   private static final int FIELD_FULL;
   private static final int SLICE_SIZE;
   private static final int MAX_STACK;
   private static final int MAX_LOCALS;
   private static final int FIXED_TIMESTAMP;
   public static final int VERBOSITY_QUIET;
   public static final int VERBOSITY_NORMAL;
   public static final int VERBOSITY_NOISY;
   public static int _verbosity;
   public static final String rapc_jarFiles;
   public static final String rapc_resourceBinaries;
   public static final String rapc_jad;
   public static final String rapc_rapc;
   public static final String underscore;
   public static final int RESULT_SUCCESS;
   public static final int RESULT_ERROR;
   public static final int RESULT_FAILURE;
   public static final int RESULT_FAILURE_JAR_SIZE;
   public static final int RESULT_FAILURE_ATTRIBUTE;
   public static final int RESULT_FAILURE_DESCRIPTOR;
   public static final int RESULT_FAILURE_JAR_BAD;
   public static final int RESULT_FAILURE_BAD_CONF_PROF;
   public static final int RESULT_FAILURE_AUTHENTICATION;
   public static final int RESULT_FAILURE_AUTHORIZATION;
   private static Vector _parmTypes = (Vector)(new Object());
   private static final boolean _convertPNG;
