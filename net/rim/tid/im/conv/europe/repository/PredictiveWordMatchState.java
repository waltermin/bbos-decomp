...
public class PredictiveWordMatchState implements RegularExpressionState {
   private PredictiveWordMatch expr;
   int t1PathIndex;
   int deletePathIndex;
   int swap1PathIndex;
   int swap2PathIndex;
   ...
   public void set(PredictiveWordMatch expr) {
      this.expr = expr;
      this.t1PathIndex = 0;
   ...
   public Object newMark() {
      PredictiveWordMatchState$CachedState state = new PredictiveWordMatchState$CachedState();
   ...
   public void rollback(Object obj) {
      PredictiveWordMatchState$CachedState state = (PredictiveWordMatchState$CachedState)obj;
   ...
   public boolean isFinal() {
      return this.t1PathIndex != -1
         ? this.t1PathIndex == this.expr.len
         : this.swap1PathIndex == this.expr.len
