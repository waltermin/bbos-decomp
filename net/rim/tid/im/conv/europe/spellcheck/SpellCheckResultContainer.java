...
public class SpellCheckResultContainer extends ResultContainer {
   ...
   public static final byte LEARNED_WORDS_FUNCTION;
   public static final byte LEARNED_WORDS_FUNCTION_WEIGHT;
   public static final byte CASE_ACCENT_INSENSITIVE_FUNCTION;
   public static final byte CASE_ACCENT_INSENSITIVE_FUNCTION_WEIGHT;
   public static final byte PHONETIC_REPLACE_FUNCTION;
   public static final byte PHONETIC_REPLACE_FUNCTION_WEIGHT;
   public static final byte MISSING_CHAR_FUNCTION;
   public static final byte MISSING_CHAR_FUNCTION_WEIGHT;
   public static final byte SWAP_CHAR_FUNCTION;
   public static final byte SWAP_CHAR_FUNCTION_WEIGHT;
   public static final byte EXTRA_CHAR_FUNCTION;
   public static final byte EXTRA_CHAR_FUNCTION_WEIGHT;
   public static final byte EXCHANGE_CHAR_FUNCTION;
   public static final byte EXCHANGE_CHAR_FUNCTION_WEIGHT;
   public static final byte SPLIT_WORDS_FUNCTION;
   public static final byte SPLIT_WORDS_FUNCTION_WEIGHT;
   public static final byte SAME_METAPHONE_FUNCTION;
   public static final byte SAME_METAPHONE_FUNCTION_WEIGHT;
   public static final byte MISSING_METAPHONE_FUNCTION;
   public static final byte MISSING_METAPHONE_FUNCTION_WEIGHT;
   public static final byte SWAP_METAPHONE_FUNCTION;
   public static final byte SWAP_METAPHONE_FUNCTION_WEIGHT;
   public static final byte EXTRA_METAPHONE_FUNCTION;
   public static final byte EXTRA_METAPHONE_FUNCTION_WEIGHT;
   public static final byte EXCHANGE_METAPHONE_FUNCTION;
   public static final byte EXCHANGE_METAPHONE_FUNCTION_WEIGHT;
   public static final byte GREATEST_COMMON_PREFIX_FUNCTION;
   public static final byte GREATEST_COMMON_PREFIX_FUNCTION_WEIGHT;
   public static final byte TOTAL_CONVERSION_FUNCTIONS;
   public static final byte[] _conversionFunctionWeights = new byte[14];
   public static final byte LAST_REGULAR_SEARCH_FUNCTION;
   private static final byte MIN_ELEMENTS_FOR_JUMP;
