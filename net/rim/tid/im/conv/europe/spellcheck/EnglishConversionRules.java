...
public class EnglishConversionRules implements LocaleConversionRules {
   ...
   private static final String BEFORE_APOSTROPHE_S_EXCLUSION;
   private static final String BEFORE_ING_EXCLUSION;
   private static final String BEFORE_PLURAL_S_EXCLUSION;
   private static final String BEFORE_PLURAL_YS_EXCLUSION;
   private static final String BEFORE_PLURAL_ES_INCLUSION;
   private static final String BEFORE_PLURAL_HES_INCLUSION;
   private static final String DOUBLED_CONSONANT;
