...
public class ContextPairsTable_en_qwerty_default___QRED implements IContextPairsTable {
   ...
   public final boolean hasContextHash(int keyHashCode, int contextHasCode) {
      ...
      return keyIndex < 0 ? false : Arrays.binarySearch(this.CONTEXT_HASHES[keyIndex], contextHasCode) >= 0;
   }
}
