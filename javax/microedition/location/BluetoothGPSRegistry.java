...
class BluetoothGPSRegistry implements BluetoothSerialPortListener {
   ...
   public static final long BT_DISCONNECT_EVENT;
   private static BluetoothGPSRegistry _registry;
   private static final long GPGGA;
   private static final long GPGLL;
   private static final long GPRMC;
   private static final long GPVTG;
   private static final long GPRMA;
   private static final long GPGSA;
   private static final int RX_BUFFER_SIZE;
   private static final int TX_BUFFER_SIZE;
   private static final int SENTENCE_ID;
   private static final int GPGGA_TIME;
   private static final int GPGGA_LATITUDE;
   private static final int GPGGA_NORTH_SOUTH;
   private static final int GPGGA_LONGITUDE;
   private static final int GPGGA_EAST_WEST;
   private static final int GPGGA_POSITION_FIX;
   private static final int GPGGA_SATALITES_USED;
   private static final int GPGGA_HDOP;
   private static final int GPGGA_ALTITUDE;
   private static final int GPGGA_ALTITUDE_UNITS;
   private static final int GPGGA_GEOID_SEPERATION;
   private static final int GPGGA_SEPERATION_UNITS;
   private static final int GPGGA_DGPS_AGE;
   private static final int GPGGA_DGPS_STATION;
   private static final int GPGGA_FIELD_COUNT;
   private static final int GPGLL_LATITUDE;
   private static final int GPGLL_NORTH_SOUTH;
   private static final int GPGLL_LONGITUDE;
   private static final int GPGLL_EAST_WEST;
   private static final int GPGLL_STATUS;
   private static final int GPGLL_FIELD_COUNT;
   private static final int GPGSA_STATUS;
   private static final int GPGSA_HDOP;
   private static final int GPGSA_VDOP;
   private static final int GPGSA_FIELD_COUNT;
   private static final int GPRMC_STATUS;
   private static final int GPRMC_LATITUDE;
   private static final int GPRMC_NORTH_SOUTH;
   private static final int GPRMC_LONGITUDE;
   private static final int GPRMC_EAST_WEST;
   private static final int GPRMC_SPEED;
   private static final int GPRMC_COURSE;
   private static final int GPRMC_FIELD_COUNT;
   private static final int GPRMC_FIELD_COUNT_OLD;
   private static final int GPVTG_COURSE;
   private static final int GPVTG_SPEED;
   private static final int GPVTG_SPEED_UNIT;
   private static final int GPVTG_FIELD_COUNT;
   private static final int GPRMA_STATUS;
   private static final int GPRMA_LATITUDE;
   private static final int GPRMA_NORTH_SOUTH;
   private static final int GPRMA_LONGITUDE;
   private static final int GPRMA_EAST_WEST;
   private static final int GPRMA_SPEED;
   private static final int GPRMA_COURSE;
   private static final int GPRMA_FIELD_COUNT;
